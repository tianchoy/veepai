...
open class GenPagesMineFeebackFeeback : BasePage {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("container" to _pS(_uM("height" to "100%", "backgroundColor" to "#F5f5f5", "paddingTop" to "20rpx", "paddingRight" to "20rpx", "paddingBottom" to "20rpx", "paddingLeft" to "20rpx")), "content" to _uM(".container " to _uM("backgroundColor" to "#ffffff", "borderTopLeftRadius" to "20rpx", "borderTopRightRadius" to "20rpx", "borderBottomRightRadius" to "20rpx", "borderBottomLeftRadius" to "20rpx", "paddingTop" to "40rpx", "paddingRight" to "20rpx", "paddingBottom" to "40rpx", "paddingLeft" to "20rpx")), "underline" to _uM(".container .content " to _uM("borderBottomWidth" to "1rpx", "borderBottomStyle" to "solid", "borderBottomColor" to "#f9f9f9")), "item-label" to _uM(".container .content " to _uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "marginTop" to "30rpx")), "little-title" to _uM(".container .content .item-label " to _uM("color" to "#999999", "fontSize" to "20rpx", "marginLeft" to "10rpx")), "btn-box" to _uM(".container " to _uM("marginTop" to "50rpx")), "l-picker" to _uM(".container " to _uM("width" to "100%")))
            }
