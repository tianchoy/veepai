...
open class GenPagesMineMyOrdersMyOrders : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesMineMyOrdersMyOrders) -> Any? = fun(__props): Any? {
            ...
            val content = ref(_uA<ContentType>(ContentType(id = "1111", title = "五年畅想套餐", date = "2025-07-09 15:00:00", price = "¥300", state = "已完成", iccid = "89862235957372384387456", isPay = "2"), ContentType(id = "1112", title = "五年畅想套餐", date = "2025-07-09 15:00:00", price = "¥300", state = "已取消", iccid = "89862235957372384387454", isPay = "3"), ContentType(id = "1113", title = "五年畅想套餐", date = "2025-07-09 15:00:00", price = "¥300", state = "待付款", iccid = "89862235957372384387467", isPay = "1"), ContentType(id = "1114", title = "五年畅想套餐", date = "2025-07-09 15:00:00", price = "¥300", state = "已退款", iccid = "89862235957372384387465", isPay = "4")))
