    ...
    companion object {
        ...
        var setup: (__props: GenPagesIndexDeviceSetting) -> Any? = fun(__props): Any? {
            ...
            val goTrafficRecharge = fun(){
                uni_navigateTo(NavigateToOptions(url = "/pages/index/deviceRechargeData"))
            }
