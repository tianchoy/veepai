...
open class GenPagesIndexIndex : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesIndexIndex) -> Any? = fun(__props): Any? {
            ...
            val videoSrc = "/static/video/video.mp4"
                ...
                return _cE("view", _uM("class" to "container"), _uA(
                    ...
                    _cE("view", _uM("class" to "content"), _uA(
                        _cE("view", _uM("class" to "video-container", "style" to _nS(_uM("border-radius" to "15rpx", "overflow" to "hidden"))), _uA(
                            _cE("video", _uM("class" to "video", "id" to "myVideo", "src" to videoSrc, "controls" to onLine.value, "show-play-btn" to onLine.value, "show-center-play-btn" to onLine.value, "enable-progress-gesture" to onLine.value, "show-fullscreen-btn" to onLine.value, "show-mute-btn" to onLine.value, "direction" to -90, "object-fit" to "fill"), _uA(
                                ...
                                if (isTrue(onLine.value)) {
                                    _cE("view", _uM("key" to 1, "class" to "video-right-control"), _uA(
                                        _cV(_component_l_icon, _uM("name" to forward, "size" to "30", "style" to _nS(_uM("padding" to "10rpx", "background" to "rgba(255, 255, 255, .7)", "border-radius" to "30rpx")), "onClick" to toDeviceDetail), null, 8, _uA(
                                            "style"
                                        )),
                                        _cV(_component_l_icon, _uM("name" to errIcon, "size" to "30", "style" to _nS(_uM("padding" to "10rpx", "background" to "rgba(255, 255, 255, .7)", "border-radius" to "30rpx")), "onClick" to errClick), null, 8, _uA(
                                            "style"
                                        )),
                                        _cV(_component_l_icon, _uM("name" to transfer, "size" to "30", "style" to _nS(_uM("padding" to "10rpx", "background" to "rgba(255, 255, 255, .7)", "border-radius" to "30rpx")), "onClick" to transferClick), null, 8, _uA(
                                            "style"
                                        )),
                                        _cV(_component_l_icon, _uM("name" to replayIcon, "size" to "30", "style" to _nS(_uM("padding" to "10rpx", "background" to "rgba(255, 255, 255, .7)", "border-radius" to "30rpx")), "onClick" to replay), null, 8, _uA(
                                            "style"
                                        ))
                                    ))
                                } else {
