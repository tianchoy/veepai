...
open class GenUniModulesLimeTextareaComponentsLTextareaLTextarea : VueComponent, TextareaProps {
    ...
    companion object {
            ...
            return fun(): Any? {
                return createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                    ...
                    utsArrayOf(
                        ...
                        utsMapOf("l-textarea--classic" to _ctx.classic, "l-textarea--classic-disabled" to (_ctx.classic && unref(isDisabled)), "l-textarea--classic-focused" to (_ctx.classic && !unref(isDisabled) && unref(innerFocused)), "l-textarea--border" to (_ctx.bordered && !_ctx.classic))
                    )
                )), "ref_key" to "textareaRef", "ref" to textareaRef, "style" to normalizeStyle(utsArrayOf(
                    unref(styles),
                    _ctx.lStyle
                ))), utsArrayOf(
                    ...
                    ,
                    createElementVNode("view", utsMapOf("class" to "l-textarea__wrapper"), utsArrayOf(
                        createElementVNode("textarea", utsMapOf("class" to normalizeClass(utsArrayOf(
                            "l-textarea__wrapper-inner",
                            utsMapOf("is-disabled" to unref(isDisabled))
                        )), "style" to normalizeStyle(utsArrayOf(
                            _ctx.innerStyle
                        ...
                        if (isTrue(_ctx.indicator && ((_ctx.maxcharacter ?: _ctx.maxlength) > 0))) {
                            createElementVNode("text", utsMapOf("key" to 0, "class" to "l-textarea__indicator", "style" to normalizeStyle(utsArrayOf(
                                _ctx.indicatorStyle
                            ))), toDisplayString(unref(count)) + " / " + toDisplayString(_ctx.maxcharacter ?: _ctx.maxlength), 5)
                        } else {
                            createCommentVNode("v-if", true)
                        }
                    ))
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("l-textarea" to padStyleMapOf(utsMapOf("boxSizing" to "border-box", "paddingTop" to "32rpx", "paddingRight" to "32rpx", "paddingBottom" to "32rpx", "paddingLeft" to "32rpx", "backgroundColor" to "#ffffff")), "l-textarea--horizontal" to padStyleMapOf(utsMapOf("flexDirection" to "row")), "l-textarea__label" to padStyleMapOf(utsMapOf("color" to "rgba(0,0,0,0.88)", "flexShrink" to 0, "lineHeight" to "44rpx", "overflow" to "hidden", "whiteSpace" to "nowrap", "textOverflow" to "ellipsis")), "l-textarea__label--vertical" to padStyleMapOf(utsMapOf("fontSize" to 14, "paddingBottom" to "16rpx")), "l-textarea__label--horizontal" to padStyleMapOf(utsMapOf("fontSize" to 16, "marginRight" to "32rpx")), "l-textarea__wrapper" to padStyleMapOf(utsMapOf("flex" to 1, "overflow" to "hidden")), "l-textarea__wrapper-inner" to padStyleMapOf(utsMapOf("flex" to "1 1 auto", "width" to "100%", "boxSizing" to "border-box", "minWidth" to 0, "minHeight" to 20, "marginTop" to 0, "marginRight" to 0, "marginBottom" to 0, "marginLeft" to 0, "paddingTop" to 0, "paddingRight" to 0, "paddingBottom" to 0, "paddingLeft" to 0, "textAlign" to "left", "backgroundColor" to "rgba(0,0,0,0)", "borderTopWidth" to 0, "borderRightWidth" to 0, "borderBottomWidth" to 0, "borderLeftWidth" to 0, "borderTopStyle" to "none", "borderRightStyle" to "none", "borderBottomStyle" to "none", "borderLeftStyle" to "none", "borderTopColor" to "#000000", "borderRightColor" to "#000000", "borderBottomColor" to "#000000", "borderLeftColor" to "#000000", "fontSize" to 16, "color" to "rgba(0,0,0,0.88)", "lineHeight" to "48rpx")), "l-textarea__placeholder" to padStyleMapOf(utsMapOf("color" to "rgba(0,0,0,0.45)", "fontSize" to 16, "lineHeight" to "48rpx")), "l-textarea__indicator" to padStyleMapOf(utsMapOf("flexShrink" to 0, "color" to "rgba(0,0,0,0.45)", "fontSize" to "24rpx", "textAlign" to "right", "lineHeight" to "40rpx", "paddingTop" to "16rpx")), "l-textarea--border" to padStyleMapOf(utsMapOf("position" to "relative")), "l-textarea--border-focused" to padStyleMapOf(utsMapOf("borderBottomColor" to "#3283ff")), "is-disabled" to utsMapOf(".l-textarea " to utsMapOf("color" to "rgba(0,0,0,0.25)")), "l-textarea--classic" to padStyleMapOf(utsMapOf("paddingTop" to 12, "paddingRight" to 16, "paddingBottom" to 12, "paddingLeft" to 16, "borderTopLeftRadius" to "12rpx", "borderTopRightRadius" to "12rpx", "borderBottomRightRadius" to "12rpx", "borderBottomLeftRadius" to "12rpx", "borderTopWidth" to 0.5, "borderRightWidth" to 0.5, "borderBottomWidth" to 0.5, "borderLeftWidth" to 0.5, "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid", "borderTopColor" to "#eeeeee", "borderRightColor" to "#eeeeee", "borderBottomColor" to "#eeeeee", "borderLeftColor" to "#eeeeee")), "l-textarea--classic-focused" to padStyleMapOf(utsMapOf("borderTopColor" to "#3283ff", "borderRightColor" to "#3283ff", "borderBottomColor" to "#3283ff", "borderLeftColor" to "#3283ff")))
            }
        var inheritAttrs = true
        var inject: Map<String, Map<String, Any?>> = utsMapOf()
        var emits: Map<String, Any?> = utsMapOf("change" to null, "focus" to null, "blur" to null, "confirm" to null, "linechange" to null, "keyboardheightchange" to null, "update:modelValue" to null)
        var props = normalizePropsOptions(utsMapOf("adjustPosition" to utsMapOf("type" to "Boolean", "required" to true, "default" to true), "autofocus" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "autosize" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "bordered" to utsMapOf("type" to "Boolean", "required" to true, "default" to true), "confirmHold" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "confirmType" to utsMapOf("type" to "String", "required" to true, "default" to "return"), "cursor" to utsMapOf("type" to "Number", "required" to true, "default" to -1), "cursorSpacing" to utsMapOf("type" to "Number", "required" to true, "default" to 0), "disableDefaultPadding" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "disabled" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "readonly" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "fixed" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "defaultFixed" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "focus" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "holdKeyboard" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "indicator" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "label" to utsMapOf("type" to "String", "required" to false), "maxcharacter" to utsMapOf("type" to "Number", "required" to false), "maxlength" to utsMapOf("type" to "Number", "required" to true, "default" to -1), "placeholder" to utsMapOf("type" to "String", "required" to true, "default" to ""), "selectionEnd" to utsMapOf("type" to "Number", "required" to true, "default" to -1), "selectionStart" to utsMapOf("type" to "Number", "required" to true, "default" to -1), "showConfirmBar" to utsMapOf("type" to "Boolean", "required" to true, "default" to true), "value" to utsMapOf("type" to "String", "required" to false), "layout" to utsMapOf("type" to "String", "required" to true, "default" to "horizontal"), "placeholderStyle" to utsMapOf("type" to "String", "required" to true, "default" to ""), "lStyle" to utsMapOf("type" to "String", "required" to false), "labelStyle" to utsMapOf("type" to "String", "required" to false), "indicatorStyle" to utsMapOf("type" to "String", "required" to false), "innerStyle" to utsMapOf("type" to "String", "required" to false), "classic" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "borderColor" to utsMapOf("type" to "String", "required" to false), "focusedBorderColor" to utsMapOf("type" to "String", "required" to false), "focused" to utsMapOf("type" to "Boolean", "required" to true, "default" to false), "modelValue" to utsMapOf("type" to "String", "default" to "")))
