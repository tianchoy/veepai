...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    val hosts: String = "127.0.0.1,192.168.3.34,169.254.248.229"
    val port: String = "8090"
    val id: String = "app-android_hc_ttb"
    if (hosts == "" || port == "" || id == "") {
...
open class tabItem (
    ...
    @JsonNotNull
    open var content: UTSArray<ContentType>,
) : UTSReactiveObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
...
open class tabItemReactiveObject : tabItem, IUTSReactive<tabItem> {
    ...
    override var content: UTSArray<ContentType>
        get() {
...
val GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmptyClass = CreateVueComponent(GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "component", name = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.name, inheritAttrs = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.inheritAttrs, inject = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.inject, props = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.props, propsNeedCastKeys = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.propsNeedCastKeys, emits = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.emits, components = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.components, styles = GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty.styles)
}
, fun(instance, renderer): GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty {
    return GenUniModulesFirstuiUnixComponentsFuiEmptyFuiEmpty(instance)
}
)
open class tabItem1 (
    @JsonNotNull
    ...
    open var title: String,
    @JsonNotNull
    open var content: UTSArray<ContentType1>,
) : UTSReactiveObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("tabItem", "pages/index/deviceRechargeData.uvue", 78, 7)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
        return tabItem1ReactiveObject(this, __v_isReadonly, __v_isShallow, __v_skip)
    }
}
open class tabItem1ReactiveObject : tabItem1, IUTSReactive<tabItem1> {
    override var __v_raw: tabItem1
    override var __v_isReadonly: Boolean
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: tabItem1, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(id = __v_raw.id, title = __v_raw.title, content = __v_raw.content) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    }
    override fun __v_clone(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): tabItem1ReactiveObject {
        return tabItem1ReactiveObject(this.__v_raw, __v_isReadonly, __v_isShallow, __v_skip)
    }
    override var id: String
        get() {
            return _tRG(__v_raw, "id", __v_raw.id, __v_isReadonly, __v_isShallow)
    ...
    override var content: UTSArray<ContentType1>
        get() {
            return _tRG(__v_raw, "content", __v_raw.content, __v_isReadonly, __v_isShallow)
        }
        set(value) {
...
open class ContentType1 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ContentType", "pages/index/deviceRechargeData.uvue", 84, 7)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
        return ContentType1ReactiveObject(this, __v_isReadonly, __v_isShallow, __v_skip)
    }
}
open class ContentType1ReactiveObject : ContentType1, IUTSReactive<ContentType1> {
    override var __v_raw: ContentType1
    override var __v_isReadonly: Boolean
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: ContentType1, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(id = __v_raw.id, title = __v_raw.title, date = __v_raw.date, price = __v_raw.price, category = __v_raw.category) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    }
    override fun __v_clone(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): ContentType1ReactiveObject {
        return ContentType1ReactiveObject(this.__v_raw, __v_isReadonly, __v_isShallow, __v_skip)
    }
    override var id: String
        get() {
            return _tRG(__v_raw, "id", __v_raw.id, __v_isReadonly, __v_isShallow)
...
val GenPagesIndexDeviceRechargeDataClass = CreateVueComponent(GenPagesIndexDeviceRechargeData::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesIndexDeviceRechargeData.inheritAttrs, inject = GenPagesIndexDeviceRechargeData.inject, props = GenPagesIndexDeviceRechargeData.props, propsNeedCastKeys = GenPagesIndexDeviceRechargeData.propsNeedCastKeys, emits = GenPagesIndexDeviceRechargeData.emits, components = GenPagesIndexDeviceRechargeData.components, styles = GenPagesIndexDeviceRechargeData.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenPagesIndexDeviceRechargeData.setup(props as GenPagesIndexDeviceRechargeData)
    }
    )
}
, fun(instance, renderer): GenPagesIndexDeviceRechargeData {
    return GenPagesIndexDeviceRechargeData(instance, renderer)
}
)
typealias CheckerDirection = String
interface CheckboxGroupProps {
    var disabled: Boolean
    var readonly: Boolean
    var max: Number?
    var name: Any?
    var value: UTSArray<Any>?
    var modelValue: UTSArray<Any>?
    var defaultValue: UTSArray<Any>?
    var size: String
    var direction: CheckerDirection
    var gap: String?
    var icon: String
    var fontSize: String?
    var iconSize: String?
    ...
    var iconDisabledColor: String?
    var iconDisabledBgColor: String?
}
typealias ComputedRef<T> = ComputedRefImpl<T>
open class GenUniModulesLimeCheckboxComponentsLCheckboxLCheckboxSlotDataCheckbox (
    @JsonNotNull
    open var checked: Boolean = false,
    @JsonNotNull
    open var disabled: Boolean = false,
) : SlotData()
fun <T> intersection(vararg spreadArrays: UTSArray<T>): UTSArray<T> {
    var arrays = UTSArray(*spreadArrays)
...
fun setCheckAllStatus(children: UTSArray<LCheckboxComponentPublicInstance>, innerValue: ComputedRef<UTSArray<Any>>, checkedSet: ComputedRef<Set<Any>>): ComputedRef<CheckboxStatus> {
    val intersectionLen = computed(fun(): Number {
        val values: UTSArray<Any> = _uA()
        children.forEach(fun(item){
    ...
    val isAllChecked = computed(fun(): Boolean {
    ...
    return computed(fun(): CheckboxStatus {
...
open class GenUniModulesLimeCheckboxComponentsLCheckboxLCheckboxSlotDataIcon (
    @JsonNotNull
    open var checked: Boolean = false,
    @JsonNotNull
    open var disabled: Boolean = false,
) : SlotData()
open class GenUniModulesLimeCheckboxComponentsLCheckboxLCheckboxSlotDataDefault (
    @JsonNotNull
    open var checked: Boolean = false,
    @JsonNotNull
    open var disabled: Boolean = false,
) : SlotData()
val GenUniModulesLimeCheckboxComponentsLCheckboxLCheckboxClass = CreateVueComponent(GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "component", name = "", inheritAttrs = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.inheritAttrs, inject = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.inject, props = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.props, propsNeedCastKeys = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.propsNeedCastKeys, emits = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.emits, components = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.components, styles = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox.setup(props as GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox)
    }
    )
}
, fun(instance, renderer): GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox {
    return GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox(instance)
}
)
typealias LCheckboxComponentPublicInstance = GenUniModulesLimeCheckboxComponentsLCheckboxLCheckbox
typealias ManageChildInList1 = (child: LCheckboxComponentPublicInstance, shouldAdd: Boolean) -> Unit
typealias CheckboxStatus = String
open class CheckboxChangeOptions (
    @JsonNotNull
    open var checked: Boolean = false,
    @JsonNotNull
    open var checkAll: Boolean = false,
    open var value: Any? = null,
) : UTSObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("CheckboxChangeOptions", "uni_modules/lime-checkbox/components/l-checkbox/type.uts", 56, 13)
    }
}
typealias OnCheckedChange = (options: CheckboxChangeOptions) -> Unit
typealias ComputedRef1<T> = ComputedRefImpl<T>
val GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroupClass = CreateVueComponent(GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "component", name = "", inheritAttrs = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.inheritAttrs, inject = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.inject, props = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.props, propsNeedCastKeys = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.propsNeedCastKeys, emits = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.emits, components = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.components, styles = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.styles, setup = fun(props: ComponentPublicInstance, ctx: SetupContext): Any? {
        return GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup.setup(props as GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup, ctx)
    }
    )
}
, fun(instance, renderer): GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup {
    return GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup(instance)
}
)
typealias LCheckboxGroupComponentPublicInstance = GenUniModulesLimeCheckboxComponentsLCheckboxGroupLCheckboxGroup
val GenPagesIndexDeviceShareDeviceShareClass = CreateVueComponent(GenPagesIndexDeviceShareDeviceShare::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesIndexDeviceShareDeviceShare.inheritAttrs, inject = GenPagesIndexDeviceShareDeviceShare.inject, props = GenPagesIndexDeviceShareDeviceShare.props, propsNeedCastKeys = GenPagesIndexDeviceShareDeviceShare.propsNeedCastKeys, emits = GenPagesIndexDeviceShareDeviceShare.emits, components = GenPagesIndexDeviceShareDeviceShare.components, styles = GenPagesIndexDeviceShareDeviceShare.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenPagesIndexDeviceShareDeviceShare.setup(props as GenPagesIndexDeviceShareDeviceShare)
    }
    )
}
, fun(instance, renderer): GenPagesIndexDeviceShareDeviceShare {
    return GenPagesIndexDeviceShareDeviceShare(instance, renderer)
}
)
val GenPagesIndexDeviceShareDeviceVisitorClass = CreateVueComponent(GenPagesIndexDeviceShareDeviceVisitor::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesIndexDeviceShareDeviceVisitor.inheritAttrs, inject = GenPagesIndexDeviceShareDeviceVisitor.inject, props = GenPagesIndexDeviceShareDeviceVisitor.props, propsNeedCastKeys = GenPagesIndexDeviceShareDeviceVisitor.propsNeedCastKeys, emits = GenPagesIndexDeviceShareDeviceVisitor.emits, components = GenPagesIndexDeviceShareDeviceVisitor.components, styles = GenPagesIndexDeviceShareDeviceVisitor.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenPagesIndexDeviceShareDeviceVisitor.setup(props as GenPagesIndexDeviceShareDeviceVisitor)
    }
    )
}
, fun(instance, renderer): GenPagesIndexDeviceShareDeviceVisitor {
    return GenPagesIndexDeviceShareDeviceVisitor(instance, renderer)
}
)
val GenPagesIndexDeviceShareVisitorDetailClass = CreateVueComponent(GenPagesIndexDeviceShareVisitorDetail::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesIndexDeviceShareVisitorDetail.inheritAttrs, inject = GenPagesIndexDeviceShareVisitorDetail.inject, props = GenPagesIndexDeviceShareVisitorDetail.props, propsNeedCastKeys = GenPagesIndexDeviceShareVisitorDetail.propsNeedCastKeys, emits = GenPagesIndexDeviceShareVisitorDetail.emits, components = GenPagesIndexDeviceShareVisitorDetail.components, styles = GenPagesIndexDeviceShareVisitorDetail.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenPagesIndexDeviceShareVisitorDetail.setup(props as GenPagesIndexDeviceShareVisitorDetail)
    }
    )
}
, fun(instance, renderer): GenPagesIndexDeviceShareVisitorDetail {
    return GenPagesIndexDeviceShareVisitorDetail(instance, renderer)
}
)
val GenPagesIndexAddNewDeviceAddNewDeviceClass = CreateVueComponent(GenPagesIndexAddNewDeviceAddNewDevice::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(type = "page", name = "", inheritAttrs = GenPagesIndexAddNewDeviceAddNewDevice.inheritAttrs, inject = GenPagesIndexAddNewDeviceAddNewDevice.inject, props = GenPagesIndexAddNewDeviceAddNewDevice.props, propsNeedCastKeys = GenPagesIndexAddNewDeviceAddNewDevice.propsNeedCastKeys, emits = GenPagesIndexAddNewDeviceAddNewDevice.emits, components = GenPagesIndexAddNewDeviceAddNewDevice.components, styles = GenPagesIndexAddNewDeviceAddNewDevice.styles, setup = fun(props: ComponentPublicInstance): Any? {
        return GenPagesIndexAddNewDeviceAddNewDevice.setup(props as GenPagesIndexAddNewDeviceAddNewDevice)
    }
    )
}
, fun(instance, renderer): GenPagesIndexAddNewDeviceAddNewDevice {
    return GenPagesIndexAddNewDeviceAddNewDevice(instance, renderer)
}
)
...
fun definePageRoutes() {
    __uniRoutes.push(UniPageRoute(path = "pages/index/index", component = GenPagesIndexIndexClass, meta = UniPageMeta(isQuit = true), style = _uM("navigationStyle" to "custom", "navigationBarTitleText" to "首页", "enableVideo" to true)))
    ...
    __uniRoutes.push(UniPageRoute(path = "pages/index/deviceRechargeData", component = GenPagesIndexDeviceRechargeDataClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationStyle" to "custom", "navigationBarTitleText" to "")))
    __uniRoutes.push(UniPageRoute(path = "pages/index/deviceShare/deviceShare", component = GenPagesIndexDeviceShareDeviceShareClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "分享管理")))
    __uniRoutes.push(UniPageRoute(path = "pages/index/deviceShare/deviceVisitor", component = GenPagesIndexDeviceShareDeviceVisitorClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "访客管理")))
    __uniRoutes.push(UniPageRoute(path = "pages/index/deviceShare/visitorDetail", component = GenPagesIndexDeviceShareVisitorDetailClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationBarTitleText" to "访客信息")))
    __uniRoutes.push(UniPageRoute(path = "pages/index/addNewDevice/addNewDevice", component = GenPagesIndexAddNewDeviceAddNewDeviceClass, meta = UniPageMeta(isQuit = false), style = _uM("navigationStyle" to "custom", "navigationBarTitleText" to "")))
}
...
val __uniLaunchPage: Map<String, Any?> = _uM("url" to "pages/index/index", "style" to _uM("navigationStyle" to "custom", "navigationBarTitleText" to "首页", "enableVideo" to true))
fun defineAppConfig() {
