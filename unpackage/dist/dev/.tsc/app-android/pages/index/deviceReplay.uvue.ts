import { ref, computed, onMounted, getCurrentInstance } from 'vue'
	...
	type TimeMark = { __$originalPosition?: UTSSourceMapPosition<"TimeMark", "pages/index/deviceReplay.uvue", 59, 7>;
		time : number
		position : number
		type : string
	}
	// 响应式状态
	type TimeScrollDetail = { __$originalPosition?: UTSSourceMapPosition<"TimeScrollDetail", "pages/index/deviceReplay.uvue", 371, 7>;
		scrollLeft : number
	}
	// 定义滚动事件类型
	type TimeScrollEvent = { __$originalPosition?: UTSSourceMapPosition<"TimeScrollEvent", "pages/index/deviceReplay.uvue", 375, 7>;
