...
// @ts-expect-error 
override __$getOriginalPosition(): UTSSourceMapPosition { return new UTSSourceMapPosition("SecurityEvent", "pages/message/message.uvue", 54, 8);}
...
// @ts-expect-error 
override __$getOriginalPosition(): UTSSourceMapPosition { return new UTSSourceMapPosition("Tab", "pages/message/message.uvue", 68, 8);}
    ...
    createElementVNode("view", utsMapOf({ class: "content-box" }), [
      createElementVNode("view", utsMapOf({ class: "sub-nav" }), [
        createElementVNode("view", utsMapOf({
          ...
          createElementVNode("view", null, toDisplayString(today.value), 1 /* TEXT */),
          ...
          createElementVNode(Fragment, null, RenderHelpers.renderList(tabs.value, (tab, index, __index, _cached): any => {
            return createElementVNode("view", utsMapOf({
              ...
              createElementVNode("text", utsMapOf({
                class: normalizeClass(utsMapOf({ active: activeTab.value === index }))
              }), toDisplayString(tab.label), 3 /* TEXT, CLASS */)
