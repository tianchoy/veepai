...
const _component_l_grid = resolveEasyComponent("l-grid",_easycom_l_grid)
  ...
  return _cE("view", _uM({ class: "container" }), [
    _cV(_component_l_grid, _uM({
      column: 3,
      border: true,
      gutter: 20
    }), _uM({
      default: withSlotCtx((): any[] => [
        _cV(_component_l_grid_item, _uM({
          text: "标题文字",
...
const GenPagesMineLocalFilesLocalFilesStyles = [_uM([["container", _pS(_uM([["height", "100%"], ["backgroundColor", "#f5f5f5"]]))]])]
