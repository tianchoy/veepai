...
const _component_l_badge = resolveEasyComponent("l-badge",_easycom_l_badge)
  ...
  return createElementVNode("view", utsMapOf({
    ref: "gridRef",
    class: normalizeClass(["l-grid-item", [unref(classes), _ctx.lClass]]),
    onClick: onClick,
    "hover-stay-time": 200,
    ...
    renderSlot(_ctx.$slots, "default", {}, (): any[] => [
      isTrue((_ctx.dot || _ctx.badge != null) && (_ctx.icon != null || _ctx.image != null || _ctx.$slots['icon'] != null))
              ...
              renderSlot(_ctx.$slots, "icon", {}, (): any[] => [
                _ctx.icon != null
                  ? createElementVNode("view", utsMapOf({
                      key: 0,
                      class: normalizeClass(["l-grid-item__icon", unref(imageClasses)])
                    }), [
                  ...
                  : _ctx.image != null
                    ? createElementVNode("image", utsMapOf({
                        key: 1,
                        class: normalizeClass(["l-grid-item__image", unref(imageClasses)]),
                        style: normalizeStyle([unref(imageStyle), unref(innerImageStyle)]),
                        src: _ctx.image,
                        mode: "aspectFill"
        ...
        : isTrue(_ctx.icon != null || _ctx.image != null || _ctx.$slots['icon'] != null)
          ? renderSlot(_ctx.$slots, "icon", utsMapOf({ key: 1 }), (): any[] => [
              _ctx.icon != null
                ? createElementVNode("view", utsMapOf({
                    key: 0,
                    class: normalizeClass(["l-grid-item__icon", unref(imageClasses)])
          ...
          : createCommentVNode("v-if", true),
      createElementVNode("view", utsMapOf({ class: "l-grid-item__content" }), [
        renderSlot(_ctx.$slots, "text", {}, (): any[] => [
          createElementVNode("text", utsMapOf({
            class: normalizeClass(["l-grid-item__title", unref(titleClasses)]),
            style: normalizeStyle([_ctx.lTitleStyle])
          }), toDisplayString(_ctx.text), 7 /* TEXT, CLASS, STYLE */)
        ]),
        renderSlot(_ctx.$slots, "description", {}, (): any[] => [
          createElementVNode("text", utsMapOf({
            class: "l-grid-item__description",
            style: normalizeStyle([_ctx.lDescriptionStyle])
          }), toDisplayString(_ctx.description), 5 /* TEXT, STYLE */)
        ])
      ])
    ]),
...
const GenUniModulesLimeGridComponentsLGridItemLGridItemStyles = [utsMapOf([["l-grid-item", padStyleMapOf(utsMapOf([["alignItems", "center"], ["paddingTop", "32rpx"], ["paddingRight", 0], ["paddingBottom", "24rpx"], ["paddingLeft", 0], ["flexDirection", "column"], ["backgroundImage", "none"], ["backgroundColor", "#ffffff"], ["width", "25%"], ["overflow", "visible"]]))], ["l-grid-item--bordered", padStyleMapOf(utsMapOf([["borderTopWidth", "0.5rpx"], ["borderRightWidth", "0.5rpx"], ["borderBottomWidth", "0.5rpx"], ["borderLeftWidth", "0.5rpx"], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#eeeeee"], ["borderRightColor", "#eeeeee"], ["borderBottomColor", "#eeeeee"], ["borderLeftColor", "#eeeeee"]]))], ["l-grid-item--horizontal", padStyleMapOf(utsMapOf([["paddingTop", "32rpx"], ["paddingRight", 0], ["paddingBottom", "32rpx"], ["paddingLeft", 0], ["flexDirection", "row"], ["justifyContent", "center"]]))], ["l-grid-item__content", utsMapOf([[".l-grid-item--horizontal ", utsMapOf([["marginTop", 0], ["marginLeft", "24rpx"]])], ["", utsMapOf([["position", "relative"], ["marginTop", "16rpx"]])]])], ["l-grid-item--hover", padStyleMapOf(utsMapOf([["backgroundColor", "rgba(0,0,0,0.02)"]]))], ["l-grid-item__title", utsMapOf([[".l-grid-item--center ", utsMapOf([["textAlign", "center"]])], ["", utsMapOf([["color", "rgba(0,0,0,0.88)"], ["fontSize", 14], ["lineHeight", "44rpx"]])]])], ["l-grid-item__description", utsMapOf([[".l-grid-item--center ", utsMapOf([["textAlign", "center"]])], ["", utsMapOf([["color", "rgba(0,0,0,0.45)"], ["fontSize", 12], ["lineHeight", "40rpx"]])]])], ["l-grid-item__icon", padStyleMapOf(utsMapOf([["alignItems", "center"], ["justifyContent", "center"], ["backgroundImage", "none"], ["backgroundColor", "rgba(0,0,0,0.02)"], ["borderTopLeftRadius", "12rpx"], ["borderTopRightRadius", "12rpx"], ["borderBottomRightRadius", "12rpx"], ["borderBottomLeftRadius", "12rpx"], ["width", "96rpx"], ["height", "96rpx"]]))], ["l-grid-item__image", padStyleMapOf(utsMapOf([["backgroundImage", "none"], ["backgroundColor", "rgba(0,0,0,0.02)"], ["borderTopLeftRadius", "12rpx"], ["borderTopRightRadius", "12rpx"], ["borderBottomRightRadius", "12rpx"], ["borderBottomLeftRadius", "12rpx"], ["width", "96rpx"], ["height", "96rpx"]]))], ["l-grid-item__image--small", padStyleMapOf(utsMapOf([["width", 32], ["height", 32]]))], ["l-grid-item__icon--small", padStyleMapOf(utsMapOf([["width", 32], ["height", 32]]))], ["l-grid-item__image--middle", padStyleMapOf(utsMapOf([["width", "80rpx"], ["height", "80rpx"]]))], ["l-grid-item__icon--middle", padStyleMapOf(utsMapOf([["width", "80rpx"], ["height", "80rpx"]]))], ["l-grid-item__title--small", padStyleMapOf(utsMapOf([["fontSize", 12]]))], ["l-grid-item__title--middle", padStyleMapOf(utsMapOf([["fontSize", 12]]))]])]
