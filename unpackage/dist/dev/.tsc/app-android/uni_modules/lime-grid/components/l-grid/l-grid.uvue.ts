...
return (): any | null => {
  ...
  return createElementVNode("view", utsMapOf({
    class: normalizeClass(["l-grid", unref(clsses)]),
    ref_key: "resizeRef",
    ref: resizeRef
  }), [
...
const GenUniModulesLimeGridComponentsLGridLGridStyles = [utsMapOf([["l-grid", padStyleMapOf(utsMapOf([["position", "relative"], ["overflow", "visible"], ["flexDirection", "row"]]))], ["l-grid--wrap", padStyleMapOf(utsMapOf([["flexWrap", "wrap"]]))], ["l-grid--inset", padStyleMapOf(utsMapOf([["marginTop", 0], ["marginRight", "32rpx"], ["marginBottom", 0], ["marginLeft", "32rpx"], ["borderTopLeftRadius", "18rpx"], ["borderTopRightRadius", "18rpx"], ["borderBottomRightRadius", "18rpx"], ["borderBottomLeftRadius", "18rpx"], ["overflow", "hidden"]]))]])]
