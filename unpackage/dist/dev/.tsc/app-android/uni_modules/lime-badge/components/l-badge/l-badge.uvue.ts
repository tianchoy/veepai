    ...
    ? createElementVNode("view", utsMapOf({
        ...
        isTrue(unref(hasContent) || _ctx.dot)
          ? createElementVNode("text", utsMapOf({
              key: 0,
              class: normalizeClass(["l-badge", unref(classes)]),
              ref_key: "textRef",
              ref: textRef,
              style: normalizeStyle([unref(styles)])
            }), [
              renderSlot(_ctx.$slots, "content", {}, (): any[] => [toDisplayString(unref(renderContent))])
            ], 6 /* CLASS, STYLE */)
          : createCommentVNode("v-if", true),
        isTrue(unref(hasContent) || _ctx.dot)
          ? createElementVNode("text", utsMapOf({
              key: 1,
              class: normalizeClass(["l-badge l-badge--offscreen", unref(classes)]),
