...
return (): any | null => {
  ...
  return _cE("view", _uM({
    class: _nC(["l-loading", unref(classes)])
  }), [
    _cE("view", _uM({
      class: "l-loading__view",
      ref_key: "loadingRef",
      ref: loadingRef,
      style: _nS(unref(spinnerStyle))
    }), null, 4 /* STYLE */),
...
const GenUniModulesLimeLoadingComponentsLLoadingLLoadingStyles = [_uM([["l-loading", _uM([["", _uM([["display", "flex"], ["position", "relative"], ["flexDirection", "row"], ["alignItems", "center"], ["borderLeftColor", "#3283ff"], ["borderLeftWidth", 0]])], [".is-vertical", _uM([["flexDirection", "column"]])]])], ["l-loading__text", _uM([["", _uM([["marginLeft", "16rpx"], ["color", "rgba(0,0,0,0.45)"], ["fontSize", 14]])], [".l-loading.is-vertical ", _uM([["marginTop", "8rpx"], ["marginRight", 0], ["marginBottom", 0], ["marginLeft", 0]])]])], ["l-loading__ball", _pS(_uM([["width", "40rpx"], ["height", "40rpx"]]))], ["l-loading__circular", _pS(_uM([["width", "40rpx"], ["height", "40rpx"]]))], ["l-loading__spinner", _pS(_uM([["width", "40rpx"], ["height", "40rpx"]]))]])]
