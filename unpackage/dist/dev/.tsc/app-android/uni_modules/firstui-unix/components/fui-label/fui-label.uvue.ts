...
const _cache = this.$.renderCache
  return createElementVNode("view", utsMapOf({
    class: normalizeClass(["fui-label__wrap", utsMapOf({'fui-label__full':_ctx.full})]),
    style: normalizeStyle(utsMapOf({padding:_ctx.padding,margin:_ctx.margin})),
...
const GenUniModulesFirstuiUnixComponentsFuiLabelFuiLabelStyles = [utsMapOf([["fui-label__wrap", padStyleMapOf(utsMapOf([["boxSizing", "border-box"]]))], ["fui-label__full", padStyleMapOf(utsMapOf([["width", "100%"]]))]])]
