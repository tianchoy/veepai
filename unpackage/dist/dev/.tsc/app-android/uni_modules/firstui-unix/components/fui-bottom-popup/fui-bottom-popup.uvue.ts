...
const _cache = this.$.renderCache
  return createElementVNode("view", utsMapOf({
    ...
    style: normalizeStyle(utsMapOf({ zIndex: _ctx.zIndex,background:_ctx.maskBackground})),
    ...
    createElementVNode("view", utsMapOf({
      ...
      ref: _ctx.refId,
      class: normalizeClass(["fui-bottom__popup", utsMapOf({'fui-bp__safe-weex':_ctx.iphoneX && _ctx.safeArea})]),
      style: normalizeStyle(utsMapOf({borderTopLeftRadius:`${_ctx.radius}rpx`,borderTopRightRadius:`${_ctx.radius}rpx`,background: _ctx.background}))
    }), [
...
const GenUniModulesFirstuiUnixComponentsFuiBottomPopupFuiBottomPopupStyles = [utsMapOf([["fui-bottom__popup-wrap", padStyleMapOf(utsMapOf([["position", "fixed"], ["left", 0], ["right", 0], ["top", 0], ["bottom", 0], ["display", "flex"], ["flexDirection", "row"], ["alignItems", "flex-end"], ["justifyContent", "center"], ["transitionProperty", "opacity,visibility"], ["transitionTimingFunction", "ease-in-out"], ["transitionDuration", "0.3s"], ["visibility", "hidden"], ["borderBottomWidth", 0], ["overflow", "hidden"], ["opacity", 0]]))], ["fui-bottom__popup", padStyleMapOf(utsMapOf([["width", "100%"], ["transitionProperty", "transform,opacity,visibility"], ["transitionTimingFunction", "ease-in-out"], ["transitionDuration", "0.3s"], ["minHeight", "20rpx"], ["overflow", "hidden"], ["transform", "translateY(100%)"], ["display", "flex"], ["flexDirection", "row"], ["position", "relative"]]))], ["fui-bp__safe-weex", padStyleMapOf(utsMapOf([["paddingBottom", 34]]))], ["@TRANSITION", utsMapOf([["fui-bottom__popup-wrap", utsMapOf([["property", "opacity,visibility"], ["timingFunction", "ease-in-out"], ["duration", "0.3s"]])], ["fui-bottom__popup", utsMapOf([["property", "transform,opacity,visibility"], ["timingFunction", "ease-in-out"], ["duration", "0.3s"]])]])]])]
