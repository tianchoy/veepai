  ...
  return createElementVNode("view", utsMapOf({
    ...
    isTrue(_ctx.val)
      ? createElementVNode("view", utsMapOf({
          key: 0,
          class: normalizeClass(["fui-check__mark", utsMapOf({'fui-checkbox__mark-color':_ctx.checkMarkColor==''})]),
...
const GenUniModulesFirstuiUnixComponentsFuiCheckboxFuiCheckboxStyles = [utsMapOf([["fui-checkbox__input", padStyleMapOf(utsMapOf([["width", "40rpx"], ["height", "40rpx"], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["boxSizing", "border-box"], ["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100], ["flexShrink", 0], ["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"], ["justifyContent", "center"], ["overflow", "hidden"], ["position", "relative"]]))], ["fui-checkbox__scale-left", padStyleMapOf(utsMapOf([["transformOrigin", "0 center"]]))], ["fui-checkbox__scale-center", padStyleMapOf(utsMapOf([["transformOrigin", "center center"]]))], ["fui-checkbox__scale-right", padStyleMapOf(utsMapOf([["transformOrigin", "100% center"]]))], ["fui-checkbox__color", padStyleMapOf(utsMapOf([["!backgroundImage", "none"], ["!backgroundColor", "#465CFF"], ["!borderTopColor", "#465CFF"], ["!borderRightColor", "#465CFF"], ["!borderBottomColor", "#465CFF"], ["!borderLeftColor", "#465CFF"]]))], ["fui-checkbox__normal-border", padStyleMapOf(utsMapOf([["!borderTopColor", "#CCCCCC"], ["!borderRightColor", "#CCCCCC"], ["!borderBottomColor", "#CCCCCC"], ["!borderLeftColor", "#CCCCCC"]]))], ["fui-checkbox__background", padStyleMapOf(utsMapOf([["!backgroundImage", "none"], ["!backgroundColor", "#ffffff"]]))], ["fui-checkbox__mark-color", padStyleMapOf(utsMapOf([["!borderBottomColor", "#ffffff"], ["!borderRightColor", "#ffffff"]]))], ["fui-check__mark", padStyleMapOf(utsMapOf([["width", "20rpx"], ["height", "40rpx"], ["borderBottomStyle", "solid"], ["borderBottomWidth", 3], ["borderBottomColor", "#FFFFFF"], ["borderRightStyle", "solid"], ["borderRightWidth", 3], ["borderRightColor", "#FFFFFF"], ["boxSizing", "border-box"], ["transform", "rotate(45deg) scale(0.5)"], ["transformOrigin", "54% 48%"]]))], ["fui-checkbox__disabled", padStyleMapOf(utsMapOf([["opacity", 0.6]]))]])]
