...
return (): any | null => {
  ...
  return createElementVNode("view", utsMapOf({
    class: normalizeClass(["l-textarea", [
    ...
    isTrue(_ctx.label != null || _ctx.$slots['label'] != null)
      ? createElementVNode("text", utsMapOf({
          key: 0,
          class: normalizeClass(["l-textarea__label", [
				'l-textarea__label--' + _ctx.layout,
			]]),
          style: normalizeStyle([_ctx.labelStyle])
        }), [
          renderSlot(_ctx.$slots, "default", {}, (): any[] => [toDisplayString(_ctx.label)])
        ], 6 /* CLASS, STYLE */)
      : createCommentVNode("v-if", true),
    createElementVNode("view", utsMapOf({ class: "l-textarea__wrapper" }), [
      createElementVNode("textarea", utsMapOf({
        class: normalizeClass(["l-textarea__wrapper-inner", utsMapOf({'is-disabled': unref(isDisabled)})]),
      ...
      isTrue(_ctx.indicator && ((_ctx.maxcharacter ?? _ctx.maxlength) > 0 ))
        ? createElementVNode("text", utsMapOf({
          ...
          }), toDisplayString(unref(count)) + " / " + toDisplayString(_ctx.maxcharacter ?? _ctx.maxlength), 5 /* TEXT, STYLE */)
        : createCommentVNode("v-if", true)
    ])
  ], 6 /* CLASS, STYLE */)
}
...
const GenUniModulesLimeTextareaComponentsLTextareaLTextareaStyles = [utsMapOf([["l-textarea", padStyleMapOf(utsMapOf([["boxSizing", "border-box"], ["paddingTop", "32rpx"], ["paddingRight", "32rpx"], ["paddingBottom", "32rpx"], ["paddingLeft", "32rpx"], ["backgroundColor", "#ffffff"]]))], ["l-textarea--horizontal", padStyleMapOf(utsMapOf([["flexDirection", "row"]]))], ["l-textarea__label", padStyleMapOf(utsMapOf([["color", "rgba(0,0,0,0.88)"], ["flexShrink", 0], ["lineHeight", "44rpx"], ["overflow", "hidden"], ["whiteSpace", "nowrap"], ["textOverflow", "ellipsis"]]))], ["l-textarea__label--vertical", padStyleMapOf(utsMapOf([["fontSize", 14], ["paddingBottom", "16rpx"]]))], ["l-textarea__label--horizontal", padStyleMapOf(utsMapOf([["fontSize", 16], ["marginRight", "32rpx"]]))], ["l-textarea__wrapper", padStyleMapOf(utsMapOf([["flex", 1], ["overflow", "hidden"]]))], ["l-textarea__wrapper-inner", padStyleMapOf(utsMapOf([["flex", "1 1 auto"], ["width", "100%"], ["boxSizing", "border-box"], ["minWidth", 0], ["minHeight", 20], ["marginTop", 0], ["marginRight", 0], ["marginBottom", 0], ["marginLeft", 0], ["paddingTop", 0], ["paddingRight", 0], ["paddingBottom", 0], ["paddingLeft", 0], ["textAlign", "left"], ["backgroundColor", "rgba(0,0,0,0)"], ["borderTopWidth", 0], ["borderRightWidth", 0], ["borderBottomWidth", 0], ["borderLeftWidth", 0], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["fontSize", 16], ["color", "rgba(0,0,0,0.88)"], ["lineHeight", "48rpx"]]))], ["l-textarea__placeholder", padStyleMapOf(utsMapOf([["color", "rgba(0,0,0,0.45)"], ["fontSize", 16], ["lineHeight", "48rpx"]]))], ["l-textarea__indicator", padStyleMapOf(utsMapOf([["flexShrink", 0], ["color", "rgba(0,0,0,0.45)"], ["fontSize", "24rpx"], ["textAlign", "right"], ["lineHeight", "40rpx"], ["paddingTop", "16rpx"]]))], ["l-textarea--border", padStyleMapOf(utsMapOf([["position", "relative"]]))], ["l-textarea--border-focused", padStyleMapOf(utsMapOf([["borderBottomColor", "#3283ff"]]))], ["is-disabled", utsMapOf([[".l-textarea ", utsMapOf([["color", "rgba(0,0,0,0.25)"]])]])], ["l-textarea--classic", padStyleMapOf(utsMapOf([["paddingTop", 12], ["paddingRight", 16], ["paddingBottom", 12], ["paddingLeft", 16], ["borderTopLeftRadius", "12rpx"], ["borderTopRightRadius", "12rpx"], ["borderBottomRightRadius", "12rpx"], ["borderBottomLeftRadius", "12rpx"], ["borderTopWidth", 0.5], ["borderRightWidth", 0.5], ["borderBottomWidth", 0.5], ["borderLeftWidth", 0.5], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#eeeeee"], ["borderRightColor", "#eeeeee"], ["borderBottomColor", "#eeeeee"], ["borderLeftColor", "#eeeeee"]]))], ["l-textarea--classic-focused", padStyleMapOf(utsMapOf([["borderTopColor", "#3283ff"], ["borderRightColor", "#3283ff"], ["borderBottomColor", "#3283ff"], ["borderLeftColor", "#3283ff"]]))]])]
