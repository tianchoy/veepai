...
if (!Array) {
  ...
  (_easycom_fui_icon_1 + _easycom_fui_input_1 + _easycom_l_textarea_1 + _easycom_l_upload_1 + _easycom_fui_button_1 + _easycom_l_picker_1 + _easycom_l_popup_1)();
}
...
if (!Math) {
  (_easycom_fui_icon + _easycom_fui_input + _easycom_l_textarea + _easycom_l_upload + _easycom_fui_button + _easycom_l_picker + _easycom_l_popup)();
}
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const showQuestionsPicker = () => {
      common_vendor.index.__f__("log", "at pages/mine/feeback/feeback.uvue:72", "aaaa");
