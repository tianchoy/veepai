...
if (!Array) {
  ...
  (_easycom_fui_icon_1 + _easycom_fui_input_1 + _easycom_l_textarea_1 + _easycom_fui_button_1 + _easycom_l_picker_1 + _easycom_fui_bottom_popup_1)();
}
...
if (!Math) {
  (_easycom_fui_icon + _easycom_fui_input + _easycom_l_textarea + _easycom_fui_button + _easycom_l_picker + _easycom_fui_bottom_popup)();
}
