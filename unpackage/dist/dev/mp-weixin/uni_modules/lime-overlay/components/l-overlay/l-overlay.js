...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent(Object.assign({
  ...
  ariaLabel: new UTSJSONObject({ default: "关闭" }),
  ariaRole: new UTSJSONObject({ default: "button" }),
  lClass: new UTSJSONObject({}),
  bgColor: new UTSJSONObject({}),
  lStyle: new UTSJSONObject({}),
  duration: new UTSJSONObject({ default: 300 }),
  preventScrollThrough: new UTSJSONObject({ type: Boolean, default: true }),
  visible: new UTSJSONObject({ type: Boolean, default: false }),
  zIndex: new UTSJSONObject({ default: 998 })
