...
import uts.sdk.modules.uniWifi.onGetWifiList as uni_onGetWifiList
...
open class GenPagesIndexAddNewDeviceAddNewDevice : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesIndexAddNewDeviceAddNewDevice) -> Any? = fun(__props): Any? {
            ...
            val switchFlash = fun(){
                uni_onGetWifiList(fun(wifiInfo: Any){
                    uni_showToast(ShowToastOptions(title = wifiInfo.wifiList[0].ssid))
                }
                )
            }
            val scanImg = fun(){
