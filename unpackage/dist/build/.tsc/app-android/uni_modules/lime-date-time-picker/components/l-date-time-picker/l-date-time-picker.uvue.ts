...
const __sfc__ = defineComponent({
  ...
  props: {
    ...
    start: { type: Object, required: false },
    steps: { type: UTSJSONObject, required: false },
    ...
    mode: { type: Object, required: true, default: 1 | 2 | 4 },
    customFilter: { type: Function as PropType<(type: TimeModeValues, columns: DateTimePickerColumn) => DateTimePickerColumn>, required: false },
    renderLabel: { type: Function as PropType<(type: string, value: string) => string>, required: false },
...
const _component_l_picker = resolveEasyComponent("l-picker",_easycom_l_picker)
  ...
  return _cV(_component_l_picker, _uM({
    title: _ctx.title,
    ...
    radius: _ctx.radius,
    value: unref(valueOfPicker),
    columns: unref(columns),
    onConfirm: onConfirm,
    onCancel: onCancel,
    onChange: onChange,
    onPick: onPick
  }), null, 8 /* PROPS */, ["title", "titleStyle", "confirm-btn", "confirm-style", "cancel-btn", "cancel-style", "itemHeight", "itemColor", "itemFontSize", "itemActiveColor", "indicatorStyle", "bgColor", "groupHeight", "radius", "value", "columns"])
}
}

})
export default __sfc__
export type LDateTimePickerComponentPublicInstance = InstanceType<typeof __sfc__>;
const GenUniModulesLimeDateTimePickerComponentsLDateTimePickerLDateTimePickerStyles = []
