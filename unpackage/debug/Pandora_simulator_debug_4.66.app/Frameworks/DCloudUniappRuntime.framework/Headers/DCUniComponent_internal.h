...
@property (atomic, strong) UIColor * _Nullable borderTopColor;
@property (atomic, strong) UIColor * _Nullable borderLeftColor;
@property (atomic, strong) UIColor * _Nullable borderRightColor;
@property (atomic, strong) UIColor * _Nullable borderBottomColor;
...
@property(nonatomic, assign) BOOL longpressEvent;
@property(nonatomic, assign) BOOL touchStartEvent;
@property(nonatomic, assign) BOOL touchMoveEvent;
@property(nonatomic, assign) BOOL touchEndEvent;
@property(nonatomic, assign) BOOL touchCancelEvent;
