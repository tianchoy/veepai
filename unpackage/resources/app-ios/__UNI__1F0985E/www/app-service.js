(function(vue) {
  ...
  const _style_0$14 = { "fui-icon": { "": { "fontFamily": "fuiFont" } }, "fui-icon__color": { "": { "!color": "#333333" } }, "fui-icon__active-color": { "": { "!color": "#465CFF" } }, "fui-icon__fontsize": { "": { "!fontSize": "64rpx", "!lineHeight": "64rpx" } }, "@FONT-FACE": [{ "fontFamily": "fuiFont", "src": 'url("/assets/fui-icon.9165208c.ttf")' }] };
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, vue.toDisplayString($options.getIcon), 7);
  }
  const __easycom_1$6 = /* @__PURE__ */ _export_sfc(_sfc_main$18, [["render", _sfc_render$h], ["styles", [_style_0$14]]]);
  ...
  const _sfc_main$17 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "custom-nav" }), [
          vue.createElementVNode("view", new UTSJSONObject({
            class: "nav-back",
            onClick: goBack
          }), [
            props.showBack ? (vue.openBlock(), vue.createBlock(_component_fui_icon, new UTSJSONObject({
              key: 0,
              name: "arrowleft",
              size: "50"
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "nav-item" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "nav-title" }), vue.toDisplayString(props.title), 1)
          ]),
          vue.createElementVNode("view", new UTSJSONObject({
            class: "nav-actions",
            onClick: rightIcon
          }), [
            __props.isText ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({ key: 0 }), vue.toDisplayString(__props.rightText), 1)) : (vue.openBlock(), vue.createBlock(_component_fui_icon, new UTSJSONObject({
              key: 1,
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createVNode(vue.unref(TopNavBar), new UTSJSONObject({
            title: "首页",
            rightText: "plussign",
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              style: new UTSJSONObject({ "border-radius": "15rpx", "overflow": "hidden" })
            }), [
              vue.createElementVNode("video", new UTSJSONObject({
                class: "video",
                id: "myVideo",
            ...
            vue.createElementVNode("view", null, vue.toDisplayString(deviceTitle.value), 1),
            vue.createElementVNode("view", new UTSJSONObject({ class: "video-right-control" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "vedio-control" }), [
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "video-bottom-control" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "vedio-control" }), [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "vedio-control-icon",
                  onClick: pauseClick,
  ...
  const _sfc_main$15 = /* @__PURE__ */ vue.defineComponent({
    ...
    props: {
      ...
      switchMode: { default: "week", type: String },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.dates, (item = null) => {
            return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              ...
              style: vue.normalizeStyle([
                vue.unref(styles),
                item.type == "selected" && _ctx.shape == "square" && _ctx.activeBgColor != null ? new UTSJSONObject({ background: _ctx.activeBgColor }) : new UTSJSONObject({}),
                _ctx.shape == "square" && _ctx.radius != null ? new UTSJSONObject({ "border-radius": _ctx.radius }) : new UTSJSONObject({})
              ]),
              onClick: ($event = null) => {
                return onClick(item);
              },
              ...
              item.prefix != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                key: 0,
                class: vue.normalizeClass(["l-date-strip__grid-prefix", new UTSJSONObject({
                ...
                style: vue.normalizeStyle([
                  item.type == "selected" && _ctx.activeColor != null ? new UTSJSONObject({ color: _ctx.activeColor }) : new UTSJSONObject({})
                ])
              }), vue.toDisplayString(item.prefix), 7)) : vue.createCommentVNode("", true),
              vue.createElementVNode("view", new UTSJSONObject({
                class: vue.normalizeClass(["l-date-strip__grid-info", new UTSJSONObject({
                  "l-date-strip__grid--active-bg": _ctx.shape == "circle" && item.type == "selected"
                })]),
                style: vue.normalizeStyle([
                  item.type == "selected" && _ctx.shape == "circle" && _ctx.activeBgColor != null ? new UTSJSONObject({ background: _ctx.activeBgColor }) : new UTSJSONObject({}),
                  _ctx.shape == "square" && _ctx.radius != null ? new UTSJSONObject({ "border-radius": _ctx.radius }) : new UTSJSONObject({})
                ])
              }), [
                vue.createElementVNode("text", new UTSJSONObject({
                  class: vue.normalizeClass(["l-date-strip__grid-day", new UTSJSONObject({
                ...
                vue.createElementVNode("view", null, [
                  item.suffix == "true" ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ key: 0 }), [
                    vue.createElementVNode("image", new UTSJSONObject({
                      style: new UTSJSONObject({ "width": "16rpx", "height": "16rpx" }),
                      src: _imports_0$a
                    }))
                  ])) : (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ key: 1 }), [
                    vue.createElementVNode("text", new UTSJSONObject({ style: new UTSJSONObject({ "width": "16rpx", "height": "16rpx" }) }))
                  ]))
                ])
              ], 6)
            ], 14, ["onClick"]);
  ...
  const _sfc_main$14 = /* @__PURE__ */ vue.defineComponent({
    __name: "l-date-strip",
    props: {
      firstDayOfWeek: { default: 1, type: Number },
      ...
      weekdays: { default: ["日", "一", "二", "三", "四", "五", "六"], type: Array }
    },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        const _component_l_date_strip_item = resolveEasycom(vue.resolveDynamicComponent("l-date-strip-item"), __easycom_0$9);
        return _ctx.switchMode == "none" ? (vue.openBlock(), vue.createElementBlock("scroll-view", new UTSJSONObject({
          key: 0,
          class: "l-date-strip l-date-strip__scroll",
          "scroll-x": true,
          "scroll-left": vue.unref(scrollLeft),
          "show-scrollbar": false,
          direction: "horizontal",
          style: vue.normalizeStyle([vue.unref(styles)])
        }), [
          vue.createVNode(_component_l_date_strip_item, new UTSJSONObject({
            dates: vue.unref(displayWeeks)[0].dates,
            color: _ctx.color,
        ...
        ], 12, ["scroll-left"])) : (vue.openBlock(), vue.createElementBlock("swiper", new UTSJSONObject({
          key: 1,
          class: "l-date-strip",
          style: vue.normalizeStyle([vue.unref(styles)]),
          current: vue.unref(currentWeekIndex),
          circular: vue.unref(swiperCircular),
          onAnimationfinish: swiperFinish,
          onChange: swiperChange
        }), [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(displayWeeks), (week, g2) => {
            return vue.openBlock(), vue.createElementBlock("swiper-item", new UTSJSONObject({ key: g2 }), [
              vue.createVNode(_component_l_date_strip_item, new UTSJSONObject({
                dates: week.dates,
                color: _ctx.color,
                activeBgColor: _ctx.activeBgColor,
  ...
  const _style_0$10 = { "l-date-strip": { "": { "height": 86, "backgroundColor": "#ffffff" } }, "l-date-strip__scroll": { "": { "flexDirection": "row" } }, "l-date-strip__item": { "": { "display": "flex", "flexDirection": "row", "paddingTop": 8, "paddingRight": 0, "paddingBottom": 8, "paddingLeft": 0, "boxSizing": "border-box" } }, "l-date-strip__item--week": { "": { "flex": 1 } }, "l-date-strip__grid": { ".l-date-strip__item--week ": { "flex": 1 }, ".l-date-strip__item--none ": { "width": 50 }, "": { "display": "flex", "flexDirection": "column", "marginTop": 0, "marginRight": "4rpx", "marginBottom": 0, "marginLeft": "4rpx", "transitionDuration": "300ms", "transitionProperty": "backgroundColor,color", "transitionTimingFunction": "linear" } }, "l-date-strip__grid-prefix": { "": { "textAlign": "center", "transitionDuration": "200ms", "transitionProperty": "color", "transitionTimingFunction": "linear", "fontSize": 14, "color": "rgba(0,0,0,0.45)" }, ".l-date-strip__grid--none ": { "paddingBottom": 4, "paddingTop": 4 }, ".l-date-strip__grid--circle ": { "paddingBottom": 4 } }, "l-date-strip__grid-day": { "": { "textAlign": "center", "transitionDuration": "200ms", "transitionProperty": "color", "transitionTimingFunction": "linear", "fontSize": 16, "color": "rgba(0,0,0,0.88)", "fontWeight": "bold" } }, "l-date-strip__grid-suffix": { "": { "textAlign": "center", "transitionDuration": "200ms", "transitionProperty": "color", "transitionTimingFunction": "linear", "position": "absolute", "top": "50%", "transform": "translateY(60%)", "fontSize": 12, "color": "rgba(0,0,0,0.65)" } }, "l-date-strip__grid-info": { ".l-date-strip__grid--circle ": { "borderTopLeftRadius": 99, "borderTopRightRadius": 99, "borderBottomRightRadius": 99, "borderBottomLeftRadius": 99 }, "": { "display": "flex", "flex": 1, "justifyContent": "center", "alignItems": "center", "position": "relative" } }, "l-date-strip__grid--square": { "": { "borderTopLeftRadius": 5, "borderTopRightRadius": 5, "borderBottomRightRadius": 5, "borderBottomLeftRadius": 5, "paddingTop": 6, "paddingRight": 0, "paddingBottom": 6, "paddingLeft": 0 } }, "l-date-strip__grid--active-bg": { "": { "backgroundColor": "#3283ff" } }, "l-date-strip__grid--active-text": { "": { "color": "#FFFFFF" } }, "l-date-strip__grid--active-text-none": { "": { "color": "#3283ff" } }, "l-date-strip__grid--disabled": { "": { "opacity": 0.4 } }, "@TRANSITION": { "l-date-strip__grid": { "duration": "300ms", "property": "backgroundColor,color", "timingFunction": "linear" }, "l-date-strip__grid-prefix": { "duration": "200ms", "property": "color", "timingFunction": "linear" }, "l-date-strip__grid-day": { "duration": "200ms", "property": "color", "timingFunction": "linear" }, "l-date-strip__grid-suffix": { "duration": "200ms", "property": "color", "timingFunction": "linear" } } };
  const __easycom_0$8 = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["styles", [_style_0$10]]]);
  ...
  const _sfc_main$13 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, _a) {
      ...
      const classes = vue.computed(() => {
        ...
        cls2.set("".concat(name$5, "--font"), !isImage.value && !isIconify.value && !isSVG.value);
        cls2.set("".concat(name$5, "--image"), isImage.value || isIconify.value || isSVG.value);
      ...
      const iconCode = vue.computed(() => {
        var _a2;
        return (_a2 = icons.value.get(innerName.value)) !== null && _a2 !== void 0 ? _a2 : /[^\x00-\x7F]/.test(innerName.value) ? innerName.value : "";
      });
      ...
      return (_ctx = null, _cache = null) => {
        return !vue.unref(isImage) && !vue.unref(isIconify) && !vue.unref(isSVG) ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
          key: 0,
          class: vue.normalizeClass(["l-icon", [vue.unref(classes), __props.lClass]]),
          style: vue.normalizeStyle([vue.unref(styles), __props.lStyle]),
          onClick: _cache[0] || (_cache[0] = ($event = null) => {
            return _ctx.$emit("click");
          })
        }), vue.toDisplayString(vue.unref(iconCode)), 7)) : !vue.unref(isSVG) && !vue.unref(isIconify) && vue.unref(isImage) ? (vue.openBlock(), vue.createElementBlock("image", new UTSJSONObject({
          key: 1,
          class: vue.normalizeClass(["l-icon", [vue.unref(classes), __props.lClass]]),
          style: vue.normalizeStyle([vue.unref(styles), __props.lStyle]),
          src: vue.unref(iconUrl),
          onClick: _cache[1] || (_cache[1] = ($event = null) => {
            return _ctx.$emit("click");
          })
        }), null, 14, ["src"])) : vue.createCommentVNode("", true);
      };
    }
  });
  const _style_0$$ = { "l-icon--font": { "": { "fontFamily": "l", "textAlign": "center" } }, "@FONT-FACE": [{ "fontFamily": "l", "src": 'url("/assets/t3.9658ea31.ttf")' }] };
  const __easycom_0$7 = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["styles", [_style_0$$]]]);
  ...
  const _sfc_main$12 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "calender" }), [
          vue.createElementVNode("canvas", new UTSJSONObject({
            ref_key: "dailyRef",
            ref: dailyRef,
            id: "l-daily-punch",
            class: "l-daily-punch",
  ...
  const _style_0$_ = { "l-daily-punch": { "": { "width": "100%" } }, "calender": { "": { "marginTop": 0, "marginRight": "30rpx", "marginBottom": 0, "marginLeft": "30rpx" } } };
  const __easycom_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["styles", [_style_0$_]]]);
  ...
  const __easycom_4$3 = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["render", _sfc_render$g], ["styles", [_style_0$Z]]]);
  ...
  function _sfc_render$f(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      $data.val && $props.styleType == 1 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
      ...
      $data.val && $props.styleType == 2 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
  ...
  const __easycom_1$5 = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["render", _sfc_render$f], ["styles", [_style_0$Y]]]);
  ...
  function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      $props.topBorder ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
      ...
      $props.bottomBorder ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
  ...
  const __easycom_1$4 = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["render", _sfc_render$e], ["styles", [_style_0$X]]]);
  ...
  const _style_0$W = { "fui-label__wrap": { "": { "boxSizing": "border-box" } }, "fui-label__full": { "": { "width": "100%" } } };
  ...
  const __easycom_2$5 = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["render", _sfc_render$d], ["styles", [_style_0$W]]]);
  ...
  const __easycom_3$5 = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$c]]);
  const _imports_0$9 = "/static/down.png";
  const _imports_1$3 = "/static/notice.png";
  const _imports_0$8 = "/static/vedio.png";
  ...
  let RadioItem$2 = class RadioItem2 extends UTS.UTSType {
    static get$UTSMetadata$() {
      return {
        kind: 2,
        get fields() {
  ...
  const _sfc_main$Y = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const currentDeviceInfo = vue.ref(new RadioItem$2({
        deviceTitle: "",
        iccid: "",
        cardid: "",
        cardState: "",
      ...
      const radioItems = vue.ref([new RadioItem$2({
        deviceTitle: "设备信息",
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "data-strip" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "rili" }), [
              vue.createVNode(_component_l_date_strip, new UTSJSONObject({
                format: customFormat,
                switchMode: "week",
                value: currentDay.value,
                minDate: vue.unref(minDate),
                height: "95rpx",
                shape: "square",
                onChange
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content-box" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "sub-nav" }), [
              vue.createElementVNode("view", new UTSJSONObject({
                class: "today",
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "select" }), [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "notice",
                  src: _imports_1$3,
                  onClick: msgSystem
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "tab-content" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "item-content" }), [
                vue.createElementVNode("view", new UTSJSONObject({ class: "title-box" }), [
                ...
                vue.createElementVNode("view", new UTSJSONObject({ class: "item-detail" }), [
                  vue.createElementVNode("view", new UTSJSONObject({ class: "item-left" }), [
                    vue.createElementVNode("image", new UTSJSONObject({
                      class: "device-img",
                      src: _imports_0$8
                    })),
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "item-content" }), [
                vue.createElementVNode("view", new UTSJSONObject({ class: "title-box" }), [
                  vue.createElementVNode("text", new UTSJSONObject({ class: "title" }), "设备名称1"),
                  vue.createElementVNode("view", new UTSJSONObject({ class: "more" }), [
                    vue.createElementVNode("text", null, "更多"),
                    vue.createVNode(_component_l_icon, new UTSJSONObject({
                      name: "chevron-right",
                      size: "20"
          ...
          vue.createVNode(_component_fui_bottom_popup, new UTSJSONObject({
            visible: showCalendar.value,
            onClose: hideCalendar
          }), {
            default: vue.withCtx(() => {
              return [
                vue.createElementVNode("view", new UTSJSONObject({ class: "calendar-box" }), [
                  vue.createVNode(_component_l_daily_punch, new UTSJSONObject({
          ...
          vue.createVNode(_component_fui_bottom_popup, new UTSJSONObject({
            ...
            default: vue.withCtx(() => {
              return [
                vue.createElementVNode("view", new UTSJSONObject({ class: "fui-scroll__wrap" }), [
                  vue.createElementVNode("view", new UTSJSONObject({ class: "popup-title" }), [
                    vue.createElementVNode("text", null, "设备列表"),
                    vue.createElementVNode("view", new UTSJSONObject({ onClick: closePopup }), [
                      vue.createVNode(_component_fui_icon, new UTSJSONObject({
                        name: "close",
                        size: 40
                      }))
                    ])
                  ]),
                  vue.createVNode(_component_fui_radio_group, new UTSJSONObject({ onChange: getValue }), {
                    default: vue.withCtx(() => {
                      return [
                        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(radioItems.value, (item, index) => {
                          return vue.openBlock(), vue.createBlock(_component_fui_label, new UTSJSONObject({ key: index }), new UTSJSONObject({
                            default: vue.withCtx(() => {
                              return [
                                vue.createVNode(_component_fui_list_cell, null, {
                                  default: vue.withCtx(() => {
                                    return [
                                      vue.createElementVNode("view", new UTSJSONObject({ class: "fui-list__cell" }), [
                                        vue.createElementVNode("text", null, vue.toDisplayString(item.deviceTitle), 1),
                                        vue.createVNode(_component_fui_radio, new UTSJSONObject({
  ...
  const _sfc_main$X = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "files" }), [
            vue.createElementVNode("view", new UTSJSONObject({
              class: "file",
              onClick: localFiles
            }), [
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "file-text" }), "本地文件")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "file" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "fileIcon",
                src: _imports_1$2,
                mode: "aspectFit"
              })),
              vue.createElementVNode("text", new UTSJSONObject({ class: "file-text" }), "永久备份")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "file",
              onClick: msgCenter
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "file-text" }), "消息列表")
            ])
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "tools-list" }), [
            vue.createElementVNode("view", new UTSJSONObject({
              class: "item",
              onClick: userInfo
            }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "个人信息")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "流量充值")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "我的订单")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "常见问题")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "item" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "在线客服")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "意见反馈")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "设置")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "item-text" }), "关于")
              ]),
              vue.createElementVNode("view", null, [
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "right-icon",
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      $props.type == "switch" ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        ...
        $data.val ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$b], ["styles", [_style_0$T]]]);
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      }, vue.toDisplayString($props.text), 7)) : vue.createCommentVNode("", true),
      vue.renderSlot(_ctx.$slots, "default"),
      $props.highlight ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 2,
  ...
  const __easycom_3$4 = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["render", _sfc_render$a], ["styles", [_style_0$S]]]);
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "title" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "title-text" }), "个人信息")
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "info-item" }), [
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "phone" }), [
                vue.createElementVNode("text", null, "18888888888"),
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "icon",
                  src: _imports_0$6,
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "info-item nobottom" }), [
              vue.createElementVNode("text", null, "微信"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "switch-state" }), [
                vue.createElementVNode("text", new UTSJSONObject({ style: new UTSJSONObject({ "margin-right": "10rpx" }) }), vue.toDisplayString(switchVal.value ? "已绑定" : "未绑定"), 1),
                vue.createVNode(_component_fui_switch, new UTSJSONObject({
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "btn-box" }), [
            vue.createVNode(_component_fui_button, new UTSJSONObject({
              color: "#fff",
              text: "退出登陆",
              background: "#1296db",
              onOnclick: logout
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "content-word" }), "账号注销后将会删除个人数据且无法恢复，请谨慎操作。"),
            vue.createElementVNode("text", new UTSJSONObject({ class: "content-word" }), "注销前，请您自行备份重要数据及信息。")
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "btn-box" }), [
  ...
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      $props.label != "" ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        }, vue.toDisplayString($props.label), 7)
  ...
  const __easycom_2$4 = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["render", _sfc_render$9], ["styles", [_style_0$P]]]);
  const _sfc_main$R = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createVNode(_component_fui_input, new UTSJSONObject({
              placeholder: "请输入手机号",
  ...
  const PagesMineUserInfoChangePhoneNumberChangePhoneNumber = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["styles", [_style_0$O]]]);
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          errorMsg.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ key: 0 }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "error-msg" }), vue.toDisplayString(errorMsg.value), 1)
          ])) : vue.createCommentVNode("", true),
          vue.createElementVNode("view", new UTSJSONObject({ class: "tips" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "tips-word" }), "密码8-16位,需包含英文字母、数字、特殊字符中两类及以上")
          ]),
          vue.createElementVNode("view", null, [
            vue.createVNode(_component_fui_button, new UTSJSONObject({
              color: "#fff",
  ...
  const _sfc_main$P = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          class: vue.normalizeClass(["l-progress", vue.unref(classes)]),
          ref: "progressRef"
        }), [
          _ctx.showInfo && _ctx.infoAlign == "start" && _ctx.infoType == "outer" ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 0,
            style: vue.normalizeStyle([vue.unref(textStyle)])
          }), vue.toDisplayString(percent.value + "%"), 5)) : vue.createCommentVNode("", true),
          vue.createElementVNode("view", new UTSJSONObject({
            class: "l-progress__inner",
            ref_key: "progressInnerRef",
            ref: progressInnerRef,
            style: vue.normalizeStyle([vue.unref(innerStyle)])
          }), [
            vue.createElementVNode("view", new UTSJSONObject({
              ref_key: "progressBgRef",
              ref: progressBgRef,
              class: "l-progress-bg",
              style: vue.normalizeStyle([vue.unref(styles)])
            }), [
              _ctx.showInfo && _ctx.infoType == "inner" ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                key: 0,
          ...
          _ctx.showInfo && _ctx.infoAlign == "end" && _ctx.infoType == "outer" ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 1,
            style: vue.normalizeStyle([vue.unref(textStyle)])
          }), vue.toDisplayString(percent.value + "%"), 5)) : vue.createCommentVNode("", true)
        ], 2);
  ...
  const _sfc_main$O = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_fui_bottom_popup = resolveEasycom(vue.resolveDynamicComponent("fui-bottom-popup"), __easycom_4$3);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "device-total" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-total-title" }), [
              vue.createElementVNode("text", null, "充值设备"),
              vue.createElementVNode("text", new UTSJSONObject({ class: "device-total-title-color" }), "（共" + vue.toDisplayString(totalDevice.value) + "台设备）", 1)
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-total-title" }), [
              vue.createElementVNode("text", new UTSJSONObject({ onClick: showPopup }), "更换设备"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                size: 50
              }))
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "device-info-box" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "device-title" }), "设备信息"),
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-info-item" }), [
              vue.createElementVNode("text", null, "ICCID"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "iccid-info" }), [
                vue.createElementVNode("text", new UTSJSONObject({ style: new UTSJSONObject({ "margin-right": "10rpx" }) }), vue.toDisplayString(currentDeviceInfo.value.iccid), 1),
                vue.createVNode(_component_l_icon, new UTSJSONObject({
                  name: "file-copy",
                  color: "#666",
                  size: "16",
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-info-item" }), [
              ...
              vue.createElementVNode("text", null, vue.toDisplayString(currentDeviceInfo.value.cardid), 1)
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-info-item" }), [
              vue.createElementVNode("text", null, "卡片状态"),
              vue.createElementVNode("text", null, vue.toDisplayString(currentDeviceInfo.value.cardState), 1)
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-info-item" }), [
              vue.createElementVNode("text", null, "当前套餐"),
              vue.createElementVNode("text", null, vue.toDisplayString(currentDeviceInfo.value.currentPackage), 1)
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-info-item add-style" }), [
              vue.createElementVNode("text", null, "生效日期"),
              vue.createElementVNode("text", null, vue.toDisplayString(currentDeviceInfo.value.useDate), 1)
            ]),
            vue.createElementVNode("text", null, "流量"),
            vue.createElementVNode("view", new UTSJSONObject({ class: "progess" }), [
              vue.createVNode(_component_l_progress, new UTSJSONObject({
  ...
  const name$4 = "l-loading";
  const _sfc_main$N = /* @__PURE__ */ vue.defineComponent({
    __name: "l-loading",
    props: {
      color: { type: String },
      type: { default: "circular", type: String },
      size: { default: "40rpx", type: String },
      text: { type: String },
      textColor: { type: String },
      textSize: { type: String },
      mode: { default: "raf", type: String },
    ...
    setup(__props) {
      ...
      const classes = vue.computed(() => {
        const cls2 = /* @__PURE__ */ new Map();
        cls2.set(name$4 + "--" + props.type, true);
        if (props.vertical) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          class: vue.normalizeClass(["l-loading", vue.unref(classes)])
        }), [
          vue.createElementVNode("view", new UTSJSONObject({
          ...
          _ctx.$slots["default"] != null || _ctx.text != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 0,
  ...
  const _style_0$K = { "l-loading": { "": { "display": "flex", "position": "relative", "flexDirection": "row", "alignItems": "center", "borderLeftColor": "#3283ff", "borderLeftWidth": 0 }, ".is-vertical": { "flexDirection": "column" } }, "l-loading__text": { "": { "marginLeft": "16rpx", "color": "rgba(0,0,0,0.45)", "fontSize": 14 }, ".l-loading.is-vertical ": { "marginTop": "8rpx", "marginRight": 0, "marginBottom": 0, "marginLeft": 0 } }, "l-loading__ball": { "": { "width": "40rpx", "height": "40rpx" } }, "l-loading__circular": { "": { "width": "40rpx", "height": "40rpx" } }, "l-loading__spinner": { "": { "width": "40rpx", "height": "40rpx" } } };
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["styles", [_style_0$K]]]);
  const _sfc_main$M = /* @__PURE__ */ vue.defineComponent(Object.assign({
    ...
    loadingProps: { type: null },
    shape: { default: "rectangle", type: String },
    ...
    hoverStartTime: { default: 20, type: Number },
    hoverStayTime: { default: 70, type: Number },
    lang: { default: "en", type: String },
    sessionFrom: { default: "", type: String },
    sendMessageTitle: { default: "", type: String },
    sendMessagePath: { default: "", type: String },
    sendMessageImg: { default: "", type: String },
    appParameter: { default: "", type: String },
    ...
    return (_ctx = null, _cache = null) => {
      ...
      const _component_l_icon = resolveEasycom(vue.resolveDynamicComponent("l-icon"), __easycom_0$7);
      return vue.openBlock(), vue.createElementBlock("view", {
        class: vue.normalizeClass(["l-button", vue.unref(classes)]),
        ref: "rootRef",
        "hover-class": _ctx.disabled || _ctx.loading || _ctx.color != null ? "" : (_a2 = _ctx.hoverClass) !== null && _a2 !== void 0 ? _a2 : "hover",
        ...
        onClick: vue.withModifiers(handleTap, ["stop"])
      }, [
        _ctx.loading ? (vue.openBlock(), vue.createBlock(_component_l_loading, new UTSJSONObject({
          key: 0,
          class: "l-button__loading",
          color: vue.unref(loadingColor)
        }), null, 8, ["color"])) : vue.createCommentVNode("", true),
        _ctx.icon ? (vue.openBlock(), vue.createBlock(_component_l_icon, new UTSJSONObject({
          key: 1,
          class: "l-button__icon",
          size: vue.unref(innerIconSize),
          color: vue.unref(loadingColor),
          name: _ctx.icon
        }), null, 8, ["size", "color", "name"])) : vue.createCommentVNode("", true),
        vue.createElementVNode("text", new UTSJSONObject({
          class: vue.normalizeClass(["l-button__content", vue.unref(gapClass)]),
        ...
        _ctx.formType != null || _ctx.openType != null ? (vue.openBlock(), vue.createElementBlock("button", new UTSJSONObject({
          key: 2,
  ...
  const _sfc_main$L = /* @__PURE__ */ vue.defineComponent({
    ...
    props: /* @__PURE__ */ vue.mergeModels(new UTSJSONObject({
      ...
      confirmType: { default: "search", type: String },
      cursor: { type: Number },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          ...
          vue.renderSlot(_ctx.$slots, "left"),
          vue.createElementVNode("view", new UTSJSONObject({
            class: vue.normalizeClass(["l-search__content", vue.unref(contentClass)]),
            style: vue.normalizeStyle([vue.unref(contextStyle)])
          }), [
            vue.renderSlot(_ctx.$slots, "left-icon", new UTSJSONObject({}), () => {
              return [
                _ctx.leftIcon.length > 0 ? (vue.openBlock(), vue.createBlock(_component_l_icon, new UTSJSONObject({
                  key: 0,
                  class: "l-search__icon",
                  size: "42rpx",
                  color: _ctx.iconColor,
                  name: _ctx.leftIcon
                }), null, 8, ["color", "name"])) : vue.createCommentVNode("", true)
              ];
            }),
            vue.createElementVNode("input", {
              name: "input",
              class: "l-search__keyword",
              style: vue.normalizeStyle([vue.unref(inputStyle), _ctx.center ? "text-align:center" : ""]),
              type: _ctx.type,
              ...
              "placeholder-style": ((_a2 = _ctx.placeholderStyle) !== null && _a2 !== void 0 ? _a2 : " ") + (_ctx.center ? "text-align:center" : ""),
            ...
            _ctx.clearable ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              key: 0,
              class: vue.normalizeClass(["l-search__clear", new UTSJSONObject({
              ...
              [vue.vShow, vue.unref(searchValue).length > 0]
            ]) : vue.createCommentVNode("", true),
            vue.renderSlot(_ctx.$slots, "right-icon")
          ], 6),
          vue.renderSlot(_ctx.$slots, "action", new UTSJSONObject({}), () => {
            return [
              _ctx.action != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                key: 0,
                class: vue.normalizeClass(["l-search__action", new UTSJSONObject({ "l-search__action--focused": vue.unref(focused) })]),
                onClick: handleActionClick
              }), vue.toDisplayString(_ctx.action), 3)) : vue.createCommentVNode("", true)
            ];
          })
        ], 4);
      };
  ...
  const _style_0$H = { "l-tab__panel": { "": { "width": "100%", "flex": 1, "flexShrink": 0, "boxSizing": "border-box" } } };
  const __easycom_4$2 = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["styles", [_style_0$H]]]);
  ...
  const _sfc_main$J = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const classes = vue.computed(() => {
        const cls2 = /* @__PURE__ */ new Map();
        cls2.set("".concat(name$3, "--fixed"), toBoolean(context.slots["default"]));
        cls2.set("".concat(name$3, "--dot"), props.dot);
        cls2.set("".concat(name$3, "--").concat(props.position), context.slots["default"] != null);
        return cls2;
      });
      const styles = vue.computed(() => {
        const style = /* @__PURE__ */ new Map();
      ...
      return (_ctx = null, _cache = null) => {
        return _ctx.$slots["default"] != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          key: 0,
          class: "l-badge__wrapper"
        }), [
          vue.renderSlot(_ctx.$slots, "default"),
          vue.unref(hasContent) || _ctx.dot ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 0,
            class: vue.normalizeClass(["l-badge", vue.unref(classes)]),
            ref: "textRef",
            style: vue.normalizeStyle([vue.unref(styles)])
          }), [
            vue.renderSlot(_ctx.$slots, "content", new UTSJSONObject({}), () => {
              return [
                vue.createTextVNode(vue.toDisplayString(vue.unref(renderContent)), 1)
              ];
            })
          ], 6)) : vue.createCommentVNode("", true),
          vue.unref(hasContent) || _ctx.dot ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 1,
            class: vue.normalizeClass(["l-badge l-badge--offscreen", vue.unref(classes)]),
            ref: "offscreenRef",
            style: vue.normalizeStyle([vue.unref(styles)])
          }), [
            vue.renderSlot(_ctx.$slots, "content", new UTSJSONObject({}), () => {
  ...
  const _sfc_main$I = /* @__PURE__ */ vue.defineComponent({
    ...
    props: /* @__PURE__ */ vue.mergeModels(new UTSJSONObject({
      ...
      swiperProgress: { default: 0, type: Number },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "l-tabs" }), [
          vue.createElementVNode("view", new UTSJSONObject({
            class: "l-tabs__wrap",
            style: vue.normalizeStyle([vue.unref(styles), _ctx.lStyle])
          }), [
            ...
            vue.createElementVNode("scroll-view", new UTSJSONObject({
              class: vue.normalizeClass(["l-tabs__scroll", new UTSJSONObject({ "l-tabs__scroll--split": _ctx.split })]),
              ref_key: "scrollRef",
              ref: scrollRef,
              "scroll-left": vue.unref(scrollLeft),
              direction: "horizontal",
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(tabs), (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                  class: vue.normalizeClass(["l-tabs__item", new UTSJSONObject({
                    "l-tabs__item--active": index == vue.unref(currentIndex),
                  ...
                  vue.renderSlot(_ctx.$slots, "label", new UTSJSONObject({
                    item,
                    active: index == vue.unref(currentIndex),
                    disabled: item.disabled
                  }), () => {
                    return [
                      item.dot == true || item.badge != null ? (vue.openBlock(), vue.createBlock(_component_l_badge, new UTSJSONObject({
                        key: 0,
                        dot: item.dot,
                        offset: item.offset,
                        content: item.badge
                        ...
                        default: vue.withCtx(() => {
                          return [
                            vue.createElementVNode("text", new UTSJSONObject({
                              style: vue.normalizeStyle([
                                vue.unref(textStyles),
                                !item.disabled && _ctx.color != null && index != vue.unref(currentIndex) ? "color:" + _ctx.color : "",
                                !item.disabled && _ctx.activeColor != null && index == vue.unref(currentIndex) ? "color:" + _ctx.activeColor : ""
                              ]),
                              class: vue.normalizeClass(["l-tabs__item-text", [
                                "l-tabs__item-text--" + _ctx.size,
                                new UTSJSONObject({
                                  "l-tabs__item-text--disabled": item.disabled,
                                  "l-tabs__item-text--active": index == vue.unref(currentIndex)
                                })
                              ]])
                        ...
                        _: 2
                      }), 1032, ["dot", "offset", "content"])) : (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                        key: 1,
                        style: vue.normalizeStyle([
                          vue.unref(textStyles),
                          !item.disabled && _ctx.color != null && index != vue.unref(currentIndex) ? "color:" + _ctx.color : "",
          ...
          _ctx.$slots["default"] != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
            key: 0,
            class: vue.normalizeClass(["l-tabs__content", new UTSJSONObject({ "l-tabs__content--animated": _ctx.animated })]),
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              style: vue.normalizeStyle([innerStyle]),
              ref_key: "innerRef",
              ref: innerRef
            }), [
              vue.renderSlot(_ctx.$slots, "default")
  ...
  const _sfc_main$H = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_l_icon = resolveEasycom(vue.resolveDynamicComponent("l-icon"), __easycom_0$7);
        const _component_l_tab_panel = resolveEasycom(vue.resolveDynamicComponent("l-tab-panel"), __easycom_4$2);
        const _component_l_tabs = resolveEasycom(vue.resolveDynamicComponent("l-tabs"), __easycom_5$2);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "search-bar" }), [
            vue.createVNode(_component_l_search, new UTSJSONObject({
              class: "search",
              padding: "10rpx 5rpx 10rpx 24rpx",
              modelValue: vue.unref(value),
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event = null) => {
                return vue.isRef(value) ? value.value = $event : null;
              }),
              shape: "round",
              placeholder: "请输入关键字"
            }), {
              "right-icon": vue.withCtx(() => {
                return [
                  vue.createVNode(_component_l_button, new UTSJSONObject({
                    type: "primary",
                    size: "small",
                    shape: "round",
                    onClick: search
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "question-box" }), [
            vue.createVNode(_component_l_tabs, new UTSJSONObject({
              modelValue: vue.unref(tabIndex),
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event = null) => {
                return vue.isRef(tabIndex) ? tabIndex.value = $event : null;
              }),
              "space-evenly": false,
              animated: true
            }), {
              default: vue.withCtx(() => {
                return [
                  vue.createVNode(_component_l_tab_panel, new UTSJSONObject({
                    value: 0,
                    label: "添加设备",
                    ...
                    default: vue.withCtx(() => {
                      return [
                        vue.createElementVNode("view", new UTSJSONObject({ class: "question-item" }), [
  ...
  const PagesMineHelpCenterQuestionDetailQuestionDetail = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$8], ["styles", [_style_0$D]]]);
  const _sfc_main$F = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "title" }), "标题"),
  ...
  */
  ...
  const __easycom_3$3 = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$7], ["styles", [_style_0$B]]]);
  ...
  const __easycom_5$1 = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$6]]);
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            loginType.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ key: 0 }), [
              vue.createVNode(_component_fui_input, new UTSJSONObject({
                ...
                left: vue.withCtx(() => {
                  return [
                    vue.createElementVNode("view", new UTSJSONObject({ style: new UTSJSONObject({ "margin-right": "20rpx" }) }), [
                      vue.createVNode(_component_fui_icon, new UTSJSONObject({
                        name: "mobile",
                        color: "#1296db",
                        size: 48
            ...
            vue.createVNode(_component_fui_checkbox_group, new UTSJSONObject({
              name: "checkbox",
              class: "check-box",
              onChange: isChecked
            }), {
              default: vue.withCtx(() => {
                return [
                  vue.createVNode(_component_fui_label, null, {
                    default: vue.withCtx(() => {
                      return [
                        vue.createVNode(_component_fui_checkbox, new UTSJSONObject({ value: "1" }))
                      ];
                    }),
                    _: 1
                  }),
                  vue.createElementVNode("view", new UTSJSONObject({ class: "fui-text-box" }), [
          ...
          vue.createElementVNode("view", null, [
            vue.createVNode(_component_fui_bottom_popup, new UTSJSONObject({
              ...
              default: vue.withCtx(() => {
                return [
                  vue.createElementVNode("view", new UTSJSONObject({ class: "fui-scroll__wrap" }), [
                    vue.createElementVNode("view", new UTSJSONObject({ class: "fui-title__pb" }), [
                      vue.createElementVNode("text", null, vue.toDisplayString(user_text.value.title), 1),
                      vue.createElementVNode("view", new UTSJSONObject({ onClick: closeUserPopup }), [
                        vue.createVNode(_component_fui_icon, new UTSJSONObject({
                          name: "close",
                          size: 48
                        }))
                    ...
                    vue.createElementVNode("scroll-view", new UTSJSONObject({
                      ...
                      vue.createElementVNode("view", null, vue.toDisplayString(user_text.value.content), 1)
                    ])
                  ])
                ];
              }),
  ...
  const _sfc_main$B = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_fui_bottom_popup = resolveEasycom(vue.resolveDynamicComponent("fui-bottom-popup"), __easycom_4$3);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "vedio-box" }), [
            vue.createElementVNode("video", new UTSJSONObject({
              class: "video",
              id: "myVideo",
              src: videoSrc,
          ...
          vue.createElementVNode("button", new UTSJSONObject({ onClick: playVideo }), "播放视频"),
          vue.createElementVNode("button", new UTSJSONObject({ onClick: pasueVideo }), "暂停视频"),
          vue.createElementVNode("view", new UTSJSONObject({ class: "content-box" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "sub-nav" }), [
              vue.createElementVNode("view", new UTSJSONObject({
                class: "today",
                ...
                vue.createElementVNode("text", null, vue.toDisplayString(today.value), 1),
                vue.createElementVNode("image", new UTSJSONObject({
                  class: "down",
                  src: _imports_0$9
                })),
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "select" }), [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabs.value, (tab, index) => {
                  return vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                    key: index,
                    class: vue.normalizeClass(["select-item", new UTSJSONObject({ active: activeTab.value === index })]),
                    onClick: ($event = null) => {
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "tab-content" }), [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(getFilteredEvents(), (event, index) => {
                return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                  key: index,
                  class: "tab-pane",
                  onClick: ($event = null) => {
                  ...
                  vue.createElementVNode("view", new UTSJSONObject({ class: "item-content" }), [
                    ...
                    vue.createElementVNode("view", new UTSJSONObject({ class: "info" }), [
                      vue.createElementVNode("text", null, vue.toDisplayString(event.type === "human" ? "人形侦测" : "移动侦测"), 1),
                      vue.createElementVNode("text", null, vue.toDisplayString(event.time), 1)
                    ])
                  ]),
                  vue.createElementVNode("image", new UTSJSONObject({
                    class: "item-img",
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$5], ["styles", [_style_0$y]]]);
  ...
  const _sfc_main$z = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        const _component_fui_tag = resolveEasycom(vue.resolveDynamicComponent("fui-tag"), __easycom_0$3);
        const _component_fui_button = resolveEasycom(vue.resolveDynamicComponent("fui-button"), __easycom_3$4);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(content.value, (item, index) => {
              return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                class: "item",
                key: index
              }), [
                ...
                vue.createElementVNode("view", new UTSJSONObject({ class: "item-content" }), [
                  ...
                  vue.createElementVNode("view", new UTSJSONObject({ class: "item-content-bottom" }), [
                    vue.createElementVNode("view", new UTSJSONObject({ class: "tag-time" }), [
                      item.type == "notice" ? (vue.openBlock(), vue.createBlock(_component_fui_tag, new UTSJSONObject({
                        key: 0,
                        text: "通知",
                        "margin-bottom": 24,
                        "margin-right": 24
                      }))) : item.type == "announcement" ? (vue.openBlock(), vue.createBlock(_component_fui_tag, new UTSJSONObject({
                        key: 1,
                        text: "公告",
                        type: "success",
                        "margin-bottom": 24,
                        "margin-right": 24
                      }))) : item.type == "share" ? (vue.openBlock(), vue.createBlock(_component_fui_tag, new UTSJSONObject({
                        key: 2,
                        text: "分享",
                        type: "warning",
                        "margin-bottom": 24,
                    ...
                    item.type == "share" ? (vue.openBlock(), vue.createBlock(_component_fui_button, new UTSJSONObject({
                      key: 0,
                      width: "100rpx",
                      height: "40rpx",
                      size: 25,
  ...
  let tabItem$1 = class tabItem2 extends UTS.UTSType {
    ...
    constructor(options, metadata = tabItem2.get$UTSMetadata$(), isJSONParse = false) {
      super();
      this.__props__ = UTS.UTSType.initProps(options, metadata, isJSONParse);
      this.id = this.__props__.id;
  ...
  let ContentType$1 = class ContentType2 extends UTS.UTSType {
    static get$UTSMetadata$() {
      return {
        kind: 2,
        get fields() {
    ...
    constructor(options, metadata = ContentType2.get$UTSMetadata$(), isJSONParse = false) {
      super();
      this.__props__ = UTS.UTSType.initProps(options, metadata, isJSONParse);
      this.id = this.__props__.id;
      this.title = this.__props__.title;
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createVNode(_component_l_tabs, new UTSJSONObject({
            ...
            default: vue.withCtx(() => {
              return [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabsVal.value, (item, index) => {
                  return vue.openBlock(), vue.createBlock(_component_l_tab_panel, new UTSJSONObject({
                    key: index,
                    value: index,
                    label: item.title
                  }), new UTSJSONObject({
                    default: vue.withCtx(() => {
                      return [
                        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(getFilteredEvents(), (item2, index2) => {
                          return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                            class: "list-item",
                            key: index2
                          }), [
                            vue.createElementVNode("view", new UTSJSONObject({
                              ...
                              vue.createElementVNode("view", new UTSJSONObject({ class: "title-state" }), [
                                vue.createElementVNode("text", new UTSJSONObject({ class: "title-style" }), vue.toDisplayString(item2.title), 1),
                                vue.createElementVNode("text", new UTSJSONObject({ class: "state-style" }), vue.toDisplayString(item2.state), 1)
                              ]),
                              vue.createElementVNode("view", new UTSJSONObject({ class: "device-type" }), [
                                vue.createElementVNode("text", null, "办公室设备"),
                                vue.createElementVNode("text", null, "ICCID " + vue.toDisplayString(item2.iccid), 1)
                              ]),
                              vue.createElementVNode("view", new UTSJSONObject({ class: "date-price" }), [
                                vue.createElementVNode("text", null, vue.toDisplayString(item2.date), 1),
                                vue.createElementVNode("text", new UTSJSONObject({ class: "price" }), vue.toDisplayString(item2.price), 1)
                              ])
                            ], 8, ["onClick"]),
                            item2.isPay == "1" ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                              key: 0,
                              class: "btn"
                            }), [
                              vue.createVNode(_component_fui_button, new UTSJSONObject({
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "item" }), [
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "price" }), "¥128")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "item underline" }), [
  ...
  const _sfc_main$w = /* @__PURE__ */ vue.defineComponent({
    ...
    props: /* @__PURE__ */ vue.mergeModels(new UTSJSONObject({
      ...
      value: { type: String },
      layout: { default: "horizontal", type: String },
      placeholderStyle: { default: "", type: String },
      lStyle: { type: String },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          class: vue.normalizeClass(["l-textarea", [
            ...
            new UTSJSONObject(
              // classic ? 'l-textarea--classic-' + status : '',
              {
                ...
                "l-textarea--classic-disabled": _ctx.classic && vue.unref(isDisabled),
                "l-textarea--classic-focused": _ctx.classic && !vue.unref(isDisabled) && vue.unref(innerFocused),
          ...
          _ctx.label != null || _ctx.$slots["label"] != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 0,
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "l-textarea__wrapper" }), [
            vue.createElementVNode("textarea", new UTSJSONObject({
              class: vue.normalizeClass(["l-textarea__wrapper-inner", new UTSJSONObject({ "is-disabled": vue.unref(isDisabled) })]),
              style: vue.normalizeStyle([_ctx.innerStyle]),
              maxlength: _ctx.maxlength,
              disabled: vue.unref(isDisabled) || vue.unref(isReadonly),
              placeholder: _ctx.placeholder,
              "placeholder-class": "l-textarea__placeholder",
              "placeholder-style": _ctx.placeholderStyle,
              value: vue.unref(innerValue),
  ...
  const b = false, k = "app", E = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = k;
  T("");
  const C = T("[]") || [];
  let x = "";
  try {
  ...
  var xt = class {
    ...
    async request(e2, t2 = true) {
      return e2 = this.setupRequest(e2), Promise.resolve().then(() => le.wrappedRequest(e2, this.adapter.request));
    }
    requestLocal(e2) {
      return new Promise((t2, n2) => {
  ...
  const _sfc_main$v = /* @__PURE__ */ vue.defineComponent({
    ...
    props: {
      ...
      imageFit: { default: "aspectFill", type: String },
      gutter: { type: String },
      column: { type: Number },
      max: { default: 0, type: Number },
      sizeLimit: { type: Number },
      uploadIcon: { default: "camera", type: String },
      uploadIconSize: { type: String },
      gridWidth: { type: String },
      gridHeight: { type: String },
      gridBgColor: { type: String },
      addBgColor: { type: String },
      gridBorderRadius: { type: String },
      defaultFiles: { type: Array },
      loadingText: { default: "上传中...", type: String },
      reloadText: { default: "重新上传", type: String },
      failedText: { default: "上传失败", type: String },
      disablePreview: { type: Boolean, default: false },
      autoUpload: { type: Boolean, default: false },
      mediaType: { default: "image", type: String },
      maxDuration: { type: Number },
      sizeType: { default: ["original", "compressed"], type: Array },
      sourceType: { default: ["album", "camera"], type: Array },
      action: { type: String },
      headers: { type: null },
      formData: { type: null },
      mode: { default: "grid", type: String }
    },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(customFiles), (file, index) => {
            return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              class: "l-upload__item",
              style: vue.normalizeStyle([vue.unref(itemStyle)]),
              key: file.url
            }), [
              vue.renderSlot(_ctx.$slots, "file", new UTSJSONObject({
                file,
                index
              }), () => {
                return [
                  file.type == "image" ? (vue.openBlock(), vue.createElementBlock("image", new UTSJSONObject({
                    key: 0,
                  ...
                  }), null, 8, ["src", "data-file", "mode", "onClick"])) : vue.createCommentVNode("", true),
                  file.type == "video" ? (vue.openBlock(), vue.createElementBlock("video", new UTSJSONObject({
                    key: 1,
                    class: "l-upload__image",
                    src: file.url,
                    "data-file": file,
                  ...
                  }), null, 8, ["src", "data-file", "onClick"])) : vue.createCommentVNode("", true),
                  file.status != null && file.status != "done" ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                    key: 2,
                    ...
                    file.status == "loading" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, new UTSJSONObject({ key: 0 }), [
                      vue.createVNode(_component_l_loading, new UTSJSONObject({
                        class: "l-upload__progress-loading",
                        size: "24px",
                        color: "white"
                      })),
                      file.percent != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                        key: 0,
                        class: "l-upload__progress-text"
                      }), vue.toDisplayString(file.percent) + "%", 1)) : (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                        key: 1,
                        class: "l-upload__progress-text"
                      }), vue.toDisplayString(_ctx.loadingText), 1))
                    ], 64)) : (vue.openBlock(), vue.createBlock(_component_l_icon, new UTSJSONObject({
                      key: 1,
                    ...
                    file.status == "reload" || file.status == "failed" ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                      key: 2,
                      class: "l-upload__progress-text"
                    }), vue.toDisplayString(file.status == "reload" ? _ctx.reloadText : _ctx.failedText), 1)) : vue.createCommentVNode("", true)
                  ], 8, ["data-file", "onClick"])) : vue.createCommentVNode("", true),
                  !vue.unref(isReadonly) ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                    key: 3,
                  ...
                  ], 8, ["data-index", "onClick"])) : vue.createCommentVNode("", true)
                ];
              })
            ], 4);
          }), 128)),
          !vue.unref(isReadonly) ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
            key: 0,
            class: vue.normalizeClass(["l-upload__item l-upload__item--add", new UTSJSONObject({ "l-upload__item--disabled": vue.unref(isDisabled) })]),
            style: vue.normalizeStyle([vue.unref(itemStyle), _ctx.addBgColor != null ? new UTSJSONObject({ background: _ctx.addBgColor }) : ""]),
            "aria-label": "上传",
            onClick: onAddTap
          }), [
            vue.renderSlot(_ctx.$slots, "default", new UTSJSONObject({}), () => {
  ...
  const _sfc_main$u = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_picker_view, new UTSJSONObject({
          ...
          default: vue.withCtx(() => {
            return [
              vue.createVNode(_component_picker_view_column, new UTSJSONObject({ class: "l-picker-item__wrapper" }), {
                default: vue.withCtx(() => {
                  return [
                    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.options, (item = null, i2) => {
                      return vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                        class: vue.normalizeClass(["l-picker-item__group-item", new UTSJSONObject({ "l-picker-item__group-item--active": vue.unref(curIndex) == i2 })]),
                        style: vue.normalizeStyle([vue.unref(itemStyles), vue.unref(curIndex) == i2 ? vue.unref(itemActiveStyles) : new UTSJSONObject({})]),
                        key: item.value
                      }), vue.toDisplayString(item.label), 7);
                    }), 128))
                  ];
  ...
  const _style_0$s = { "l-picker-item__group": { "": { "flex": 1 } }, "l-picker-item__group-item": { "": { "height": 50, "lineHeight": "50px", "textAlign": "center", "transitionDuration": "100ms", "transitionProperty": "fontWeight,color", "transitionTimingFunction": "linear", "fontWeight": "400", "color": "rgba(0,0,0,0.88)", "fontSize": 16, "whiteSpace": "nowrap" } }, "l-picker-item__group-item--active": { "": { "color": "rgba(0,0,0,0.88)", "fontWeight": "700" } }, "l-picker-item__indicator": { "": { "left": "0rpx", "right": "0rpx", "width": "auto", "height": 50, "pointerEvents": "none", "backgroundColor": "rgba(0,0,0,0.02)" } }, "@TRANSITION": { "l-picker-item__group-item": { "duration": "100ms", "property": "fontWeight,color", "timingFunction": "linear" } } };
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["styles", [_style_0$s]]]);
  ...
  const _sfc_main$t = /* @__PURE__ */ vue.defineComponent({
    ...
    props: {
      ...
      loadingSize: { default: "64rpx", type: String },
    ...
    setup(__props, _a) {
      ...
      return (_ctx = null, _cache = null) => {
        var _a2, _b2, _c2;
        const _component_l_picker_item = resolveEasycom(vue.resolveDynamicComponent("l-picker-item"), __easycom_0$2);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          class: "l-picker",
          style: vue.normalizeStyle([vue.unref(styles)]),
          ref: "pickerRef"
          ...
          _ctx.cancelBtn != null || _ctx.title != null || _ctx.confirmBtn != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
            ...
            key: vue.unref(ohosShow)
          }), [
            _ctx.cancelBtn != null ? (vue.openBlock(), vue.createElementBlock("text", {
              class: "l-picker__cancel",
              key: vue.unref(ohosShow),
              style: vue.normalizeStyle((_a2 = _ctx.cancelStyle) !== null && _a2 !== void 0 ? _a2 : ""),
              onClick: onCancel
            }, vue.toDisplayString(_ctx.cancelBtn), 5)) : vue.createCommentVNode("", true),
            (vue.openBlock(), vue.createElementBlock("text", {
              class: "l-picker__title",
              key: vue.unref(ohosShow),
              style: vue.normalizeStyle((_b2 = _ctx.titleStyle) !== null && _b2 !== void 0 ? _b2 : "")
            }, vue.toDisplayString(_ctx.title), 5)),
            _ctx.confirmBtn != null ? (vue.openBlock(), vue.createElementBlock("text", {
              class: "l-picker__confirm",
              key: vue.unref(ohosShow),
              style: vue.normalizeStyle((_c2 = _ctx.confirmStyle) !== null && _c2 !== void 0 ? _c2 : ""),
              onClick: onConfirm
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "item" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "item-label" }), [
                vue.createElementVNode("image", new UTSJSONObject({
                  style: new UTSJSONObject({ "width": "20rpx", "height": "20rpx", "margin-right": "10rpx" }),
                  src: _imports_0$3
                })),
                vue.createElementVNode("text", null, "问题描述")
              ]),
              vue.createVNode(_component_l_textarea, new UTSJSONObject({
                placeholder: "请输入内容",
                maxlength: 200,
                indicator: true,
                autosize: true,
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "item" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "item-label" }), [
                ...
                vue.createElementVNode("text", new UTSJSONObject({ class: "little-title" }), "(问题截图,最多三张)")
              ]),
              vue.createVNode(_component_l_upload, new UTSJSONObject({
                max: 3,
                multiple: true,
          ...
          vue.createVNode(_component_fui_bottom_popup, new UTSJSONObject({ visible: showPicker.value }), {
            default: vue.withCtx(() => {
              return [
  ...
  const PagesMineFeebackFeeback = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["styles", [_style_0$q]]]);
  ...
  const _sfc_main$r = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "items underline" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "offline" }), [
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "tips" }), "设备离线8小时后,推送消息到APP")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "items" }), [
              vue.createVNode(_component_fui_input, new UTSJSONObject({
                label: "自动播放",
                labelSize: 28,
                textAlign: "right",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "tips" }), "摄像机视频是否自动播放")
            ])
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(permissionList.value, (item, index) => {
  ...
  const PagesMineSystemSettingSystemSetting = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["styles", [_style_0$p]]]);
  ...
  const PagesMineAboutAbout = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$4], ["styles", [_style_0$o]]]);
  const name$2 = "l-grid-item";
  const _sfc_main$p = /* @__PURE__ */ vue.defineComponent({
    __name: "l-grid-item",
    props: {
      text: { type: String },
      ...
      url: { type: String },
      openType: { default: "navigateTo", type: String },
      icon: { type: String },
      prefix: { type: String },
      image: { type: String },
      ...
      bgColor: { type: String },
      padding: { type: String },
      layout: { default: "vertical", type: String },
      dot: { type: Boolean, default: false },
      iconSize: { default: "48rpx", type: String },
      iconColor: { default: "rgba(0,0,0,0.88)", type: String },
      badge: { type: null },
      borderColor: { type: String },
      lStyle: { type: null },
      lImageStyle: { type: null },
      lTitleStyle: { type: null },
      lDescriptionStyle: { type: null },
      lClass: { type: String },
      lClassIcon: { type: String }
    },
    emits: ["click"],
    setup(__props, _a) {
      var __emit = _a.emit;
      ...
      const classes = vue.computed(() => {
        var _a2, _b;
        const cls2 = /* @__PURE__ */ new Map();
        cls2.set("".concat(name$2, "--").concat(props.layout), true);
        cls2.set("".concat(name$2, "--").concat((_a2 = parent === null || parent === void 0 ? null : parent.props.align) !== null && _a2 !== void 0 ? _a2 : "center"), true);
        cls2.set("".concat(name$2, "--bordered"), (_b = parent === null || parent === void 0 ? null : parent.props.border) !== null && _b !== void 0 ? _b : false);
        return cls2;
      });
      const size = vue.computed(() => {
      ...
      const imageClasses = vue.computed(() => {
        const cls2 = /* @__PURE__ */ new Map();
        cls2.set("".concat(name$2, "__image--").concat(size.value), true);
        return cls2;
      });
      const titleClasses = vue.computed(() => {
        const cls2 = /* @__PURE__ */ new Map();
        cls2.set("".concat(name$2, "__title--").concat(size.value), true);
        return cls2;
      });
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          ref: "gridRef",
          class: vue.normalizeClass(["l-grid-item", [vue.unref(classes), _ctx.lClass]]),
          onClick,
          "hover-stay-time": 200,
          "hover-class": vue.unref(hover) ? "l-grid-item--hover" : "",
          style: vue.normalizeStyle([vue.unref(styles), _ctx.lStyle])
        }), [
          vue.renderSlot(_ctx.$slots, "default", new UTSJSONObject({}), () => {
            return [
              (_ctx.dot || _ctx.badge != null) && (_ctx.icon != null || _ctx.image != null || _ctx.$slots["icon"] != null) ? (vue.openBlock(), vue.createBlock(_component_l_badge, new UTSJSONObject({
                key: 0,
                content: _ctx.badge,
                dot: _ctx.dot
              }), new UTSJSONObject({
                default: vue.withCtx(() => {
                  return [
                    vue.renderSlot(_ctx.$slots, "icon", new UTSJSONObject({}), () => {
                      return [
                        _ctx.icon != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                          key: 0,
                          class: vue.normalizeClass(["l-grid-item__icon", vue.unref(imageClasses)])
                        }), [
                          vue.createVNode(_component_l_icon, new UTSJSONObject({
                        ...
                        ], 2)) : _ctx.image != null ? (vue.openBlock(), vue.createElementBlock("image", new UTSJSONObject({
                          key: 1,
                          class: vue.normalizeClass(["l-grid-item__image", vue.unref(imageClasses)]),
                          style: vue.normalizeStyle([vue.unref(imageStyle), vue.unref(innerImageStyle)]),
                          src: _ctx.image,
                          mode: "aspectFill"
                        }), null, 14, ["src"])) : vue.createCommentVNode("", true)
                      ];
                ...
                _: 3
              }), 8, ["content", "dot"])) : _ctx.icon != null || _ctx.image != null || _ctx.$slots["icon"] != null ? vue.renderSlot(_ctx.$slots, "icon", new UTSJSONObject({ key: 1 }), () => {
                return [
                  _ctx.icon != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                    key: 0,
                    class: vue.normalizeClass(["l-grid-item__icon", vue.unref(imageClasses)])
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "l-grid-item__content" }), [
                vue.renderSlot(_ctx.$slots, "text", new UTSJSONObject({}), () => {
                  return [
                    vue.createElementVNode("text", new UTSJSONObject({
                      class: vue.normalizeClass(["l-grid-item__title", vue.unref(titleClasses)]),
                ...
                vue.renderSlot(_ctx.$slots, "description", new UTSJSONObject({}), () => {
                  return [
                    ...
                    }), vue.toDisplayString(_ctx.description), 5)
                  ];
                })
              ])
            ];
  ...
  const _sfc_main$o = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          class: vue.normalizeClass(["l-grid", vue.unref(clsses)]),
          ref_key: "resizeRef",
          ref: resizeRef
        }), [
          vue.renderSlot(_ctx.$slots, "default")
  ...
  const _sfc_main$n = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createVNode(_component_l_grid, new UTSJSONObject({
            column: 3,
            border: true,
            gutter: 20
          }), {
            default: vue.withCtx(() => {
              return [
                vue.createVNode(_component_l_grid_item, new UTSJSONObject({
                  text: "标题文字",
  ...
  const _style_0$l = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5" } } };
  const PagesMineLocalFilesLocalFiles = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["styles", [_style_0$l]]]);
  const _imports_0$1 = "/static/device/camera.png";
  const _imports_1$1 = "/static/device/vedio.png";
    ...
    setup(__props) {
      ...
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "control-big" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "big-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "big-item-icon",
                src: _imports_0$1
              }))
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "control-more" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
                src: _imports_4
              })),
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "画质")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "智能侦测")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "夜视模式")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "镜头翻转")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "云台")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "巡航")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "警笛")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "small-item" }), [
              vue.createElementVNode("image", new UTSJSONObject({
                class: "small-item-icon",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "红蓝灯")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "small-item",
              onClick: replay
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "回放")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "small-item",
              onClick: share
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "small-item-text" }), "分享")
            ])
          ])
        ]);
      };
  ...
  const _sfc_main$l = /* @__PURE__ */ vue.defineComponent(Object.assign({
    ...
    cursorColor: { default: "", type: String },
    cursorSpacing: { default: 0, type: Number },
    disabled: { type: Boolean, default: false },
    focus: { type: Boolean, default: false },
    holdKeyboard: { type: Boolean, default: false },
    ...
    placeholderClass: { type: String },
    readonly: { type: Boolean, default: false },
    safePasswordCertPath: { default: "", type: String },
    safePasswordCustomHash: { default: "", type: String },
    safePasswordLength: { type: Number },
    safePasswordNonce: { default: "", type: String },
    safePasswordSalt: { default: "", type: String },
    safePasswordTimeStamp: { type: Number },
    selectionEnd: { default: -1, type: Number },
    selectionStart: { default: -1, type: Number },
    status: { default: "default", type: String },
    prefixIcon: { type: String },
    prefixIconColor: { type: String },
    suffix: { type: String },
    suffixIcon: { type: String },
    suffixIconColor: { type: String },
    tips: { type: String },
    type: { default: "text", type: String },
    value: { type: [String, Number] },
    modelValue: { type: [String, Number] },
    lStyle: { type: String },
    lableStyle: { type: String },
    tipsStyle: { type: String },
    inputStyle: { type: String },
    borderColor: { type: String },
    classic: { type: Boolean, default: false },
    focused: { type: Boolean, default: false },
    focusedBorderColor: { type: String },
    prefixIconSize: { type: String },
    suffixIconSize: { type: String },
    ...
    const calculateValue = (value) => {
      ...
      const maxcharacter = props.maxcharacter;
      if (maxcharacter != null && maxcharacter > 0) {
        return characterLimit("maxcharacter", "".concat(value), maxcharacter);
      }
      return {
        characters: "".concat(value),
        length: "".concat(value).length
      };
    };
    let _innerValue = vue.ref("");
    const innerFocused = vue.ref(props.focus || props.focused);
    const innerValue = vue.computed({
      set(value) {
      ...
      get() {
        ...
        if (_innerValue.value != _value && props.type != "number") {
          const characters = calculateValue("".concat(_value !== null && _value !== void 0 ? _value : _innerValue.value)).characters;
          return characters;
        }
    ...
    const showClearIcon = vue.computed(() => {
      ...
      return "".concat(innerValue.value).length > 0 || clearTrigger == "always";
    });
    const onInput = (e2) => {
      const _a2 = e2.detail, value = _a2.value;
      _a2.cursor;
      _a2.keyCode;
      if (props.type == "number") {
        const _v = parseFloat("".concat(value));
    ...
    const _b = useDrawBorder(rootRef, new DrawBorderOptions({
      direction: "bottom",
      watchSize: true,
      startOffset: 16,
      immediate: false,
    ...
    vue.onMounted(() => {
      vue.watchEffect(() => {
        ...
        if (!props.classic) {
          if (props.borderColor != null && !innerFocused.value) {
            (_a2 = rootRef.value) === null || _a2 === void 0 ? null : _a2.style.setProperty("border-color", props.borderColor);
          }
          if (props.focusedBorderColor != null && innerFocused.value) {
            (_b2 = rootRef.value) === null || _b2 === void 0 ? null : _b2.style.setProperty("border-color", props.focusedBorderColor);
          }
        }
        if (!props.bordered || props.classic) {
          clearBorder();
    ...
    return (_ctx = null, _cache = null) => {
      const _component_l_icon = resolveEasycom(vue.resolveDynamicComponent("l-icon"), __easycom_0$7);
      return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
        class: vue.normalizeClass(["l-input", [
          "l-input--" + _ctx.layout,
          _ctx.classic ? "l-input--classic-" + _ctx.status : "",
          new UTSJSONObject({ "l-input--classic": _ctx.classic }),
          new UTSJSONObject({ "l-input--classic-disabled": _ctx.classic && _ctx.disabled }),
          new UTSJSONObject({ "l-input--classic-focused": _ctx.classic && !_ctx.disabled && vue.unref(innerFocused) }),
          new UTSJSONObject({ "l-input--border": _ctx.bordered && !_ctx.classic })
        ]]),
        style: vue.normalizeStyle([vue.unref(styles), _ctx.lStyle]),
        ref_key: "rootRef",
        ref: rootRef
      }), [
        _ctx.label != null || _ctx.$slots["label"] != null || _ctx.$slots["prefix-icon"] != null || _ctx.prefixIcon != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          key: 0,
          class: "l-input__wrap--prefix"
        }), [
          vue.renderSlot(_ctx.$slots, "prefix-icon", new UTSJSONObject({}), () => {
            return [
              _ctx.prefixIcon != null ? (vue.openBlock(), vue.createBlock(_component_l_icon, new UTSJSONObject({
                key: 0,
                class: "l-input__icon--prefix",
                name: _ctx.prefixIcon,
                color: _ctx.prefixIconColor,
                size: _ctx.prefixIconSize
              }), null, 8, ["name", "color", "size"])) : vue.createCommentVNode("", true)
            ];
          }),
          _ctx.label != null || _ctx.$slots["label"] != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 0,
            class: vue.normalizeClass(["l-input__label", new UTSJSONObject({ "l-input__label--gap": _ctx.prefixIcon != null || _ctx.$slots["prefix-icon"] != null })]),
            style: vue.normalizeStyle([_ctx.lableStyle])
          }), [
            vue.renderSlot(_ctx.$slots, "label", new UTSJSONObject({}), () => {
              return [
                vue.createTextVNode(vue.toDisplayString(_ctx.label), 1)
        ...
        vue.createElementVNode("view", new UTSJSONObject({ class: "l-input__wrap" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "l-input__content" }), [
            vue.createElementVNode("input", new UTSJSONObject({
              class: vue.normalizeClass(["l-input__control", [
                "l-input--" + _ctx.align,
                new UTSJSONObject({
                  "l-input__control--disabled": vue.unref(isDisabled),
                  "l-input__control--read-only": vue.unref(isReadonly)
                })
              ]]),
              ...
              placeholder: _ctx.placeholder,
              "placeholder-style": _ctx.placeholderStyle,
              "placeholder-class": _ctx.placeholderStyle == "" ? vue.unref(isDisabled) || vue.unref(isReadonly) ? "l-input__placeholder--disabled" : "l-input__placeholder" : "",
              value: vue.unref(innerValue),
            ...
            _ctx.suffix != null || _ctx.$slots["suffix"] != null ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              key: 1,
              ...
              vue.renderSlot(_ctx.$slots, "suffix", new UTSJSONObject({}), () => {
                return [
                  vue.createElementVNode("text", new UTSJSONObject({ class: "l-input__wrap--suffix-text" }), vue.toDisplayString(_ctx.suffix), 1)
                ];
              })
            ])) : vue.createCommentVNode("", true),
            vue.renderSlot(_ctx.$slots, "suffix-icon", new UTSJSONObject({}), () => {
              return [
                _ctx.suffixIcon != null ? (vue.openBlock(), vue.createBlock(_component_l_icon, new UTSJSONObject({
                  key: 0,
          ...
          _ctx.tips != null && _ctx.tips.length > 0 || _ctx.$slots["tips"] != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
            key: 0,
            class: vue.normalizeClass(["l-input__tips", ["l-input__tips--" + _ctx.status]]),
            style: vue.normalizeStyle([_ctx.tipsStyle])
          }), [
            vue.renderSlot(_ctx.$slots, "tips", new UTSJSONObject({}), () => {
              return [
                vue.createTextVNode(vue.toDisplayString(_ctx.tips), 1)
              ];
            })
          ], 6)) : vue.createCommentVNode("", true)
        ])
  ...
  const _style_0$i = { "l-overlay": { "": { "position": "fixed", "top": 0, "left": 0, "width": "100%", "bottom": 0, "backgroundColor": "rgba(0,0,0,0.6)", "transitionDuration": "300ms", "transitionProperty": "opacity", "transitionTimingFunction": "ease", "zIndex": 998, "opacity": 1 } }, "l-fade-enter": { "": { "opacity": 0 } }, "l-fade-leave-to": { "": { "opacity": 0 } }, "@TRANSITION": { "l-overlay": { "duration": "300ms", "property": "opacity", "timingFunction": "ease" } } };
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["styles", [_style_0$i]]]);
  ...
  const _sfc_main$i = /* @__PURE__ */ vue.defineComponent({
    ...
    props: /* @__PURE__ */ vue.mergeModels(new UTSJSONObject({
      actions: { type: Array },
      buttonLayout: { default: "horizontal", type: String },
      cancelBtn: { type: null },
      closeBtn: { type: Boolean },
      closeOnClickOverlay: { type: Boolean, default: true },
      confirmBtn: { type: null },
      content: { type: String },
    ...
    emits: /* @__PURE__ */ vue.mergeModels(["action", "confirm", "cancel", "click", "agreeprivacyauthorization", "chooseavatar", "getuserinfo", "contact", "getphonenumber", "error", "opensetting", "launchapp"], ["update:modelValue"]),
    setup(__props, _a) {
      var __expose = _a.expose, __emit = _a.emit;
      const emit = __emit;
      const props = __props;
      const dialogCallbacks = vue.reactive({
        beforeClose: null,
        onAction: null,
        onConfirm: null,
        onCancel: null
      });
      const innerOptions = vue.reactive({
      ...
      const closeBtnProps = vue.computed(() => {
        var _a2, _b;
        return (_b = (_a2 = innerOptions.closeBtn) !== null && _a2 !== void 0 ? _a2 : props.closeBtn) !== null && _b !== void 0 ? _b : false;
      });
      const cancelBtnProps = vue.computed(() => {
        var _a2;
        return parseToObject((_a2 = props.cancelBtn) !== null && _a2 !== void 0 ? _a2 : innerOptions.cancelBtn);
      });
      const confirmBtnProps = vue.computed(() => {
        var _a2;
        return parseToObject((_a2 = props.confirmBtn) !== null && _a2 !== void 0 ? _a2 : innerOptions.confirmBtn);
      });
      const innerTitle = vue.computed(() => {
        var _a2;
        return (_a2 = props.title) !== null && _a2 !== void 0 ? _a2 : innerOptions.title;
      });
      const innerButtonLayout = vue.computed(() => {
        var _a2;
        return (_a2 = innerOptions.buttonLayout) !== null && _a2 !== void 0 ? _a2 : props.buttonLayout;
      });
      const innerActions = vue.computed(() => {
        var _a2;
        return (_a2 = props.actions) !== null && _a2 !== void 0 ? _a2 : innerOptions.actions;
      });
      const buttonVariant = vue.computed(() => {
        var _a2;
      ...
      const _updateOptions = (options) => {
        ...
        if (innerOptions.actions != null && (innerOptions.actions.length == 0 || innerOptions.actions.length > maxLengthSuggestion)) {
          uni.__log__("warn", "at uni_modules/lime-dialog/components/l-dialog/l-dialog.uvue:390", "action 数量建议控制在1至".concat(maxLengthSuggestion, "个"));
        }
        ...
        innerOptions.closeOnClickOverlay = (_e2 = options.getBoolean("closeOnClickOverlay")) !== null && _e2 !== void 0 ? _e2 : props.closeOnClickOverlay;
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_l_popup, {
          visible: vue.unref(innerValue),
          overlay: (_a2 = vue.unref(innerOptions).overlay) !== null && _a2 !== void 0 ? _a2 : _ctx.overlay,
          "bg-color": "transparent",
          closeOnClickOverlay: (_b = vue.unref(innerOptions).closeOnClickOverlay) !== null && _b !== void 0 ? _b : _ctx.closeOnClickOverlay,
          preventScrollThrough: (_c = vue.unref(innerOptions).preventScrollThrough) !== null && _c !== void 0 ? _c : _ctx.preventScrollThrough,
          zIndex: (_d = _ctx.zIndex) !== null && _d !== void 0 ? _d : vue.unref(innerOptions).zIndex,
          onChange: overlayClick,
          position: "center"
        }, {
          default: vue.withCtx(() => {
            return [
              vue.createElementVNode("view", new UTSJSONObject({ class: "l-dialog" }), [
                vue.renderSlot(_ctx.$slots, "top"),
                vue.unref(closeBtnProps) ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                  key: 0,
                ...
                vue.createElementVNode("view", new UTSJSONObject({ class: "l-dialog__content" }), [
                  vue.renderSlot(_ctx.$slots, "title", new UTSJSONObject({}), () => {
                    var _a3;
                    return [
                      vue.unref(innerTitle) != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
                        key: 0,
                        class: "l-dialog__header"
                      }), vue.toDisplayString((_a3 = _ctx.title) !== null && _a3 !== void 0 ? _a3 : vue.unref(innerOptions).title), 1)) : vue.createCommentVNode("", true)
                    ];
                  }),
                  vue.createElementVNode("view", new UTSJSONObject({
                    class: vue.normalizeClass(["l-dialog__body", new UTSJSONObject({ "l-dialog__body--gap": vue.unref(innerTitle) != null || _ctx.$slots["title"] != null })])
                  }), [
                    vue.renderSlot(_ctx.$slots, "default", new UTSJSONObject({}), () => {
                      var _a3;
                      return [
                        vue.createElementVNode("text", new UTSJSONObject({ class: "l-dialog__body-text" }), vue.toDisplayString((_a3 = vue.unref(innerOptions).content) !== null && _a3 !== void 0 ? _a3 : _ctx.content), 1)
                      ];
                    })
                  ], 2)
                ]),
                ...
                vue.createElementVNode("view", new UTSJSONObject({
                  class: vue.normalizeClass(["l-dialog__footer", [
                    "l-dialog__footer--" + vue.unref(innerButtonLayout),
                    new UTSJSONObject({
                      "l-dialog__footer--column": vue.unref(innerButtonLayout) == "vertical",
                      "l-dialog__footer--full": vue.unref(buttonVariant)
                    })
                  ]])
                }), [
                  vue.renderSlot(_ctx.$slots, "actions", new UTSJSONObject({}), () => {
                    return [
                      vue.unref(innerActions) != null ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, new UTSJSONObject({ key: 0 }), vue.renderList(vue.unref(innerActions), (action, index) => {
                        var _a3, _b2, _c2, _d2, _e2, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s2, _t2, _u, _v;
                        return vue.openBlock(), vue.createBlock(_component_l_button, {
                          class: vue.normalizeClass(["l-dialog__button", [
                            "l-dialog__button--" + vue.unref(innerButtonLayout),
                            new UTSJSONObject({
                              "l-dialog__button--text": vue.unref(buttonVariant)
                            })
                          ]]),
                          key: index,
                          style: vue.normalizeStyle([
                            vue.unref(buttonStyle),
                            new UTSJSONObject({
                              "margin-left": vue.unref(innerButtonLayout) == "horizontal" && !vue.unref(buttonVariant) && index > 0 ? "20rpx" : "0",
                              "margin-bottom": vue.unref(innerButtonLayout) == "vertical" && !vue.unref(buttonVariant) && index > 0 ? "20rpx" : "0"
                            })
                          ]),
                          ...
                          loading: (_e2 = action.getBoolean("loading")) !== null && _e2 !== void 0 ? _e2 : false,
                          type: (_f = action.getString("type")) !== null && _f !== void 0 ? _f : "primary",
                          ghost: (_g = action.getBoolean("loading")) !== null && _g !== void 0 ? _g : false,
                          shape: (_h = action.getString("shape")) !== null && _h !== void 0 ? _h : "rectangle",
                          size: (_j = action.getString("size")) !== null && _j !== void 0 ? _j : "medium",
                          variant: action.getString("variant"),
                          "open-type": (_k = action.getString("openType")) !== null && _k !== void 0 ? _k : "",
                          color: action.getString("color"),
                          textColor: action.getString("textColor"),
                          fontSize: action.getString("fontSize"),
                          "hover-stop-propagation": (_l = action.getBoolean("hoverStopPropagation")) !== null && _l !== void 0 ? _l : false,
                          "hover-start-time": (_m = action.getNumber("hoverStartTime")) !== null && _m !== void 0 ? _m : 20,
                          "hover-stay-time": (_o = action.getNumber("hoverStayTime")) !== null && _o !== void 0 ? _o : 70,
                          lang: (_p = action.getString("lang")) !== null && _p !== void 0 ? _p : "en",
                          "session-from": (_q = action.getString("sessionFrom")) !== null && _q !== void 0 ? _q : "",
                          "send-message-title": (_r = action.getString("sendMessageTitle")) !== null && _r !== void 0 ? _r : "",
                          "send-message-path": (_s2 = action.getString("sendMessagePath")) !== null && _s2 !== void 0 ? _s2 : "",
                          "send-message-img": (_t2 = action.getString("sendMessageImg")) !== null && _t2 !== void 0 ? _t2 : "",
                          "app-parameter": (_u = action.getString("appParameter")) !== null && _u !== void 0 ? _u : "",
                          "show-message-card": (_v = action.getBoolean("showMessageCard")) !== null && _v !== void 0 ? _v : false,
                          onClick: ($event = null) => {
                          ...
                          default: vue.withCtx(() => {
                            return [
                              vue.createTextVNode(vue.toDisplayString(action["content"]), 1)
                            ];
                          }),
                          _: 2
                        }), 1032, ["class", "style", "block", "disabled", "data-extra", "content", "icon", "loading", "type", "ghost", "shape", "size", "variant", "open-type", "color", "textColor", "fontSize", "hover-stop-propagation", "hover-start-time", "hover-stay-time", "lang", "session-from", "send-message-title", "send-message-path", "send-message-img", "app-parameter", "show-message-card", "onClick"]);
                      }), 128)) : vue.createCommentVNode("", true)
                    ];
                  }),
                  vue.renderSlot(_ctx.$slots, "cancel-btn", new UTSJSONObject({}), () => {
                    var _a3, _b2, _c2, _d2, _e2, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s2, _t2, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19;
                    return [
                      vue.unref(cancelBtnProps) != null ? (vue.openBlock(), vue.createBlock(_component_l_button, {
                        key: 0,
                        class: vue.normalizeClass(["l-dialog__button", [
                          "l-dialog__button--" + vue.unref(innerButtonLayout),
                          new UTSJSONObject({
                        ...
                        block: (_b2 = (_a3 = vue.unref(cancelBtnProps)) === null || _a3 === void 0 ? null : _a3.getBoolean("block")) !== null && _b2 !== void 0 ? _b2 : false,
                        disabled: (_d2 = (_c2 = vue.unref(cancelBtnProps)) === null || _c2 === void 0 ? null : _c2.getBoolean("disabled")) !== null && _d2 !== void 0 ? _d2 : false,
                        content: (_f = (_e2 = vue.unref(cancelBtnProps)) === null || _e2 === void 0 ? null : _e2.getString("content")) !== null && _f !== void 0 ? _f : "",
                        icon: (_h = (_g = vue.unref(cancelBtnProps)) === null || _g === void 0 ? null : _g.getString("icon")) !== null && _h !== void 0 ? _h : "",
                        loading: (_k = (_j = vue.unref(cancelBtnProps)) === null || _j === void 0 ? null : _j.getBoolean("loading")) !== null && _k !== void 0 ? _k : false,
                        type: (_m = (_l = vue.unref(cancelBtnProps)) === null || _l === void 0 ? null : _l.getString("type")) !== null && _m !== void 0 ? _m : "primary",
                        ghost: (_p = (_o = vue.unref(cancelBtnProps)) === null || _o === void 0 ? null : _o.getBoolean("loading")) !== null && _p !== void 0 ? _p : false,
                        shape: (_r = (_q = vue.unref(cancelBtnProps)) === null || _q === void 0 ? null : _q.getString("shape")) !== null && _r !== void 0 ? _r : "rectangle",
                        size: (_t2 = (_s2 = vue.unref(cancelBtnProps)) === null || _s2 === void 0 ? null : _s2.getString("size")) !== null && _t2 !== void 0 ? _t2 : "medium",
                        variant: (_v = (_u = vue.unref(cancelBtnProps)) === null || _u === void 0 ? null : _u.getString("variant")) !== null && _v !== void 0 ? _v : "light",
                        "open-type": (_w = vue.unref(cancelBtnProps)) === null || _w === void 0 ? null : _w.getString("openType"),
                        color: (_x = vue.unref(cancelBtnProps)) === null || _x === void 0 ? null : _x.getString("color"),
                        textColor: (_y = vue.unref(cancelBtnProps)) === null || _y === void 0 ? null : _y.getString("textColor"),
                        fontSize: (_z = vue.unref(cancelBtnProps)) === null || _z === void 0 ? null : _z.getString("fontSize"),
                        "hover-stop-propagation": (_1 = (_0 = vue.unref(cancelBtnProps)) === null || _0 === void 0 ? null : _0.getBoolean("hoverStopPropagation")) !== null && _1 !== void 0 ? _1 : false,
                        "hover-start-time": (_3 = (_2 = vue.unref(cancelBtnProps)) === null || _2 === void 0 ? null : _2.getNumber("hoverStartTime")) !== null && _3 !== void 0 ? _3 : 20,
                        "hover-stay-time": (_5 = (_4 = vue.unref(cancelBtnProps)) === null || _4 === void 0 ? null : _4.getNumber("hoverStayTime")) !== null && _5 !== void 0 ? _5 : 70,
                        lang: (_7 = (_6 = vue.unref(cancelBtnProps)) === null || _6 === void 0 ? null : _6.getString("lang")) !== null && _7 !== void 0 ? _7 : "en",
                        "session-from": (_9 = (_8 = vue.unref(cancelBtnProps)) === null || _8 === void 0 ? null : _8.getString("sessionFrom")) !== null && _9 !== void 0 ? _9 : "",
                        "send-message-title": (_11 = (_10 = vue.unref(cancelBtnProps)) === null || _10 === void 0 ? null : _10.getString("sendMessageTitle")) !== null && _11 !== void 0 ? _11 : "",
                        "send-message-path": (_13 = (_12 = vue.unref(cancelBtnProps)) === null || _12 === void 0 ? null : _12.getString("sendMessagePath")) !== null && _13 !== void 0 ? _13 : "",
                        "send-message-img": (_15 = (_14 = vue.unref(cancelBtnProps)) === null || _14 === void 0 ? null : _14.getString("sendMessageImg")) !== null && _15 !== void 0 ? _15 : "",
                        "app-parameter": (_17 = (_16 = vue.unref(cancelBtnProps)) === null || _16 === void 0 ? null : _16.getString("appParameter")) !== null && _17 !== void 0 ? _17 : "",
                        "show-message-card": (_19 = (_18 = vue.unref(cancelBtnProps)) === null || _18 === void 0 ? null : _18.getBoolean("showMessageCard")) !== null && _19 !== void 0 ? _19 : false,
                        onClick: _cache[1] || (_cache[1] = ($event = null) => {
                        ...
                        default: vue.withCtx(() => {
                          var _a4;
                          return [
                            vue.createTextVNode(vue.toDisplayString((_a4 = vue.unref(cancelBtnProps)) === null || _a4 === void 0 ? null : _a4.getString("content")), 1)
                          ];
                        }),
                        _: 1
                      }, 8, ["style", "class", "block", "disabled", "content", "icon", "loading", "type", "ghost", "shape", "size", "variant", "open-type", "color", "textColor", "fontSize", "hover-stop-propagation", "hover-start-time", "hover-stay-time", "lang", "session-from", "send-message-title", "send-message-path", "send-message-img", "app-parameter", "show-message-card"])) : vue.createCommentVNode("", true)
                    ];
                  }),
                  vue.renderSlot(_ctx.$slots, "confirm-btn", new UTSJSONObject({}), () => {
                    var _a3, _b2, _c2, _d2, _e2, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s2, _t2, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19;
                    return [
                      vue.unref(confirmBtnProps) != null ? (vue.openBlock(), vue.createBlock(_component_l_button, {
                        key: 0,
                        class: vue.normalizeClass(["l-dialog__button", [
                          "l-dialog__button--" + vue.unref(innerButtonLayout),
                          new UTSJSONObject({
                        ...
                        style: vue.normalizeStyle([
                          vue.unref(buttonStyle),
                          new UTSJSONObject({
                            "margin-left": vue.unref(cancelBtnProps) != null && vue.unref(innerButtonLayout) == "horizontal" && !vue.unref(buttonVariant) ? "24rpx" : "0",
                            "margin-bottom": vue.unref(cancelBtnProps) != null && vue.unref(innerButtonLayout) == "vertical" && !vue.unref(buttonVariant) ? "24rpx" : "0"
                          })
                        ]),
                        "data-type": "confirm",
                        block: (_b2 = (_a3 = vue.unref(confirmBtnProps)) === null || _a3 === void 0 ? null : _a3.getBoolean("block")) !== null && _b2 !== void 0 ? _b2 : false,
                        disabled: (_d2 = (_c2 = vue.unref(confirmBtnProps)) === null || _c2 === void 0 ? null : _c2.getBoolean("disabled")) !== null && _d2 !== void 0 ? _d2 : false,
                        content: (_f = (_e2 = vue.unref(confirmBtnProps)) === null || _e2 === void 0 ? null : _e2.getString("content")) !== null && _f !== void 0 ? _f : "",
                        icon: (_h = (_g = vue.unref(confirmBtnProps)) === null || _g === void 0 ? null : _g.getString("icon")) !== null && _h !== void 0 ? _h : "",
                        loading: (_k = (_j = vue.unref(confirmBtnProps)) === null || _j === void 0 ? null : _j.getBoolean("loading")) !== null && _k !== void 0 ? _k : false,
                        type: (_m = (_l = vue.unref(confirmBtnProps)) === null || _l === void 0 ? null : _l.getString("type")) !== null && _m !== void 0 ? _m : "primary",
                        ghost: (_p = (_o = vue.unref(confirmBtnProps)) === null || _o === void 0 ? null : _o.getBoolean("loading")) !== null && _p !== void 0 ? _p : false,
                        shape: (_r = (_q = vue.unref(confirmBtnProps)) === null || _q === void 0 ? null : _q.getString("shape")) !== null && _r !== void 0 ? _r : "rectangle",
                        size: (_t2 = (_s2 = vue.unref(confirmBtnProps)) === null || _s2 === void 0 ? null : _s2.getString("size")) !== null && _t2 !== void 0 ? _t2 : "medium",
                        variant: (_v = (_u = vue.unref(confirmBtnProps)) === null || _u === void 0 ? null : _u.getString("variant")) !== null && _v !== void 0 ? _v : "solid",
                        "open-type": (_w = vue.unref(confirmBtnProps)) === null || _w === void 0 ? null : _w.getString("openType"),
                        color: (_x = vue.unref(confirmBtnProps)) === null || _x === void 0 ? null : _x.getString("color"),
                        textColor: (_y = vue.unref(confirmBtnProps)) === null || _y === void 0 ? null : _y.getString("textColor"),
                        fontSize: (_z = vue.unref(confirmBtnProps)) === null || _z === void 0 ? null : _z.getString("fontSize"),
                        "hover-stop-propagation": (_1 = (_0 = vue.unref(confirmBtnProps)) === null || _0 === void 0 ? null : _0.getBoolean("hoverStopPropagation")) !== null && _1 !== void 0 ? _1 : false,
                        "hover-start-time": (_3 = (_2 = vue.unref(confirmBtnProps)) === null || _2 === void 0 ? null : _2.getNumber("hoverStartTime")) !== null && _3 !== void 0 ? _3 : 20,
                        "hover-stay-time": (_5 = (_4 = vue.unref(confirmBtnProps)) === null || _4 === void 0 ? null : _4.getNumber("hoverStayTime")) !== null && _5 !== void 0 ? _5 : 70,
                        lang: (_7 = (_6 = vue.unref(confirmBtnProps)) === null || _6 === void 0 ? null : _6.getString("lang")) !== null && _7 !== void 0 ? _7 : "en",
                        "session-from": (_9 = (_8 = vue.unref(confirmBtnProps)) === null || _8 === void 0 ? null : _8.getString("sessionFrom")) !== null && _9 !== void 0 ? _9 : "",
                        "send-message-title": (_11 = (_10 = vue.unref(confirmBtnProps)) === null || _10 === void 0 ? null : _10.getString("sendMessageTitle")) !== null && _11 !== void 0 ? _11 : "",
                        "send-message-path": (_13 = (_12 = vue.unref(confirmBtnProps)) === null || _12 === void 0 ? null : _12.getString("sendMessagePath")) !== null && _13 !== void 0 ? _13 : "",
                        "send-message-img": (_15 = (_14 = vue.unref(confirmBtnProps)) === null || _14 === void 0 ? null : _14.getString("sendMessageImg")) !== null && _15 !== void 0 ? _15 : "",
                        "app-parameter": (_17 = (_16 = vue.unref(confirmBtnProps)) === null || _16 === void 0 ? null : _16.getString("appParameter")) !== null && _17 !== void 0 ? _17 : "",
                        "show-message-card": (_19 = (_18 = vue.unref(confirmBtnProps)) === null || _18 === void 0 ? null : _18.getBoolean("showMessageCard")) !== null && _19 !== void 0 ? _19 : false,
                        ...
                        default: vue.withCtx(() => {
                          var _a4;
                          return [
                            vue.createTextVNode(vue.toDisplayString((_a4 = vue.unref(confirmBtnProps)) === null || _a4 === void 0 ? null : _a4.getString("content")), 1)
                          ];
                        }),
                        _: 1
                      }, 8, ["class", "style", "block", "disabled", "content", "icon", "loading", "type", "ghost", "shape", "size", "variant", "open-type", "color", "textColor", "fontSize", "hover-stop-propagation", "hover-start-time", "hover-stay-time", "lang", "session-from", "send-message-title", "send-message-path", "send-message-img", "app-parameter", "show-message-card"])) : vue.createCommentVNode("", true)
                    ];
                  })
                ], 2)
              ])
          ...
          _: 3
        }, 8, ["visible", "overlay", "closeOnClickOverlay", "preventScrollThrough", "zIndex"]);
      };
    }
  });
  const _style_0$g = { "l-dialog": { "": { "overflow": "hidden", "width": "642rpx", "borderTopLeftRadius": "12rpx", "borderTopRightRadius": "12rpx", "borderBottomRightRadius": "12rpx", "borderBottomLeftRadius": "12rpx", "backgroundColor": "#ffffff" } }, "l-dialog__close": { "": { "position": "absolute", "top": "16rpx", "right": "16rpx", "zIndex": 1 } }, "l-dialog__close-icon": { "": { "color": "rgba(0,0,0,0.45)" } }, "l-dialog__content": { "": { "paddingTop": "64rpx", "paddingRight": "48rpx", "paddingBottom": 0, "paddingLeft": "48rpx", "maxHeight": "912rpx", "boxSizing": "border-box", "display": "flex", "flexDirection": "column", "justifyContent": "center" } }, "l-dialog__header": { "": { "textAlign": "center", "fontWeight": "bold", "fontSize": "36rpx", "lineHeight": "52rpx", "color": "rgba(0,0,0,0.88)" } }, "l-dialog__body-text": { "": { "textAlign": "center", "fontSize": "32rpx", "color": "rgba(0,0,0,0.65)", "lineHeight": "48rpx" } }, "l-dialog__body--left": { "": { "textAlign": "left" } }, "l-dialog__body--right": { "": { "textAlign": "right" } }, "l-dialog__body--gap": { "": { "marginTop": "16rpx" } }, "l-dialog__footer": { "": { "display": "flex", "paddingTop": "48rpx", "paddingRight": "48rpx", "paddingBottom": "48rpx", "paddingLeft": "48rpx" } }, "l-dialog__footer--horizontal": { "": { "flexDirection": "row", "flexWrap": "nowrap" } }, "l-dialog__footer--vertical": { "": { "flexDirection": "column-reverse", "flexWrap": "nowrap" } }, "l-dialog__button": { ".l-dialog__footer--vertical ": { "width": "100%" }, "": { "position": "relative", "flex": 1, "overflow": "hidden", "textOverflow": "ellipsis", "whiteSpace": "nowrap" } }, "l-dialog__footer--full": { "": { "paddingTop": "64rpx", "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0 } }, "l-dialog__button--horizontal": { ".l-dialog__button--horizontal+": { "marginLeft": "24rpx" } }, "l-dialog__button--vertical": { ".l-dialog__button--vertical+": { "marginBottom": "24rpx" } }, "l-dialog__button--text": { "": { "flex": 1, "borderTopLeftRadius": 0, "borderTopRightRadius": 0, "borderBottomRightRadius": 0, "borderBottomLeftRadius": 0, "borderTopWidth": 1, "borderTopStyle": "solid", "borderTopColor": "#e7e7e7", "borderLeftWidth": 1, "borderLeftStyle": "solid", "borderLeftColor": "#e7e7e7" } } };
  const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["styles", [_style_0$g]]]);
  const _sfc_main$h = /* @__PURE__ */ vue.defineComponent({
    __name: "deviceSetting",
    setup(__props) {
      const showEditName = vue.ref(false);
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_fui_icon = resolveEasycom(vue.resolveDynamicComponent("fui-icon"), __easycom_1$6);
        const _component_fui_button = resolveEasycom(vue.resolveDynamicComponent("fui-button"), __easycom_3$4);
        const _component_l_input = resolveEasycom(vue.resolveDynamicComponent("l-input"), __easycom_4$1);
        const _component_l_dialog = resolveEasycom(vue.resolveDynamicComponent("l-dialog"), __easycom_4);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createVNode(vue.unref(TopNavBar), new UTSJSONObject({
            showBack: true,
            title: "设备设置",
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "device-box" }), [
            vue.createElementVNode("image", new UTSJSONObject({
              class: "device-img",
              src: _imports_0$8,
              mode: "aspectFill"
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "device-info" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "device-name-box" }), [
                vue.createElementVNode("text", null, "设备名称"),
                vue.createVNode(_component_l_icon, new UTSJSONObject({
                  name: "round-filled",
                  color: "#e8782eff",
                ...
                vue.createVNode(_component_l_icon, new UTSJSONObject({
                  style: new UTSJSONObject({ "margin-left": "50rpx" }),
                  name: "edit",
                  color: "#333",
                  size: "18",
                  onClick: editName
              ...
              vue.createElementVNode("view", null, [
                vue.createElementVNode("view", new UTSJSONObject({ class: "model-uid" }), [
                  vue.createElementVNode("text", null, "型号"),
                  vue.createElementVNode("text", new UTSJSONObject({ class: "model-uid-text" }), "YY-1234567")
                ]),
                vue.createElementVNode("view", new UTSJSONObject({ class: "model-uid" }), [
                  vue.createElementVNode("text", null, "UID"),
                  vue.createElementVNode("view", new UTSJSONObject({ class: "model-uid" }), [
                    vue.createElementVNode("text", new UTSJSONObject({ class: "model-uid-text" }), "YY-1234567"),
                    vue.createVNode(_component_l_icon, new UTSJSONObject({
                      name: "file-copy",
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "network" }), "网络 中国电信")
            ])
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "device-list-box" }), [
            vue.createElementVNode("view", new UTSJSONObject({
              class: "item",
              onClick: goDeviceSettingInfo
            }), [
              vue.createElementVNode("text", null, "设备设置"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                color: "#111",
                size: "40"
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "item" }), [
                vue.createElementVNode("text", null, "流量充值"),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  color: "#111",
                  size: "40"
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "date" }), [
                vue.createElementVNode("text", new UTSJSONObject({ class: "word" }), "已用80G(80%)"),
                vue.createElementVNode("text", new UTSJSONObject({ class: "word" }), "2025-8-10到期")
              ])
            ]),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "item",
              ...
              vue.createElementVNode("text", null, "智能侦测"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                color: "#111",
                size: "40"
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "TF卡设置"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                color: "#111",
                size: "40"
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "云存储设置"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                color: "#111",
                size: "40"
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "item nounderline" }), [
              vue.createElementVNode("text", null, "存储管理"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                color: "#111",
                size: "40"
          ...
          vue.createVNode(_component_l_dialog, new UTSJSONObject({
            modelValue: showEditName.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event = null) => {
              return showEditName.value = $event;
            }),
            title: "修改设备名称",
            "cancel-btn": new UTSJSONObject({ content: "取消", variant: "text", size: "large", type: "default" }),
            "confirm-btn": new UTSJSONObject({ content: "确认", variant: "text", size: "large" }),
            onConfirm: changeName,
            onCancel: _cache[2] || (_cache[2] = ($event = null) => {
              return showEditName.value = false;
            })
          }), {
            default: vue.withCtx(() => {
              return [
                vue.createVNode(_component_l_input, new UTSJSONObject({
  ...
  const _sfc_main$f = vue.defineComponent({
    ...
    methods: {
      ...
      _getTextWidth(text) {
        ...
        return "".concat(sum / 2 * multiplier + px, "px");
      },
      getWidth() {
        let max = this.max;
        let value;
        if (typeof this.value == "string") {
          ...
          if (typeof this.value == "number") {
            ...
            if (max == -1) {
              ...
              value = val_num > max ? "".concat(max, "+") : val_num.toString();
            }
          } else {
            if (max == -1) {
              value = this.value.toString();
            } else {
              value = parseFloat(this.value.toString()) > max ? "".concat(max, "+") : "".concat(this.value);
            }
          }
        }
  ...
  const _style_0$e = { "fui-badge__wrap": { "": { "height": "36rpx", "color": "#FFFFFF", "fontSize": "24rpx", "lineHeight": "36rpx", "borderTopLeftRadius": 100, "borderTopRightRadius": 100, "borderBottomRightRadius": 100, "borderBottomLeftRadius": 100, "minWidth": "36rpx", "boxSizing": "border-box", "textAlign": "center", "zIndex": 10 } }, "fui-badge__dot": { "": { "!height": 8, "!width": 8, "borderTopLeftRadius": 100, "borderTopRightRadius": 100, "borderBottomRightRadius": 100, "borderBottomLeftRadius": 100, "zIndex": 10 } }, "fui-badge__bg-primary": { "": { "!backgroundColor": "#465CFF" } }, "fui-badge__bg-success": { "": { "!backgroundColor": "#09BE4F" } }, "fui-badge__bg-warning": { "": { "!backgroundColor": "#FFB703" } }, "fui-badge__bg-danger": { "": { "!backgroundColor": "#FF2B2B" } }, "fui-badge__bg-purple": { "": { "!backgroundColor": "#6831FF" } }, "fui-badge__bg-white": { "": { "!backgroundColor": "#FFFFFF" } }, "fui-badge__text-color": { "": { "!color": "#FF2B2B" } }, "fui-badge__trans-origin": { "": { "transformOrigin": "center center" } }, "fui-badge__absolute": { "": { "position": "absolute" } } };
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.showValue != "" || $props.dot ? (vue.openBlock(), vue.createElementBlock("text", {
      key: 0,
      class: vue.normalizeClass([$props.dot ? "fui-badge__dot" : "fui-badge__wrap", $props.background != "" ? "" : "fui-badge__bg-" + $props.type, $props.absolute ? "fui-badge__absolute" : "", $props.scaleRatio != 1 ? "fui-badge__trans-origin" : "", $props.background == "" && $props.type == "white" ? "fui-badge__text-color" : ""]),
      style: vue.normalizeStyle({ top: $props.absolute ? $props.top : "auto", right: $props.absolute ? $props.right : "auto", transform: "scale(".concat($props.scaleRatio, ")"), marginTop: "".concat($props.marginTop, "rpx"), marginLeft: "".concat($props.marginLeft, "rpx"), marginRight: "".concat($props.marginRight, "rpx"), width: $data.width, color: $props.color, background: $props.background }),
      onClick: _cache[0] || (_cache[0] = (...args) => $options.handleClick && $options.handleClick(...args))
    }, vue.toDisplayString($props.dot ? "" : $data.showValue), 7)) : vue.createCommentVNode("", true);
  }
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$2], ["styles", [_style_0$e]]]);
  const _sfc_main$e = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const changeSwitch = (e2) => {
        uni.__log__("log", "at pages/index/deviceSettingInfo/deviceSettingInfo.uvue:48", e2);
      };
      const restart = () => {
        uni.showModal(new UTSJSONObject({
          title: "提示",
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "夜视模式"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                size: "40"
              }))
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list-item" }), [
              vue.createElementVNode("text", null, "翻转设置"),
              vue.createVNode(_component_fui_switch, new UTSJSONObject({
                scaleRatio: 0.8,
                checked: vue.unref(state),
                onChange: changeSwitch
              }), null, 8, ["checked"])
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list-item" }), [
              vue.createElementVNode("text", null, "固件"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "firmware-box" }), [
                vue.createVNode(_component_fui_badge, new UTSJSONObject({
                  value: "new",
                  type: "danger",
                  scaleRatio: 0.8
                })),
                vue.createElementVNode("text", new UTSJSONObject({ class: "firmware-version" }), "1.1.1")
              ])
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list-item" }), [
              vue.createElementVNode("text", null, "Mac地址"),
              vue.createElementVNode("text", new UTSJSONObject({ class: "firmware-version" }), "1.1.1")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "list-item",
              ...
              vue.createElementVNode("text", null, "重启"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "arrowright",
                size: "40"
              }))
  ...
  const PagesIndexDeviceSettingInfoDeviceSettingInfo = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["styles", [_style_0$d]]]);
  ...
  const _sfc_main$d = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const val = vue.ref("1");
      const select_img = vue.ref("../../../static/u4062.png");
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "select-mode" }), [
              vue.createVNode(_component_fui_radio_group, new UTSJSONObject({
                              ...
                              default: vue.withCtx(() => {
                                return [
                                  vue.createElementVNode("view", new UTSJSONObject({
                                    ...
                                    vue.createElementVNode("text", new UTSJSONObject({ class: "fui-desc" }), vue.toDisplayString(item.desc), 1)
                                  ], 8, ["onClick"])
                                ];
                              }),
                              _: 2
  ...
  const _style_0$c = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx" } }, "night-img": { ".container .content ": { "width": "100%", "height": "245rpx" } }, "fui-align__center": { ".container .content .select-mode ": { "width": "100%" } }, "fui-text-box": { ".container .content .select-mode .fui-align__center ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "marginBottom": "10rpx" } }, "fui-desc": { ".container .content .select-mode .fui-align__center ": { "color": "#999999", "fontSize": "24rpx" } } };
  const PagesIndexDeviceSettingInfoDeviceNight = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["styles", [_style_0$c]]]);
  const _sfc_main$c = /* @__PURE__ */ vue.defineComponent({
    __name: "intelligentWatch",
    setup(__props) {
      const peopleWatch = vue.ref(true);
      const mobileWatch = vue.ref(true);
      const flashlight = vue.ref(true);
      const redBlueWatch = vue.ref(true);
      const policeWatch = vue.ref(true);
      const peopleSelectWatch = vue.ref(true);
      const peopleFindWatch = vue.ref(true);
      const showPicker = vue.ref(false);
      const peopleWatchLevel = vue.ref("中");
      const timeWatchLevel = vue.ref("全天");
      const pickerOptions = vue.ref([]);
      vue.ref([]);
      const mobileWatchLevel = vue.ref("高");
      const mobileTimeWatchLevel = vue.ref("全天");
      ...
      const peopleWatchFun = (e2) => {
        peopleWatch.value = e2;
      };
      ...
      const pickerFun = (e2) => {
        const selectedValue = e2.values[0].toString();
      ...
      const mobileWatchFun = (e2) => {
        mobileWatch.value = e2;
      };
      const flashlightFun = (e2) => {
        flashlight.value = e2;
      };
      const redBlueWatchFun = (e2) => {
        redBlueWatch.value = e2;
      };
      const policeWatchFun = (e2) => {
        policeWatch.value = e2;
      };
      const peopleSelectWatchFun = (e2) => {
        peopleSelectWatch.value = e2;
      };
      const peopleFindWatchFun = (e2) => {
        peopleFindWatch.value = e2;
      };
      return (_ctx = null, _cache = null) => {
        const _component_fui_switch = resolveEasycom(vue.resolveDynamicComponent("fui-switch"), __easycom_0$5);
        const _component_fui_icon = resolveEasycom(vue.resolveDynamicComponent("fui-icon"), __easycom_1$6);
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            ...
            peopleWatch.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              key: 0,
              class: "list",
              onClick: peopeWatchChange
            }), [
              vue.createElementVNode("text", null, "侦测灵敏度"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "level" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(peopleWatchLevel.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  color: "#333",
                  size: "60"
            ...
            peopleWatch.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "侦测时间段"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "level" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(timeWatchLevel.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  color: "#333",
                  size: "60"
            ...
            peopleWatch.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "侦测范围"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "level" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            ...
            mobileWatch.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              key: 0,
              class: "list",
              ...
              vue.createElementVNode("text", null, "侦测灵敏度"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "level" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(mobileWatchLevel.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  color: "#333",
                  size: "60"
            ...
            mobileWatch.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "侦测时间段"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "level" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(mobileTimeWatchLevel.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  color: "#333",
                  size: "60"
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "闪光灯"),
              vue.createVNode(_component_fui_switch, new UTSJSONObject({
                scaleRatio: 0.8,
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "红蓝警灯"),
              vue.createVNode(_component_fui_switch, new UTSJSONObject({
                scaleRatio: 0.8,
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "报警声"),
              vue.createVNode(_component_fui_switch, new UTSJSONObject({
                scaleRatio: 0.8,
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "list-box" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "list nounderline" }), [
                vue.createElementVNode("view", new UTSJSONObject({ class: "text-box" }), [
                  vue.createElementVNode("text", null, "人形框定"),
                  vue.createVNode(_component_fui_icon, new UTSJSONObject({
                    name: "help",
                    size: "30"
                  }))
              ...
              vue.createElementVNode("text", new UTSJSONObject({ class: "tips" }))
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list-box nounderline" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "list nounderline" }), [
                vue.createElementVNode("view", new UTSJSONObject({ class: "text-box" }), [
                  vue.createElementVNode("text", null, "人形追踪"),
                  vue.createVNode(_component_fui_icon, new UTSJSONObject({
                    name: "help",
                    size: "30"
                  }))
            ...
            default: vue.withCtx(() => {
              return [
                vue.createVNode(_component_l_picker, new UTSJSONObject({
                  ...
                  "confirm-btn": "确定",
                  columns: pickerOptions.value,
                  onCancel: _cache[0] || (_cache[0] = ($event = null) => {
  ...
  const PagesIndexIntelligentWatch = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["styles", [_style_0$b]]]);
  const MODE_YEAR = 1;
  const MODE_MONTH = 2;
  const MODE_DATE = 4;
  const MODE_HOUR = 8;
  ...
  const _sfc_main$b = /* @__PURE__ */ vue.defineComponent({
    ...
    props: {
      cancelBtn: { type: String },
      cancelStyle: { type: String },
      confirmBtn: { type: String },
      confirmStyle: { type: String },
    ...
    setup(__props, _a) {
      ...
      const normalize = (val = null, defaultDay) => {
        return val != null && dayuts(val).isValid() ? dayuts(val) : defaultDay;
      };
      const start = vue.computed(() => {
        return normalize(props.start, dayuts().subtract(10, "year"));
      });
      const end = vue.computed(() => {
        return normalize(props.end, dayuts().add(10, "year"));
      });
      ...
      const columns = vue.computed(() => {
        ...
        const _b2 = __read(getDate(start.value), 6), minYear = _b2[0], minMonth = _b2[1], minDay = _b2[2], minHour = _b2[3], minMinute = _b2[4], minSecond = _b2[5];
        const _c2 = __read(getDate(end.value), 6), maxYear = _c2[0], maxMonth = _c2[1], maxDay = _c2[2], maxHour = _c2[3], maxMinute = _c2[4], maxSecond = _c2[5];
      ...
      const stop = vue.watch(innerValue, (val = null) => {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_l_picker, new UTSJSONObject({
          ...
          onChange,
          onPick
        }), null, 8, ["title", "titleStyle", "confirm-btn", "confirm-style", "cancel-btn", "cancel-style", "itemHeight", "itemColor", "itemFontSize", "itemActiveColor", "indicatorStyle", "bgColor", "groupHeight", "radius", "value", "columns"]);
      };
    }
  });
  const _sfc_main$a = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const types = vue.ref(true);
      const pickerOptions = vue.ref([]);
      const percent = vue.ref(80);
      const showPicker = vue.ref(false);
      const vedioModeType = vue.ref("事件录像");
      const pictureQualityType = vue.ref("高清");
      const startTime = vue.ref("00:00");
      const endTime = vue.ref("23:59");
      let currentCallback = null;
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_fui_icon = resolveEasycom(vue.resolveDynamicComponent("fui-icon"), __easycom_1$6);
        const _component_l_picker = resolveEasycom(vue.resolveDynamicComponent("l-picker"), __easycom_3$1);
        const _component_l_date_time_picker = resolveEasycom(vue.resolveDynamicComponent("l-date-time-picker"), _sfc_main$b);
        const _component_l_popup = resolveEasycom(vue.resolveDynamicComponent("l-popup"), __easycom_5);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "list-box" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "title" }), [
                vue.createElementVNode("text", null, "存储空间"),
                vue.createVNode(_component_l_button, new UTSJSONObject({
                  type: "primary",
                  size: "mini"
                }), {
              ...
              vue.createElementVNode("view", new UTSJSONObject({ class: "title" }), [
                vue.createElementVNode("text", null, "已用80G"),
                vue.createElementVNode("text", null, "可用 20G/共100G")
              ])
            ]),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "list",
              ...
              vue.createElementVNode("text", null, "录像模式"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "right" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(vedioModeType.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  size: "50"
                }))
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "录像画质"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "right" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(pictureQualityType.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  size: "50"
                }))
            ...
            vue.createElementVNode("view", new UTSJSONObject({
              ...
              vue.createElementVNode("text", null, "录像时间"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "right" }), [
                vue.createElementVNode("text", null, vue.toDisplayString(startTime.value) + "至" + vue.toDisplayString(endTime.value), 1),
                vue.createVNode(_component_fui_icon, new UTSJSONObject({
                  name: "arrowright",
                  size: "50"
                }))
          ...
          vue.createVNode(_component_l_popup, new UTSJSONObject({
            ...
            default: vue.withCtx(() => {
              return [
                types.value ? (vue.openBlock(), vue.createBlock(_component_l_picker, new UTSJSONObject({
                  key: 0,
                  "cancel-btn": "取消",
                  "confirm-btn": "确定",
                  columns: pickerOptions.value,
                  ...
                  onConfirm: pickerFun
                }), null, 8, ["columns"])) : (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
                  key: 1,
                  class: "time-picker"
                }), [
                  vue.createElementVNode("view", new UTSJSONObject({ class: "time-picker-title" }), [
                    vue.createVNode(_component_l_button, new UTSJSONObject({
                      type: "default",
                      size: "mini",
                      onClick: _cache[1] || (_cache[1] = ($event = null) => {
                  ...
                  vue.createElementVNode("view", new UTSJSONObject({ class: "time-picker-content" }), [
  ...
  const _style_0$a = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx" } }, "list-box": { ".container .content ": { "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f1f1f1" } }, "title": { ".container .content .list-box ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "list": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f1f1f1" } }, "right": { ".container .content .list ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0, "borderBottomWidth": "medium", "borderBottomStyle": "none", "borderBottomColor": "#000000" } }, "nobottom": { ".container .content ": { "borderBottomWidth": "medium", "borderBottomStyle": "none", "borderBottomColor": "#000000" } }, "time-picker": { ".container ": { "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "time-picker-title": { ".container .time-picker ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "marginBottom": "20rpx" } }, "time-picker-content": { ".container .time-picker ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center" } }, "l-picker": { ".container .time-picker .time-picker-content ": { "width": "45%" } } };
  const PagesIndexTFCardSetting = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["styles", [_style_0$a]]]);
  const _style_0$9 = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "list": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f1f1f1" } }, "btn-box": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderBottomWidth": 0, "borderBottomStyle": "none", "borderBottomColor": "#000000", "marginTop": "50rpx" } } };
  const _sfc_main$9 = {};
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("view", { class: "content" }, [
        vue.createElementVNode("view", { class: "list" }, [
          vue.createElementVNode("text", null, "当前套餐"),
          vue.createElementVNode("text", null, "7天滚动云存储 - 月卡")
        ]),
        vue.createElementVNode("view", { class: "list" }, [
          vue.createElementVNode("text", null, "到期时间"),
          vue.createElementVNode("text", null, "2025-10-29")
        ]),
        vue.createElementVNode("view", { class: "list" }, [
          vue.createElementVNode("text", null, "自动续费"),
  ...
  const PagesIndexCloudStorageSetting = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$1], ["styles", [_style_0$9]]]);
  ...
  const _style_0$8 = { "fui-empty__wrap": { "": { "width": "100%", "display": "flex", "flexDirection": "column", "alignItems": "center", "justifyContent": "center" } }, "fui-empty__fixed": { "": { "position": "fixed", "left": 0, "top": "50%", "transform": "translateY(-50%)", "zIndex": 99 } }, "fui-empty__title": { "": { "textAlign": "center", "fontWeight": "bold", "paddingTop": "48rpx" } }, "fui-empty__desc": { "": { "textAlign": "center", "fontWeight": "normal", "paddingTop": "8rpx" } }, "fui-empty__title-color": { "": { "!color": "#333333" } }, "fui-empty__descr-color": { "": { "!color": "#B2B2B2" } } };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: vue.normalizeClass(["fui-empty__wrap", { "fui-empty__fixed": $props.isFixed }]),
      style: vue.normalizeStyle({ marginTop: "".concat($props.marginTop, "rpx") })
    }, [
      $props.src != "" ? (vue.openBlock(), vue.createElementBlock("image", {
        key: 0,
        src: $props.src,
        style: vue.normalizeStyle({ width: "".concat($props.width, "rpx"), height: "".concat($props.height, "rpx") }),
        mode: "widthFix"
      }, null, 12, ["src"])) : vue.createCommentVNode("", true),
      $props.title != "" ? (vue.openBlock(), vue.createElementBlock("text", {
        key: 1,
        class: vue.normalizeClass(["fui-empty__title", { "fui-empty__title-color": $props.color == "" }]),
        style: vue.normalizeStyle({ color: $props.color, fontSize: "".concat($props.size, "rpx") })
      }, vue.toDisplayString($props.title), 7)) : vue.createCommentVNode("", true),
      $props.descr != "" ? (vue.openBlock(), vue.createElementBlock("text", {
        key: 2,
        class: vue.normalizeClass(["fui-empty__desc", { "fui-empty__descr-color": $props.descrColor == "" }]),
        style: vue.normalizeStyle({ color: $props.descrColor, fontSize: "".concat($props.descrSize, "rpx") })
      }, vue.toDisplayString($props.descr), 7)) : vue.createCommentVNode("", true),
      vue.renderSlot(_ctx.$slots, "default")
    ], 6);
  }
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render], ["styles", [_style_0$8]]]);
  ...
  const _sfc_main$7 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const tabVal = vue.ref(0);
      const percent = vue.ref(60);
      const selectedPackage = vue.ref(null);
      const tabsVal = vue.ref([
        new tabItem({
          id: "0",
          title: "订购套餐",
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "ICCID"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "right-item" }), [
                vue.createElementVNode("text", null, "8986112223504991234"),
                vue.createVNode(_component_l_icon, new UTSJSONObject({
                  style: new UTSJSONObject({ "margin-left": "10rpx" }),
                  name: "file-copy",
                  size: "20",
                  onClick: copyiccid
                }))
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "list underline" }), [
              vue.createElementVNode("text", null, "卡号"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "right-item" }), [
                vue.createElementVNode("text", null, "8986112223504991234"),
                vue.createElementVNode("text", new UTSJSONObject({ style: new UTSJSONObject({ "color": "#FF4D4F" }) }), "[停用]")
              ])
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "当前套餐"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "right-item" }), [
                vue.createElementVNode("text", null, "店长推荐"),
                vue.createElementVNode("text", null, "[终身流量]")
              ])
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list underline" }), [
              vue.createElementVNode("text", null, "生效日期"),
              vue.createElementVNode("text", null, "套餐将于 2025-5-13 到期")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "流量 - 异常"),
              vue.createVNode(_component_fui_icon, new UTSJSONObject({
                name: "right",
                size: "50"
              }))
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "progress" }), [
              vue.createVNode(_component_l_progress, new UTSJSONObject({
                percent: percent.value,
                "info-align": "end",
                "show-info": true
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "已用 60G (60%)"),
              vue.createElementVNode("text", null, "可用 20G/共100G")
            ])
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "package-box" }), [
            vue.createVNode(_component_l_tabs, new UTSJSONObject({
              value: tabVal.value,
              onClick: changeTab,
              spaceEvenly: false,
                ...
                return [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabsVal.value, (item, index) => {
                    return vue.openBlock(), vue.createBlock(_component_l_tab_panel, new UTSJSONObject({
                      ...
                      default: vue.withCtx(() => {
                        return [
                          vue.createElementVNode("view", new UTSJSONObject({ class: "product-container" }), [
                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(getFilteredEvents(), (it2, index2) => {
                              var _a2;
                              return vue.openBlock(), vue.createElementBlock("view", {
                                class: vue.normalizeClass(["list-item", { "selected-item": ((_a2 = selectedPackage.value) === null || _a2 === void 0 ? null : _a2.id) === it2.id }]),
                                key: index2,
                                onClick: ($event = null) => {
                                  return selectPackge(it2);
                                }
                              }, [
                                vue.createElementVNode("text", new UTSJSONObject({ class: "product-name" }), vue.toDisplayString(it2.title), 1),
                                vue.createElementVNode("text", new UTSJSONObject({ class: "product-date" }), vue.toDisplayString(it2.date), 1),
                                vue.createElementVNode("text", new UTSJSONObject({ class: "product-price" }), "¥" + vue.toDisplayString(it2.price), 1)
                              ], 10, ["onClick"]);
                            }), 128))
                          ]),
                          getFilteredEvents().length == 0 ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ key: 0 }), [
                            vue.createVNode(_component_fui_empty, new UTSJSONObject({
                              color: "#999",
                              size: 25,
                              title: "暂无套餐"
                            }))
          ...
          selectedPackage.value ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
            key: 0,
            class: "btn-box"
          }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "price" }), [
              vue.createElementVNode("text", new UTSJSONObject({ class: "price-title" }), "金额"),
              vue.createElementVNode("text", new UTSJSONObject({ class: "price-text" }), "¥" + vue.toDisplayString((_a = selectedPackage.value) === null || _a === void 0 ? null : _a.price), 1)
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "btn" }), [
              vue.createVNode(_component_l_button, new UTSJSONObject({ type: "primary" }), {
                default: vue.withCtx(() => {
                  return [
                    vue.createTextVNode("流量充值")
                  ];
                }),
                _: 1
              })
  ...
  const _style_0$7 = { "container": { "": { "position": "relative", "height": "100%", "backgroundColor": "#f5f5f5", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx" } }, "list": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "right-item": { ".container .content .list ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0, "borderBottomWidth": "medium", "borderBottomStyle": "none", "borderBottomColor": "#000000" } }, "progress": { ".container .content ": { "paddingTop": 0, "paddingRight": "20rpx", "paddingBottom": 0, "paddingLeft": "20rpx" } }, "underline": { ".container .content ": { "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f1f1f1" } }, "package-box": { ".container ": { "marginTop": "50rpx" } }, "product-container": { ".container .package-box ": { "display": "flex", "flexWrap": "wrap", "flexDirection": "row", "justifyContent": "space-between", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "list-item": { ".container .package-box .product-container ": { "width": "48%", "marginBottom": "30rpx", "paddingTop": "40rpx", "paddingRight": "40rpx", "paddingBottom": "40rpx", "paddingLeft": "40rpx", "boxSizing": "border-box", "backgroundImage": "none", "backgroundColor": "#ffffff", "borderTopLeftRadius": "10rpx", "borderTopRightRadius": "10rpx", "borderBottomRightRadius": "10rpx", "borderBottomLeftRadius": "10rpx", "display": "flex", "flexDirection": "column", "alignItems": "center", "borderTopWidth": "2rpx", "borderRightWidth": "2rpx", "borderBottomWidth": "2rpx", "borderLeftWidth": "2rpx", "borderTopStyle": "solid", "borderRightStyle": "solid", "borderBottomStyle": "solid", "borderLeftStyle": "solid", "borderTopColor": "#ffffff", "borderRightColor": "#ffffff", "borderBottomColor": "#ffffff", "borderLeftColor": "#ffffff" }, ".container .package-box .product-container .selected-item": { "borderTopWidth": "2rpx", "borderRightWidth": "2rpx", "borderBottomWidth": "2rpx", "borderLeftWidth": "2rpx", "borderTopStyle": "solid", "borderRightStyle": "solid", "borderBottomStyle": "solid", "borderLeftStyle": "solid", "borderTopColor": "#FF5722", "borderRightColor": "#FF5722", "borderBottomColor": "#FF5722", "borderLeftColor": "#FF5722" } }, "product-name": { ".container .package-box .product-container .list-item ": { "fontSize": "30rpx" } }, "product-date": { ".container .package-box .product-container .list-item ": { "fontSize": "20rpx", "color": "#999999", "height": "50rpx", "lineHeight": "50rpx" } }, "product-price": { ".container .package-box .product-container .list-item ": { "fontSize": "30rpx", "color": "#FF5722", "fontWeight": "bold" } }, "l-tabs": { ".container ": { "!backgroundColor": "rgba(0,0,0,0)" } }, "btn-box": { ".container ": { "position": "fixed", "width": "100%", "left": 0, "bottom": 0, "height": "100rpx", "display": "flex", "flexDirection": "row" } }, "price": { ".container .btn-box ": { "flex": 1, "height": "100%", "display": "flex", "flexDirection": "row", "justifyContent": "center", "alignItems": "center", "backgroundColor": "#ffffff", "gap": "10rpx" } }, "price-title": { ".container .btn-box .price ": { "fontSize": "20rpx" } }, "price-text": { ".container .btn-box .price ": { "fontSize": "40rpx", "color": "#FF5722", "fontWeight": "bold", "marginLeft": "15rpx" } }, "btn": { ".container .btn-box ": { "flex": 1, "height": "100%" } }, "l-button": { ".container .btn-box .btn ": { "height": "100%" } } };
  const PagesIndexDeviceRechargeData = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["styles", [_style_0$7]]]);
  const name$1 = "l-checkbox";
  const _sfc_main$6 = /* @__PURE__ */ vue.defineComponent(Object.assign({
    ...
    value: { type: null },
    icon: { default: "rectangle", type: String },
    fontSize: { type: String },
    iconSize: { type: String },
    checkedColor: { type: String },
    iconBgColor: { type: String },
    iconBorderColor: { type: String },
    iconDisabledColor: { type: String },
    iconDisabledBgColor: { type: String },
    ...
    const formDisabled = vue.inject("formDisabled", null);
    const formReadonly = vue.inject("formReadonly", null);
    const checkboxGroup = vue.inject("limeCheckboxGroup", null);
    const checkboxGroupValue = vue.inject("limeCheckboxGroupValue", null);
    const checkboxGroupStatus = vue.inject("limeCheckboxGroupStatus", null);
    const checkboxGroupCheckedSet = vue.inject("limeCheckboxGroupCheckedSet", null);
    const manageChildInList = vue.inject("limeCheckboxGroupManageChildInList", null);
    const onCheckedChange = vue.inject("limeCheckboxGroupOnCheckedChange", null);
    ...
    const _innerChecked = vue.ref(props.defaultChecked);
    const innerChecked = vue.computed({
      set(value) {
    ...
    const innerFontSize = vue.computed(() => {
      var _a2;
    ...
    const innerIconBgColor = vue.computed(() => {
      var _a2, _b;
    ...
    const innerIconBorderColor = vue.computed(() => {
      var _a2, _b;
    ...
    const innerIconDisabledColor = vue.computed(() => {
      var _a2, _b;
    ...
    const innerIconDisabledBgColor = vue.computed(() => {
      var _a2, _b;
    ...
    const rootCasses = vue.computed(() => {
      const cls2 = /* @__PURE__ */ new Map();
      cls2.set("".concat(name$1, "--").concat(props.size), true);
      cls2.set("".concat(name$1, "--disabled"), isDisabled.value);
      return cls2;
    });
    const iconClasses = vue.computed(() => {
      const cls2 = /* @__PURE__ */ new Map();
      cls2.set("".concat(name$1, "__icon--disabled"), isDisabled.value);
      cls2.set("".concat(name$1, "__icon--").concat(props.icon), true);
      cls2.set("".concat(name$1, "__icon--checked"), isChecked.value && innerCheckedColor.value == null);
      cls2.set("".concat(name$1, "__icon--indeterminate"), isIndeterminate.value && innerCheckedColor.value == null);
      return cls2;
    });
    const labelClass = vue.computed(() => {
      const cls2 = /* @__PURE__ */ new Map();
      cls2.set("".concat(name$1, "__label--disabled"), isDisabled.value);
      return cls2;
    });
    const styles = vue.computed(() => {
      const style = /* @__PURE__ */ new Map();
    ...
    const labelStyles = vue.computed(() => {
      ...
      if (typeof props.labelStyle == "string") {
        return "".concat(props.labelStyle, ";") + (innerIconSize.value != null ? "font-size: ".concat(innerIconSize.value) : "");
      }
    ...
    const update = () => {
      ...
      const drawIndeterminate = () => {
        var _a2;
        ctx.strokeStyle = isDisabled.value ? innerIconDisabledColor.value : innerIcon.value == "line" ? (_a2 = props.checkedColor) !== null && _a2 !== void 0 ? _a2 : "#3283ff" : "white";
      ...
      const drawCheckedIcon = () => {
        ...
        if (isDisabled.value) {
          ...
          ctx.strokeStyle = (_a2 = props.checkedColor) !== null && _a2 !== void 0 ? _a2 : "#3283ff";
        } else {
          ctx.strokeStyle = "white";
          ctx.fillStyle = "white";
        }
        ...
        if (innerIcon.value == "circle" || innerIcon.value == "rectangle") {
          ...
          ctx.beginPath();
          ctx.moveTo(rect.width * 0.1, rect.height * 0.5466);
          ctx.lineTo(rect.width * 0.3666, rect.height * 0.8134);
          ctx.lineTo(rect.width * 0.9, rect.height * 0.28);
          ctx.stroke();
        } else if (innerIcon.value == "dot") {
          ctx.beginPath();
          ctx.arc(x2, y2, rect.width * 0.22, 0, Math.PI * 2);
          ctx.fill();
        }
      };
    ...
    return (_ctx = null, _cache = null) => {
      return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
        class: vue.normalizeClass(["l-checkbox", [vue.unref(rootCasses)]]),
        style: vue.normalizeStyle([vue.unref(styles)]),
        onClick: handleChange
      }), [
        vue.renderSlot(_ctx.$slots, "checkbox", new UTSJSONObject({
          ...
          return [
            vue.renderSlot(_ctx.$slots, "icon", new UTSJSONObject({
              ...
              return [
                vue.createElementVNode("view", new UTSJSONObject({
                  class: vue.normalizeClass(["l-checkbox__icon", vue.unref(iconClasses)]),
                  ref_key: "iconRef",
                  ref: iconRef,
                  style: vue.normalizeStyle([vue.unref(iconStyle)])
                }), null, 6)
              ];
            }),
            _ctx.label != null || _ctx.$slots["default"] != null ? (vue.openBlock(), vue.createElementBlock("text", new UTSJSONObject({
              key: 0,
              class: vue.normalizeClass(["l-checkbox__label", vue.unref(labelClass)]),
              style: vue.normalizeStyle([vue.unref(labelStyles)])
            }), [
              vue.renderSlot(_ctx.$slots, "default", new UTSJSONObject({}), () => {
                return [
                  vue.createTextVNode(vue.toDisplayString(_ctx.label), 1)
  ...
  const _style_0$6 = { "l-checkbox": { "": { "flexDirection": "row", "alignItems": "center" } }, "l-checkbox__icon": { "": { "position": "relative", "boxSizing": "border-box", "width": "40rpx", "height": "40rpx", "alignSelf": "center", "transitionProperty": "all", "transitionDuration": "200ms", "transitionTimingFunction": "cubic-bezier(0.78,0.14,0.15,0.86)" } }, "l-checkbox__icon--rectangle": { "": { "borderTopLeftRadius": "6rpx", "borderTopRightRadius": "6rpx", "borderBottomRightRadius": "6rpx", "borderBottomLeftRadius": "6rpx", "backgroundColor": "#FFFFFF", "borderTopWidth": "1rpx", "borderRightWidth": "1rpx", "borderBottomWidth": "1rpx", "borderLeftWidth": "1rpx", "borderTopStyle": "solid", "borderRightStyle": "solid", "borderBottomStyle": "solid", "borderLeftStyle": "solid", "borderTopColor": "#c5c5c5", "borderRightColor": "#c5c5c5", "borderBottomColor": "#c5c5c5", "borderLeftColor": "#c5c5c5" }, ".l-checkbox__icon--checked": { "backgroundColor": "#3283ff", "borderTopColor": "#3283ff", "borderRightColor": "#3283ff", "borderBottomColor": "#3283ff", "borderLeftColor": "#3283ff" }, ".l-checkbox__icon--indeterminate": { "backgroundColor": "#3283ff", "borderTopColor": "#3283ff", "borderRightColor": "#3283ff", "borderBottomColor": "#3283ff", "borderLeftColor": "#3283ff" }, ".l-checkbox__icon--disabled": { "borderTopColor": "#c5c5c5", "borderRightColor": "#c5c5c5", "borderBottomColor": "#c5c5c5", "borderLeftColor": "#c5c5c5", "backgroundColor": "#f3f3f3" } }, "l-checkbox__icon--dot": { "": { "borderTopLeftRadius": 99, "borderTopRightRadius": 99, "borderBottomRightRadius": 99, "borderBottomLeftRadius": 99, "backgroundColor": "#FFFFFF", "borderTopWidth": "1rpx", "borderRightWidth": "1rpx", "borderBottomWidth": "1rpx", "borderLeftWidth": "1rpx", "borderTopStyle": "solid", "borderRightStyle": "solid", "borderBottomStyle": "solid", "borderLeftStyle": "solid", "borderTopColor": "#c5c5c5", "borderRightColor": "#c5c5c5", "borderBottomColor": "#c5c5c5", "borderLeftColor": "#c5c5c5" }, ".l-checkbox__icon--checked": { "backgroundColor": "#3283ff" }, ".l-checkbox__icon--indeterminate": { "backgroundColor": "#3283ff" }, ".l-checkbox__icon--disabled": { "borderTopColor": "#c5c5c5", "borderRightColor": "#c5c5c5", "borderBottomColor": "#c5c5c5", "borderLeftColor": "#c5c5c5", "backgroundColor": "#f3f3f3" } }, "l-checkbox__icon--circle": { "": { "borderTopLeftRadius": 99, "borderTopRightRadius": 99, "borderBottomRightRadius": 99, "borderBottomLeftRadius": 99, "backgroundColor": "#FFFFFF", "borderTopWidth": "1rpx", "borderRightWidth": "1rpx", "borderBottomWidth": "1rpx", "borderLeftWidth": "1rpx", "borderTopStyle": "solid", "borderRightStyle": "solid", "borderBottomStyle": "solid", "borderLeftStyle": "solid", "borderTopColor": "#c5c5c5", "borderRightColor": "#c5c5c5", "borderBottomColor": "#c5c5c5", "borderLeftColor": "#c5c5c5" }, ".l-checkbox__icon--checked": { "backgroundColor": "#3283ff", "borderTopColor": "#3283ff", "borderRightColor": "#3283ff", "borderBottomColor": "#3283ff", "borderLeftColor": "#3283ff" }, ".l-checkbox__icon--indeterminate": { "backgroundColor": "#3283ff", "borderTopColor": "#3283ff", "borderRightColor": "#3283ff", "borderBottomColor": "#3283ff", "borderLeftColor": "#3283ff" }, ".l-checkbox__icon--disabled": { "borderTopColor": "#c5c5c5", "borderRightColor": "#c5c5c5", "borderBottomColor": "#c5c5c5", "borderLeftColor": "#c5c5c5", "backgroundColor": "#f3f3f3" } }, "l-checkbox__label": { "": { "paddingLeft": "16rpx", "fontSize": "32rpx", "color": "rgba(0,0,0,0.88)" } }, "l-checkbox__label--disabled": { "": { "color": "#c5c5c5" } }, "@TRANSITION": { "l-checkbox__icon": { "property": "all", "duration": "200ms", "timingFunction": "cubic-bezier(0.78,0.14,0.15,0.86)" } } };
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["styles", [_style_0$6]]]);
  function intersection(...arrays) {
    const result = [];
    for (let i2 = 0; i2 < arrays[0].length; i2++) {
      const item = arrays[0][i2];
      let isCommon = true;
      for (let j2 = 1; j2 < arrays.length; j2++) {
        if (!arrays[j2].includes(item)) {
          isCommon = false;
          break;
        }
      }
  ...
  function setCheckAllStatus(children, innerValue = null, checkedSet = null) {
    const intersectionLen = vue.computed(() => {
      const values = [];
  ...
  const _sfc_main$5 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, _a) {
      ...
      const emit = __emit;
      const props = __props;
      const _innerValue = vue.ref((_b = props.defaultValue) !== null && _b !== void 0 ? _b : []);
      const innerValue = vue.computed({
        set(value) {
          _innerValue.value = value;
          emit("change", value);
      ...
      const maxExceeded = vue.computed(() => {
      ...
      const handleCheckboxChange = (item) => {
        ...
        if (Array.isArray(innerValue.value)) {
          ...
          if (item.checked) {
            ...
            const i2 = val.indexOf(currentValue);
            val.splice(i2, 1);
          }
          innerValue.value = val;
        } else {
          uni.__log__("warn", "at uni_modules/lime-checkbox/components/l-checkbox-group/l-checkbox-group.uvue:105", "CheckboxGroup Warn: `value` must be an array, instead of ".concat(typeof innerValue.value));
        }
      };
      ...
      vue.provide("limeCheckboxGroup", props);
      vue.provide("limeCheckboxGroupValue", innerValue);
      vue.provide("limeCheckboxGroupStatus", checkAllStatus);
      vue.provide("limeCheckboxGroupCheckedSet", checkedSet);
      vue.provide("limeCheckboxGroupManageChildInList", manageChildInList);
      vue.provide("limeCheckboxGroupOnCheckedChange", onCheckedChange);
      return (_ctx = null, _cache = null) => {
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
          class: vue.normalizeClass(["l-checkbox-group", "l-checkbox-group--" + _ctx.direction])
        }), [
          vue.renderSlot(_ctx.$slots, "default")
        ], 2);
      };
  ...
  const _style_0$5 = { "l-checkbox-group": { "": { "flexDirection": "row" } }, "l-checkbox-group--vertical": { "": { "flexDirection": "column" } } };
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["styles", [_style_0$5]]]);
  const _sfc_main$4 = /* @__PURE__ */ vue.defineComponent({
    __name: "deviceShare",
    setup(__props) {
      const checkboxGroupRef = vue.ref(null);
      const sharedCount = vue.ref("2");
      const shareType = vue.ref("1");
      const goVisitor = () => {
        uni.navigateTo({
      ...
      const onChange = (e2) => {
        uni.__log__("log", "at pages/index/deviceShare/deviceShare.uvue:83", "onChange", e2);
      };
      const checkAll = () => {
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_fui_radio_group = resolveEasycom(vue.resolveDynamicComponent("fui-radio-group"), __easycom_3$5);
        const _component_l_input = resolveEasycom(vue.resolveDynamicComponent("l-input"), __easycom_4$1);
        const _component_l_checkbox = resolveEasycom(vue.resolveDynamicComponent("l-checkbox"), __easycom_1);
        const _component_l_checkbox_group = resolveEasycom(vue.resolveDynamicComponent("l-checkbox-group"), __easycom_2);
        const _component_l_button = resolveEasycom(vue.resolveDynamicComponent("l-button"), __easycom_7);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "share-title" }), "设备的名称"),
            vue.createElementVNode("view", new UTSJSONObject({
              class: "list",
              onClick: goVisitor
            }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "shared-title" }), [
                vue.createElementVNode("text", null, "已分享"),
                vue.createElementVNode("text", new UTSJSONObject({ class: "shared-count" }), vue.toDisplayString(sharedCount.value), 1)
              ]),
              vue.createVNode(_component_l_icon, new UTSJSONObject({
                name: "chevron-right",
                size: "30"
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("text", new UTSJSONObject({ class: "title" }), "分享方式"),
            vue.createElementVNode("view", new UTSJSONObject({ class: "share-type" }), [
              vue.createVNode(_component_fui_radio_group, new UTSJSONObject({
                name: "radio",
                onChange: change,
                ...
                default: vue.withCtx(() => {
                  return [
                    vue.createElementVNode("view", new UTSJSONObject({ class: "fui-list__item" }), [
                      vue.createVNode(_component_fui_label, null, {
                        default: vue.withCtx(() => {
                          return [
                            vue.createElementVNode("view", new UTSJSONObject({ class: "fui-align__center" }), [
                              vue.createVNode(_component_fui_radio, new UTSJSONObject({
                                value: "1",
                                scaleRatio: 0.9
                              })),
                              vue.createElementVNode("text", new UTSJSONObject({ class: "fui-text" }), "夜精灵用户")
                            ])
                          ];
                        }),
                        _: 1
                      }),
                      vue.createVNode(_component_fui_label, new UTSJSONObject({ margin: "0 0 0 40rpx" }), {
                        default: vue.withCtx(() => {
                          return [
                            vue.createElementVNode("view", new UTSJSONObject({ class: "fui-align__center" }), [
                              vue.createVNode(_component_fui_radio, new UTSJSONObject({
                              ...
                              vue.createElementVNode("text", new UTSJSONObject({ class: "fui-text" }), "二维码")
                            ])
                          ];
                        }),
                        _: 1
                        ...
                        default: vue.withCtx(() => {
                          return [
                            vue.createElementVNode("view", new UTSJSONObject({ class: "fui-align__center" }), [
                              ...
                              vue.createElementVNode("text", new UTSJSONObject({ class: "fui-text" }), "微信")
                            ])
                          ];
                        }),
                        _: 1
            ...
            shareType.value == "1" ? (vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({
              key: 0,
              class: "share-content"
            }), [
              vue.createElementVNode("text", null, "用户名"),
              vue.createVNode(_component_l_input, new UTSJSONObject({ placeholder: "请输入文字" }))
            ])) : vue.createCommentVNode("", true),
            vue.createElementVNode("view", new UTSJSONObject({ class: "visitor-box" }), [
              vue.createElementVNode("view", new UTSJSONObject({ class: "vistor-title" }), [
                vue.createElementVNode("text", new UTSJSONObject({ class: "title" }), "设置访客权限"),
                vue.createElementVNode("text", new UTSJSONObject({ onClick: checkAll }), "全选")
              ]),
              vue.createVNode(_component_l_checkbox_group, new UTSJSONObject({
                ...
                default: vue.withCtx(() => {
                  return [
                    vue.createVNode(_component_l_checkbox, new UTSJSONObject({
                      value: "1",
                      label: "视频预览"
                    })),
                    vue.createVNode(_component_l_checkbox, new UTSJSONObject({
  ...
  const _style_0$4 = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx", "marginBottom": "50rpx" } }, "share-title": { ".container .content ": { "paddingTop": 0, "paddingRight": "20rpx", "paddingBottom": 0, "paddingLeft": "20rpx" } }, "list": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": 0, "paddingLeft": "20rpx" } }, "shared-title": { ".container .content .list ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": 0, "paddingRight": 0, "paddingBottom": 0, "paddingLeft": 0 } }, "shared-count": { ".container .content .list .shared-title ": { "marginLeft": "20rpx", "color": "#9d2ddf", "fontWeight": "bold" } }, "title": { ".container .content ": { "paddingTop": 0, "paddingRight": "20rpx", "paddingBottom": 0, "paddingLeft": "20rpx", "fontWeight": "bold" } }, "share-type": { ".container .content ": { "paddingTop": "30rpx", "paddingRight": "30rpx", "paddingBottom": "30rpx", "paddingLeft": "30rpx" } }, "fui-list__item": { ".container .content .share-type ": { "display": "flex", "flexDirection": "row", "justifyContent": "flex-start", "alignItems": "center" } }, "fui-align__center": { ".container .content .share-type .fui-list__item ": { "display": "flex", "flexDirection": "row", "justifyContent": "flex-start", "alignItems": "center" } }, "fui-text": { ".container .content .share-type .fui-list__item .fui-align__center ": { "marginLeft": "10rpx" } }, "share-content": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "flex-start", "alignItems": "center", "paddingTop": "10rpx", "paddingRight": "30rpx", "paddingBottom": "10rpx", "paddingLeft": "30rpx", "width": "100%" } }, "l-input": { ".container .content .share-content ": { "flex": 1, "borderTopWidth": "1rpx", "borderRightWidth": "1rpx", "borderBottomWidth": "1rpx", "borderLeftWidth": "1rpx", "borderTopStyle": "solid", "borderRightStyle": "solid", "borderBottomStyle": "solid", "borderLeftStyle": "solid", "borderTopColor": "#cccccc", "borderRightColor": "#cccccc", "borderBottomColor": "#cccccc", "borderLeftColor": "#cccccc", "paddingTop": "10rpx", "paddingRight": "20rpx", "paddingBottom": "10rpx", "paddingLeft": "20rpx", "borderTopLeftRadius": "10rpx", "borderTopRightRadius": "10rpx", "borderBottomRightRadius": "10rpx", "borderBottomLeftRadius": "10rpx", "marginLeft": "20rpx" } }, "visitor-box": { ".container .content ": { "paddingTop": "30rpx", "paddingRight": 0, "paddingBottom": "30rpx", "paddingLeft": 0 } }, "vistor-title": { ".container .content .visitor-box ": { "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "30rpx", "paddingLeft": 0, "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center" } }, "l-checkbox-group": { ".container .content .visitor-box ": { "display": "flex", "flexDirection": "row", "flexWrap": "wrap", "paddingTop": 0, "paddingRight": "20rpx", "paddingBottom": 0, "paddingLeft": "20rpx" } }, "l-checkbox": { ".container .content .visitor-box .l-checkbox-group ": { "marginTop": 0, "marginRight": "30rpx", "marginBottom": "30rpx", "marginLeft": 0 } }, "btn": { ".container ": { "marginTop": "100rpx" } } };
  const PagesIndexDeviceShareDeviceShare = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["styles", [_style_0$4]]]);
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            ...
            vue.createElementVNode("view", new UTSJSONObject({ class: "list nounderline" }), [
              vue.createElementVNode("text", null, "李四"),
              vue.createVNode(_component_l_icon, new UTSJSONObject({
                name: "chevron-right",
                size: "30"
              }))
  ...
  const _style_0$3 = { "container": { "": { "height": "100%", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "backgroundColor": "#f5f5f5" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx" } }, "list": { ".container .content ": { "paddingTop": "20rpx", "paddingRight": 0, "paddingBottom": "20rpx", "paddingLeft": 0, "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f1f1f1" } }, "nounderline": { ".container .content ": { "borderBottomWidth": 0, "borderBottomStyle": "none", "borderBottomColor": "#000000" } } };
  const PagesIndexDeviceShareDeviceVisitor = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["styles", [_style_0$3]]]);
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    __name: "visitorDetail",
    setup(__props) {
      const checkboxGroupRef = vue.ref(null);
      const checked = vue.ref(["1", "3", "7"]);
      const onChange = (e2) => {
        uni.__log__("log", "at pages/index/deviceShare/visitorDetail.uvue:43", "onChange", e2);
        checked.value = e2;
      };
      const checkAll = () => {
        if (checkboxGroupRef.value == null)
      ...
      return (_ctx = null, _cache = null) => {
        ...
        const _component_fui_button = resolveEasycom(vue.resolveDynamicComponent("fui-button"), __easycom_3$4);
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          vue.createElementVNode("text", null, "访客信息"),
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "list" }), [
              vue.createElementVNode("text", null, "访客姓名"),
              vue.createElementVNode("text", null, "张三")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "list nounderline" }), [
              vue.createElementVNode("text", null, "分享时间"),
              vue.createElementVNode("text", null, "2023-12-12 12:12:12")
            ])
          ]),
          vue.createElementVNode("view", new UTSJSONObject({ class: "content-title" }), [
            vue.createElementVNode("text", null, "访客权限"),
            vue.createVNode(_component_l_icon, new UTSJSONObject({
              name: "task-checked",
              onClick: checkAll,
              size: "20"
  ...
  const _style_0$2 = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5", "paddingTop": "20rpx", "paddingRight": "20rpx", "paddingBottom": "20rpx", "paddingLeft": "20rpx" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "paddingTop": "20rpx", "paddingRight": "30rpx", "paddingBottom": "20rpx", "paddingLeft": "30rpx", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx", "marginTop": "20rpx", "marginRight": 0, "marginBottom": "50rpx", "marginLeft": 0 } }, "list": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingTop": "20rpx", "paddingRight": 0, "paddingBottom": "20rpx", "paddingLeft": 0, "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f5f5f5" } }, "nounderline": { ".container .content ": { "borderBottomWidth": 0, "borderBottomStyle": "none", "borderBottomColor": "#000000" } }, "l-checkbox": { ".container .content ": { "width": "100%", "display": "flex", "flexDirection": "row-reverse", "justifyContent": "space-between", "paddingTop": "30rpx", "paddingRight": 0, "paddingBottom": "30rpx", "paddingLeft": 0, "borderBottomWidth": "1rpx", "borderBottomStyle": "solid", "borderBottomColor": "#f5f5f5" } }, "content-title": { ".container ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center", "paddingRight": "30rpx" } }, "btn-box": { ".container ": { "display": "flex", "flexDirection": "row", "justifyContent": "space-between", "alignItems": "center" } } };
  const PagesIndexDeviceShareVisitorDetail = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["styles", [_style_0$2]]]);
  ...
  const _imports_0 = "/static/device/flashlight.png";
  const _imports_1 = "/static/device/picture.png";
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    __name: "addNewDevice",
    setup(__props) {
      const flash = vue.ref("off");
      const devicePosition = vue.ref("back");
      const frameSize = vue.ref("medium");
      const goback = () => {
        uni.navigateBack();
      };
      ...
      const switchFlash = () => {
        onGetWifiList((wifiInfo = null) => {
          uni.showToast({
            title: wifiInfo.wifiList[0].ssid
          });
        });
      };
      const scanImg = () => {
        uni.chooseImage(new UTSJSONObject({
          ...
          success: (res) => {
            uni.scanCode(new UTSJSONObject({
              ...
              scanType: ["qrCode"],
              success: (scanRes) => {
                uni.__log__("log", "at pages/index/addNewDevice/addNewDevice.uvue:86", "识别结果:", scanRes.result);
              },
              fail: (err) => {
                uni.__log__("error", "at pages/index/addNewDevice/addNewDevice.uvue:89", "识别失败:", err);
              }
            }));
          }
        }));
      ...
      return (_ctx = null, _cache = null) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", new UTSJSONObject({ class: "container" }), [
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "content" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "camera-box" }), [
              vue.createVNode(_component_camera, new UTSJSONObject({
                style: new UTSJSONObject({ "width": "100%", "height": "300px" }),
                resolution: "medium",
              ...
              }), null, 8, ["device-position", "flash", "frame-size"]),
              vue.createElementVNode("view", new UTSJSONObject({ class: "tips" }), "请扫描机身上的二维码"),
              vue.createElementVNode("view", new UTSJSONObject({ class: "tools" }), [
                vue.createElementVNode("view", new UTSJSONObject({ class: "icon-container" }), [
                  vue.createElementVNode("image", new UTSJSONObject({
                    class: "icons",
                    src: _imports_0,
                    mode: "aspectFit",
          ...
          vue.createElementVNode("view", new UTSJSONObject({ class: "other-ways" }), "找不到二维码时，请选择以下方式"),
          vue.createElementVNode("view", new UTSJSONObject({ class: "ways-box" }), [
            vue.createElementVNode("view", new UTSJSONObject({ class: "ways-item" }), [
              vue.createElementVNode("text", new UTSJSONObject({ class: "ways-title" }), "WIFI摄像机"),
              vue.createElementVNode("text", new UTSJSONObject({ class: "ways-desc" }), "使用扫APP二维码的配网方式")
            ]),
            vue.createElementVNode("view", new UTSJSONObject({ class: "ways-item" }), [
              vue.createElementVNode("text", new UTSJSONObject({ class: "ways-title" }), "4G摄像机"),
              vue.createElementVNode("text", new UTSJSONObject({ class: "ways-desc" }), "使用4G网络的摄像机")
            ])
          ])
        ]);
      };
  ...
  const _style_0$1 = { "container": { "": { "height": "100%", "backgroundColor": "#f5f5f5" } }, "content": { ".container ": { "backgroundColor": "#ffffff", "paddingTop": "50rpx", "paddingRight": "100rpx", "paddingBottom": "30rpx", "paddingLeft": "100rpx" } }, "tips": { ".container .content ": { "paddingTop": "50rpx", "paddingRight": 0, "paddingBottom": "20rpx", "paddingLeft": 0, "display": "flex", "flexDirection": "row", "justifyContent": "center" } }, "tools": { ".container .content ": { "display": "flex", "flexDirection": "row", "justifyContent": "center", "alignItems": "center" } }, "icon-container": { ".container .content .tools ": { "display": "flex", "justifyContent": "center", "alignItems": "center", "width": "50%" } }, "icons": { ".container .content .tools .icon-container ": { "width": "80rpx", "height": "80rpx" } }, "other-ways": { ".container ": { "display": "flex", "flexDirection": "row", "justifyContent": "center", "alignItems": "center", "marginTop": "30rpx", "marginRight": 0, "marginBottom": "30rpx", "marginLeft": 0 } }, "ways-box": { ".container ": { "paddingTop": 0, "paddingRight": "30rpx", "paddingBottom": 0, "paddingLeft": "30rpx" } }, "ways-item": { ".container .ways-box ": { "paddingTop": "30rpx", "paddingRight": "30rpx", "paddingBottom": "30rpx", "paddingLeft": "30rpx", "backgroundColor": "#ffffff", "marginBottom": "30rpx", "borderTopLeftRadius": "20rpx", "borderTopRightRadius": "20rpx", "borderBottomRightRadius": "20rpx", "borderBottomLeftRadius": "20rpx" } }, "ways-title": { ".container .ways-box .ways-item ": { "fontSize": "35rpx", "marginBottom": "15rpx" } }, "ways-desc": { ".container .ways-box .ways-item ": { "fontSize": "25rpx", "color": "#999999" } } };
  const PagesIndexAddNewDeviceAddNewDevice = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["styles", [_style_0$1]]]);
  ...
  __definePage("pages/index/deviceSetting", PagesIndexDeviceSetting);
  __definePage("pages/index/deviceReplay", PagesIndexDeviceReplay);
  __definePage("pages/index/deviceSettingInfo/deviceSettingInfo", PagesIndexDeviceSettingInfoDeviceSettingInfo);
  __definePage("pages/index/deviceSettingInfo/deviceNight", PagesIndexDeviceSettingInfoDeviceNight);
  __definePage("pages/index/intelligentWatch", PagesIndexIntelligentWatch);
  __definePage("pages/index/TFCardSetting", PagesIndexTFCardSetting);
  __definePage("pages/index/cloudStorageSetting", PagesIndexCloudStorageSetting);
  __definePage("pages/index/deviceRechargeData", PagesIndexDeviceRechargeData);
  __definePage("pages/index/deviceShare/deviceShare", PagesIndexDeviceShareDeviceShare);
  __definePage("pages/index/deviceShare/deviceVisitor", PagesIndexDeviceShareDeviceVisitor);
  __definePage("pages/index/deviceShare/visitorDetail", PagesIndexDeviceShareVisitorDetail);
  __definePage("pages/index/addNewDevice/addNewDevice", PagesIndexAddNewDeviceAddNewDevice);
