...
<script lang="ts">
	...
	import { defineComponent, ref, provide, reactive, getCurrentInstance, watch, watchEffect, computed, ComputedRef, onUnmounted, nextTick, onMounted } from '@/uni_modules/lime-shared/vue';
